...
(function(){var a;a=angular.module("cdoj",["ngSanitize"]);a.controller("ActivateController",["$scope","$http","$element",function(c,d,b){c.userName="";c.buttonText="Send Email";c.onSend=false;return c.sendSerialKey=function(){if(c.userName.length>0){c.buttonText="Sending...";c.onSend=true;return d.post("/user/sendSerialKey/"+c.userName).then(function(e){var f;f=e.data;if(f.result==="success"){alert("We send you an Email with the url to reset your password right now, please check your mail box.");b.modal("hide")}else{if(f.result==="failed"){alert("Unknown error occurred.")}else{alert(f.error_msg)}}c.buttonText="Send Email";return c.onSend=false})}}}]);a.controller("ContestEditorController",["$scope","$http",function(b,c){b.contest={action:0,contestId:0,title:0,type:0,time:0,lengthHours:0,lengthDays:0,lengthMinutes:0,description:0,problemList:0};b.problemList=[];b.$watch("problemList",function(d){return b.contest.problemList=_.map(d,function(e){return e.problemId}).join(",")},true);b.updateProblemTitle=function(d){if(d.problemId===void 0){return d.title="Invalid problem id!"}else{return c.get("/problem/query/"+d.problemId+"/title").then(function(e){var f;f=e.data;if(f.result==="success"){if(f.list.length===1){return d.title=f.list[0]}else{return d.title="No such problem!"}}else{return d.title=f.error_msg}})}};b.addProblem=function(){var f,d,e;e="";if(b.problemList.length>0){f=parseInt(b.problemList.last().problemId);if(!isNaN(f)){e=f+1}}d={problemId:e,title:""};b.updateProblemTitle(d);return b.problemList.add(d)};b.removeProblem=function(d){return b.problemList.splice(d,1)};return b.submit=function(){var d,e=this;d=angular.copy(b.contest);d.time=Date.create(d.time).getTime();return c.post("/contest/edit",d).success(function(f){if(f.result==="success"){return window.location.href="/contest/show/"+f.contestId}else{return alert(f.error_msg)}})}}]);a.controller("ListController",["$scope","$rootScope","$http",function(c,b,d){c.condition=0;c.list=[];c.pageInfo={countPerPage:20,currentPage:1,displayDistance:2,totalPages:1};c.requestUrl=0;c.reset=function(){_.each(c.condition,function(f,e){return c.condition[e]=void 0});return c.condition.currentPage=null};return c.$watch("condition",function(){var f,e=this;if(c.requestUrl!==0){f=angular.copy(c.condition);return d.post(c.requestUrl,f).then(function(g){c.list=g.data.list;return c.pageInfo=g.data.pageInfo})}},true)}]);a.controller("PasswordResetController",["$scope","$http",function(b,c){b.userActivateDTO={userName:"",serialKey:"",password:"",passwordRepeat:""};return b.submit=function(){var d,e;d=CryptoJS.SHA1(b.userActivateDTO.password).toString();b.userActivateDTO.password=d;e=CryptoJS.SHA1(b.userActivateDTO.passwordRepeat).toString();b.userActivateDTO.passwordRepeat=e;return c.post("/user/resetPassword",b.userActivateDTO).then(function(f){var g;g=f.data;if(g.result==="success"){alert("Success!");return window.location.href="/"}else{if(g.result==="field_error"){return b.fieldInfo=g.field}else{return alert(g.error_msg)}}})}}]);a.controller("RegisterController",["$scope","$rootScope","$http","$element",function(d,b,e,c){d.userRegisterDTO={departmentId:1,email:"",motto:"",nickName:"",password:"",passwordRepeat:"",school:"",studentId:"",userName:""};d.fieldInfo=[];return d.register=function(){var f,g;f=CryptoJS.SHA1(d.userRegisterDTO.password).toString();d.userRegisterDTO.password=f;g=CryptoJS.SHA1(d.userRegisterDTO.passwordRepeat).toString();d.userRegisterDTO.passwordRepeat=g;return e.post("/user/register",d.userRegisterDTO).then(function(h){var i;i=h.data;if(i.result==="success"){b.hasLogin=true;b.currentUser={userName:i.userName,email:i.email,type:i.type};return c.modal("hide")}else{if(i.result==="field_error"){return d.fieldInfo=i.field}else{return alert(i.error_msg)}}})}}]);a.controller("UserController",["$scope","$rootScope","$http","$element","$compile",function(d,b,f,c,e){b.hasLogin=false;b.currentUser=0;b.isAdmin=false;d.userLoginDTO={userName:"",password:""};d.fieldInfo=[];d.views={loginView:'<a href="#" class="dropdown-toggle" data-toggle="dropdown">\n  Sign in\n</a>\n<ul ui-dropdown-menu class="dropdown-menu cdoj-form-menu" style="width: 340px;">\n  <li>\n    <form>\n      <div class="input-group form-group input-group-sm">\n        <span class="input-group-addon">\n          <i class="fa fa-user" style="width: 14px;"></i>\n        </span>\n        <input type="text"\n               ng-model="userLoginDTO.userName"\n               maxlength="24"\n               id="userName"\n               class="form-control"\n               ng-required="true"\n               ng-pattern="/^[a-zA-Z0-9_]{4,24}$/"\n               placeholder="Username"/>\n      </div>\n      <div class="input-group form-group input-group-sm">\n        <span class="input-group-addon">\n          <i class="fa fa-key" style="width: 14px;"></i>\n        </span>\n        <input type="password"\n               ng-model="userLoginDTO.password"\n               id="password"\n               ng-required="true"\n               class="form-control"\n               placeholder="Password"/>\n        <span class="input-group-btn">\n          <button type="submit"\n                  class="btn btn-default"\n                  ng-click="login()">\n            Login\n          </button>\n        </span>\n      </div>\n      <ui-validate-info value="fieldInfo" for="password"></ui-validate-info>\n    </form>\n  </li>\n  <li role="presentation" class="divider"></li>\n  <li>\n    <a href="#" data-toggle="modal"\n       data-target="#cdoj-register-modal">\n      <i class="fa fa-arrow-circle-right" style="padding-right: 6px;"></i>Register</a>\n    <a href="#" data-toggle="modal"\n       data-target="#cdoj-activate-modal">\n      <i class="fa fa-arrow-circle-right" style="padding-right: 6px;"></i>Forget password? </a>\n  </li>\n</ul>',userView:'<div id="cdoj-user">\n  <a href="#" class="dropdown-toggle" data-toggle="dropdown">\n    <img id="cdoj-user-avatar"\n         ui-avatar\n         email="currentUser.email"\n         src="/images/avatar/default.jpg"/>\n  </a>\n  <ul class="dropdown-menu"\n      role="menu"\n      aria-labelledby="user-menu">\n    <li role="presentation"\n        class="dropdown-header text-center">\n      <span id="currentUser"\n            ng-bind="currentUser.userName">\n        </span>\n    </li>\n    <li role="presentation">\n      <a href="/user/center/{{currentUser.userName}}">\n        <i class="fa fa-home"></i>User center\n      </a>\n    </li>\n    <li role="presentation">\n      <a href="#" data-toggle="modal"\n         data-target="#cdoj-profile-edit-modal">\n        <i class="fa fa-wrench"></i>Edit profile\n      </a>\n    </li>\n    <li role="presentation" class="divider"></li>\n    <li role="presentation">\n      <a href="#" id="cdoj-logout-button" ng-click="logout()">\n        <i class="fa fa-power-off"></i>Logout\n      </a>\n    </li>\n  </ul>\n</div>'};b.$watch("hasLogin",function(){var g;if(b.hasLogin){g=d.views.userView}else{g=d.views.loginView}c.html(g);e(c.contents())(d);if(b.hasLogin&&b.currentUser.type===1){return b.isAdmin=true}else{return b.isAdmin=false}});d.login=function(){var g;g=CryptoJS.SHA1(d.userLoginDTO.password).toString();d.userLoginDTO.password=g;return f.post("/user/login",d.userLoginDTO).then(function(h){var i;i=h.data;if(i.result==="success"){b.hasLogin=true;return b.currentUser={userName:i.userName,email:i.email,type:i.type}}else{if(i.result==="field_error"){return d.fieldInfo=i.field}else{return alert(i.error_msg)}}})};return d.logout=function(){return f.post("/user/logout").then(function(g){var h;h=g.data;if(h.result==="success"){b.hasLogin=false;return b.currentUser=0}})}}]);a.directive("input",["$timeout",function(b){return{restrict:"E",require:"?ngModel",link:function(e,d,c,f){if(f!==void 0){e.check=function(){var g;g=d.val();if(f.$viewValue!==g){f.$setViewValue(g)}return b(e.check,300)};return e.check()}}}}]);a.directive("equals",function(){return{restrict:"A",require:"?ngModel",link:function(d,c,b,e){var f;if(e===void 0){return}d.$watch(b.ngModel,function(){return f()});b.$observe("equals",function(g){return f()});return f=function(){var h,g;h=e.$viewValue;g=b.equals;return e.$setValidity("equals",h===g)}}}});a.directive("uiAvatar",function(){return{restrict:"A",scope:{email:"=",rating:"@",image:"@",size:"@"},controller:["$scope","$element",function(c,b){return c.$watch("email",function(){var d;if(c.size===void 0){c.size=b.width()}if(c.image===void 0){c.image="retro"}if(c.rating===void 0){c.rating="pg"}d="http://www.gravatar.com/avatar/"+(hex_md5(c.email))+".jpg?"+(c.size?"s="+c.size+"&":"")+(c.rating?"r="+c.rating+"&":"")+(c.image?"d="+encodeURIComponent(c.image):"");return b.attr("src",d)})}]}});a.directive("uiCodeHref",function(){return{restrict:"A",scope:{status:"="},controller:["$scope","$rootScope","$http",function(c,b,d){c.showHref=false;b.$watch("hasLogin",function(){if(b.hasLogin&&(b.currentUser.type===1||b.currentUser.userName===c.status.userName)){return c.showHref=true}else{return c.showHref=false}});return c.showCode=function(){var e;e=c.status.statusId;return d.post("/status/info/"+e).then(function(f){var g,i,h,j;j=f.data;h="";if(j.result==="success"){h=j.compileInfo}else{h=j.error_msg}i="";if(j.result==="success"){i=j.code}else{i=j.error_msg}i=i.escapeHTML();g=$("#code-modal");g.find(".modal-body").empty().append("<pre>"+i+"</pre>");g.find(".modal-body").prettify();return g.modal("toggle")})}}],template:'<a href="#" ng-show="showHref" ng-click="showCode()">{{status.length}} B</a>\n<span ng-hide="showHref">{{status.length}} B</span>'}});a.directive("uiContestAdminSpan",function(){return{restrict:"A",scope:{contestId:"=",isVisible:"="},controller:["$scope","$http",function(b,c){return b.editVisible=function(){var e,d=this;e="/contest/operator/"+b.contestId+"/isVisible/"+(!b.isVisible);return c.post(e).then(function(f){if(f.data.result==="success"){return b.isVisible=!b.isVisible}})}}],template:'<div class="btn-toolbar" role="toolbar">\n  <div class="btn-group">\n    <button type="button" class="btn btn-default btn-sm" ng-click="editVisible()" style="padding: 1px 5px;">\n      <i class="fa" ng-class="{\n        \'fa-eye\': isVisible == true,\n        \'fa-eye-slash\': isVisible == false\n      }"></i>\n    </button>\n    <a href="/contest/editor/{{contestId}}" target="_blank"\n       class="btn btn-default btn-sm" style="padding: 1px 5px;"><i class="fa fa-pencil"></i></a>\n  </div>\n</div>'}});a.directive("uiDatetimepicker",function(){return{restrict:"A",link:function(c,b){console.log(b);return b.datetimepicker()}}});a.directive("uiDropdownMenu",function(){return{restrict:"A",link:function(c,b){var d=this;return b.find("form").click(function(f){return f.stopPropagation()})}}});a.directive("uiFlandre",function(){return{restrict:"A",scope:{content:"=ngModel",uploadUrl:"@uploadUrl"},controller:["$scope","$element",function(c,b){var e,d;c.mode="edit";c.previewContent="";e=b.find(".flandre-editor");e.elastic();c.togglePreview=function(){if(c.mode==="edit"){c.previewContent=c.content;return c.mode="preview"}else{return c.mode="edit"}};return d=new qq.FineUploaderBasic({button:b.find(".flandre-picture-uploader")[0],request:{endpoint:c.uploadUrl,inputName:"uploadFile"},validation:{allowedExtensions:["jpeg","jpg","gif","png"],sizeLimit:10*1000*1000},multiple:false,callbacks:{onComplete:function(k,j,i){var g,f,h;if(i.success==="true"){h="![title]("+i.uploadedFileUrl+")";f=e.getCursorPosition();g=e.val();g=g.insert(h,f);c.$apply(function(){return c.content=g});return e.setSelection(f+2,f+7)}else{return console.log(i)}}}})}],template:'<div class="panel panel-default">\n  <div class="panel-heading flandre-heading">\n    <div class="btn-toolbar" role="toolbar">\n      <div class="btn-group">\n        <button type="button" class="btn btn-default btn-sm"\n                ng-click="togglePreview()"\n                ng-class="{active: mode == \'preview\'}">Preview</button>\n      </div>\n      <div class="btn-group flandre-tools">\n        <span class="btn btn-default btn-sm"><i class="fa fa-smile-o"></i></span>\n        <span class="btn btn-default btn-sm flandre-picture-uploader"><i class="fa fa-picture-o"></i></span>\n      </div>\n    </div>\n  </div>\n  <textarea class="tex2jax_ignore form-control flandre-editor"\n            ng-class="{\'flandre-show\': mode == \'edit\'}"\n            ng-model="content"></textarea>\n  <div class="flandre-preview" ng-class="{\'flandre-show\': mode == \'preview\'}">\n    <div ui-markdown content="previewContent"></div>\n  </div>\n</div>',replace:true}});a.directive("uiMarkdown",function(){return{restrict:"A",scope:{content:"="},link:function(c,b){var d;d=function(){b.prettify();return b.mathjax()};d();if(c.content!==void 0){return c.$watch("content",function(e){e=marked(e);b.empty().append(e);return d()})}}}});a.directive("uiPageInfo",function(){return{restrict:"A",scope:{pageInfo:"=",condition:"="},controller:["$scope",function(b){b.pageList=[];b.beginPages=1;b.endPages=1;b.$watch("pageInfo",function(){var c,d;if(b.pageInfo.totalPages>1){c=Math.max(1,b.pageInfo.currentPage-b.pageInfo.displayDistance);d=Math.min(b.pageInfo.totalPages,c+b.pageInfo.displayDistance*2);c=Math.max(1,d-b.pageInfo.displayDistance*2);b.beginPages=c;b.endPages=d;return b.pageList=_.range(c,d+1).map(function(e){return{page:e,active:e===b.pageInfo.currentPage}})}else{return b.pageList=""}},true);return b.jump=function(c){return b.condition.currentPage=c}}],template:'<ul class="pagination pagination-sm">\n  <li ng-class="{disabled: beginPages == 1}" ng-show="pageInfo.totalPages > 1"><a href="#" ng-click="jump(1)"><i class="fa fa-arrow-left"></i></a></li>\n  <li ng-repeat="page in pageList"\n      ng-class="{active: page.active}">\n    <a href="#" ng-click="jump(page.page)">{{page.page}}</a>\n  </li>\n  <li ng-class="{disabled: endPages == pageInfo.totalPages}" ng-show="pageInfo.totalPages > 1"><a href="#" ng-click="jump(pageInfo.totalPages)"><i class="fa fa-arrow-right"></i></a></li>\n</ul>'}});a.directive("uiProblemAdminSpan",function(){return{restrict:"A",scope:{problemId:"=",isVisible:"="},controller:["$scope","$http",function(b,c){return b.editVisible=function(){var e,d=this;e="/problem/operator/"+b.problemId+"/isVisible/"+(!b.isVisible);return c.post(e).then(function(f){if(f.data.result==="success"){return b.isVisible=!b.isVisible}})}}],template:'<div class="btn-toolbar" role="toolbar">\n  <div class="btn-group">\n    <button type="button" class="btn btn-default btn-sm" ng-click="editVisible()" style="padding: 1px 5px;">\n      <i class="fa" ng-class="{\n        \'fa-eye\': isVisible == true,\n        \'fa-eye-slash\': isVisible == false\n      }"></i>\n    </button>\n    <a href="/problem/editor/{{problemId}}" target="_blank"\n       class="btn btn-default btn-sm" style="padding: 1px 5px;"><i class="fa fa-pencil"></i></a>\n    <a href="/problem/dataEditor/{{problemId}}" target="_blank"\n       class="btn btn-default btn-sm" style="padding: 1px 5px;"><i class="fa fa-cog"></i></a>\n  </div>\n</div>'}});a.directive("uiReadmore",function(){return{restrict:"A",scope:{hasMore:"=",articleId:"="},link:function(c,b){if(c.hasMore){return b.empty().append('<a href="/article/show/'+c.articleId+'" target="_blank">Read more >></a>')}}}});a.directive("uiRejudgeButton",function(){return{restrict:"A",scope:{condition:"="},controller:["$scope","$http",function(b,c){return b.rejudge=function(){return c.post("/status/count",b.condition).then(function(d){var e;e=d.data;if(e.result==="success"){if(confirm("Rejudge all "+e.count+" records")){return c.post("/status/rejudge",b.condition).then(function(f){e=f.data;if(e.result==="success"){return alert("Done!")}else{return alert(e.error_msg)}})}}else{return alert(e.error_msg)}})}}],template:'<button type="button" class="btn btn-danger btn-sm" ng-click="rejudge()">Rejudge</button>'}});a.directive("uiStatus",function(){return{restrict:"A",scope:{status:"="},controller:["$scope","$rootScope","$http",function(c,b,e){var d;c.showHref=false;b.$watch("hasLogin",function(){if(c.status.returnTypeId===7){if(b.hasLogin&&(b.currentUser.type===1||b.currentUser.userName===c.status.userName)){return c.showHref=true}else{return c.showHref=false}}else{return c.showHref=false}});c.showCompileInfo=function(){var f;f=c.status.statusId;return e.post("/status/info/"+f).then(function(g){var h,i,j;j=g.data;i="";if(j.result==="success"){i=j.compileInfo}else{i=j.error_msg}h=$("#compile-info-modal");h.find(".modal-body").empty().append("<pre>"+i+"</pre>");h.find(".modal-body").prettify();return h.modal("toggle")})};if([0,16,17,18].some(c.status.returnTypeId)){return d=setInterval(function(){var f;f={currentPage:null,startId:c.status.statusId,endId:c.status.statusId,userName:void 0,problemId:void 0,languageId:void 0,contestId:void 0,result:"OJ_ALL",orderFields:"statusId",orderAsc:"false"};return e.post("/status/search",f).then(function(g){var h;h=g.data;if(h.result==="success"&&h.list.length===1){c.status=h.list[0];if([0,16,17,18].none(c.status.returnTypeId)){return clearInterval(d)}}})},500)}}],template:'<a href="#" ng-show="showHref" ng-click="showCompileInfo()">{{status.returnType}}</a>\n<span ng-hide="showHref">{{status.returnType}}</span>'}});a.directive("uiTime",function(){return{restrict:"A",scope:{time:"=",inline:"="},controller:["$scope",function(b){b.timeString="";b.$watch("time",function(){return b.showRelativeTime()});b.showRelativeTime=function(){return b.timeString=Date.create(b.time).relative()};b.showRealTime=function(){return b.timeString=Date.create(b.time).format("{yyyy}-{MM}-{dd} {HH}:{mm}:{ss}")};b.showRelativeTimeDelay=function(){return setTimeout(function(){return b.$apply(function(){return b.showRelativeTime()})},400)};return b.getInline=function(){if(b.inline){return"inline"}else{return"block"}}}],template:'<div ng-mouseover="showRealTime()"\n     ng-mouseleave="showRelativeTimeDelay()"\n     style="width: 100%;"\n     ng-style="{display: getInline()}">{{timeString}}</div>'}});a.directive("uiTimeLength",function(){return{restrict:"A",scope:{length:"="},controller:["$scope",function(b){b.timeString="";b.$watch("length",function(){return b.showTimeLength()});return b.showTimeLength=function(){var g,c,e,f,d;e=parseInt(b.length);d=e%60;e=(e-d)/60;f=e%60;e=(e-f)/60;c=e%24;e=(e-c)/24;g=e;b.timeString="";if(g>0){b.timeString=b.timeString+g+(" "+(g===1?"day":"days")+" ")}return b.timeString=b.timeString+"%d:%02d:%02d".sprintf(c,f,d)}}],template:"<div>{{timeString}}</div>"}});a.directive("uiYesNoRadio",function(){return{restrict:"E",scope:{ngModel:"="},controller:["$scope",function(b){b.options=[{key:"All",value:void 0},{key:"Yes",value:true},{key:"No",value:false}];return b.select=function(c){return b.ngModel=c}}],replace:true,template:'<div class="btn-group pull-right" data-toggle="buttons">\n  <button type="button" class="btn  btn-info btn-sm" ng-class="{active: option.value == ngModel}"\n          ng-repeat="option in options"\n          ng-click="select(option.value)"\n          ng-bind="option.key">\n  </button>\n</div>'}});a.directive("uiValidateInfo",function(){return{restrict:"E",scope:{value:"=","for":"@"},link:function(b){b.isInvalid=false;b.message="";return b.$watch("value",function(){var c;c=_.findWhere(b.value,{field:b["for"]});if(c!==void 0){b.message=c.defaultMessage;return b.isInvalid=true}})},template:'<span class="help-block" ng-show="isInvalid" ng-bind="message"></span>'}})}).call(this);