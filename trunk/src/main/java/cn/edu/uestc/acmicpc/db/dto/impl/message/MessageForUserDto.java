...
public class MessageForUserDto implements BaseDto<Message> {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MessageForUserDto)) {
      return false;
    }
    ...
    return Objects.equals(this.isOpened, that.isOpened)
        ...
        && Objects.equals(this.receiverUserName, that.receiverUserName)
  ...
  public static class Builder implements BaseDtoBuilder<MessageForUserDto> {
