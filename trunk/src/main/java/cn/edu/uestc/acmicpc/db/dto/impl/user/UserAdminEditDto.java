...
public class UserAdminEditDto {
  ...
  private UserAdminEditDto(Integer userId, String userName, String nickName, String email,
      String school,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UserAdminEditDto)) {
      return false;
    }
    ...
    if (newPasswordRepeat != null ? !newPasswordRepeat.equals(that.newPasswordRepeat)
        : that.newPasswordRepeat != null) {
      return false;
    }
