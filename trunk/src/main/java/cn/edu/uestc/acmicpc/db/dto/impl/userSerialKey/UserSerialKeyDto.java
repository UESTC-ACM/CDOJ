...
/**
 * Dto for user serial key entity. <br/>
...
public class UserSerialKeyDto implements BaseDto<UserSerialKey> {
  ...
  public boolean equals(Object o) {
    ...
    if (userSerialKeyId != null ? !userSerialKeyId.equals(that.userSerialKeyId)
        : that.userSerialKeyId != null) {
      return false;
    }
  ...
  public static class Builder implements BaseDtoBuilder<UserSerialKeyDto> {
