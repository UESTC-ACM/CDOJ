...
public class Contest implements Serializable {
	...
	@Column(name = "contestId", nullable = false, insertable = true, updatable = true, length = 10, precision = 0, unique = true)
	@Id
	@GeneratedValue
	...
	public String toString() {
		return "Contest{" + "isVisible=" + isVisible + ", length=" + length
				+ ", time=" + time + ", type=" + type + ", description='"
	...
	public boolean equals(Object o) {
		...
		if (time != null ? !time.equals(contest.time) : contest.time != null)
			return false;
		if (title != null ? !title.equals(contest.title)
				: contest.title != null)
			return false;
	...
	public void setContestProblemsByContestId(
			Collection<ContestProblem> contestProblemsByContestId) {
	...
	public void setContestUsersByContestId(
			Collection<ContestUser> contestUsersByContestId) {
