...
public class Problem implements Serializable {
	...
	public String toString() {
		return "Problem{" + "problemId=" + problemId + ", title='" + title
				...
				+ input + '\'' + ", output='" + output + '\''
				+ ", sampleInput='" + sampleInput + '\'' + ", sampleOutput='"
				+ sampleOutput + '\'' + ", hint='" + hint + '\'' + ", source='"
				+ source + '\'' + ", timeLimit=" + timeLimit + ", memoryLimit="
				+ memoryLimit + ", solved=" + solved + ", tried=" + tried
				+ ", isSpj=" + isSpj + ", isVisible=" + isVisible
				+ ", outputLimit=" + outputLimit + ", javaTimeLimit="
				+ javaTimeLimit + ", javaMemoryLimit=" + javaMemoryLimit
				+ ", dataCount=" + dataCount + ", difficulty=" + difficulty
				+ '}';
	}

	@Column(name = "problemId", nullable = false, insertable = true, updatable = true, length = 10, precision = 0, unique = true)
	@Id
	@GeneratedValue
	...
	public boolean equals(Object o) {
		...
		if (!dataCount.equals(problem.dataCount))
			return false;
		if (!difficulty.equals(problem.difficulty))
			return false;
		if (isSpj != problem.isSpj)
			return false;
		if (isVisible != problem.isVisible)
			return false;
		if (!javaMemoryLimit.equals(problem.javaMemoryLimit))
			return false;
		if (!javaTimeLimit.equals(problem.javaTimeLimit))
			return false;
		if (!memoryLimit.equals(problem.memoryLimit))
			return false;
		if (!outputLimit.equals(problem.outputLimit))
			return false;
		if (!problemId.equals(problem.problemId))
			return false;
		if (!solved.equals(problem.solved))
			return false;
		if (!timeLimit.equals(problem.timeLimit))
			return false;
		if (!tried.equals(problem.tried))
			return false;
		if (description != null ? !description.equals(problem.description)
				: problem.description != null)
			return false;
		if (hint != null ? !hint.equals(problem.hint) : problem.hint != null)
			return false;
		if (input != null ? !input.equals(problem.input)
				: problem.input != null)
			return false;
		if (output != null ? !output.equals(problem.output)
				: problem.output != null)
			return false;
		if (sampleInput != null ? !sampleInput.equals(problem.sampleInput)
				: problem.sampleInput != null)
			return false;
		if (sampleOutput != null ? !sampleOutput.equals(problem.sampleOutput)
				: problem.sampleOutput != null)
			return false;
		if (source != null ? !source.equals(problem.source)
				: problem.source != null)
			return false;
		if (title != null ? !title.equals(problem.title)
				: problem.title != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (sampleInput != null ? sampleInput.hashCode() : 0);
		result = 31 * result
				+ (sampleOutput != null ? sampleOutput.hashCode() : 0);
	...
	public void setContestproblemsByProblemId(
			Collection<ContestProblem> contestproblemsByProblemId) {
	...
	public void setProblemtagsByProblemId(
			Collection<ProblemTag> problemtagsByProblemId) {
