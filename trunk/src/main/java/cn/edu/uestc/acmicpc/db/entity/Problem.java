...
public class Problem implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (hint != null ? !hint.equals(problem.hint) : problem.hint != null)
      return false;
    if (input != null ? !input.equals(problem.input) : problem.input != null)
      return false;
    if (output != null ? !output.equals(problem.output) : problem.output != null)
      return false;
    ...
    if (sampleOutput != null ? !sampleOutput.equals(problem.sampleOutput)
      ...
      return false;
    if (source != null ? !source.equals(problem.source) : problem.source != null)
      return false;
    if (title != null ? !title.equals(problem.title) : problem.title != null)
      return false;
