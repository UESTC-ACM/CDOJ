...
public class TrainingStatus implements Serializable {
	...
	@Column(name = "trainingStatusId", nullable = false, insertable = true, updatable = true, length = 10, precision = 0, unique = true)
	@Id
	@GeneratedValue
	...
	@Column(name = "rank", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
	@Basic
	...
	@Column(name = "penalty", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
	@Basic
	...
	@Column(name = "solve", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
	@Basic
	...
	@Column(name = "volatilityVary", nullable = false, insertable = true, updatable = true, precision = 0)
	@Basic
	...
	@Column(name = "summary", nullable = false, insertable = true, updatable = true, length = 1024, precision = 0)
	@Basic
	...
	public boolean equals(Object o) {
		...
		if (penalty != null ? !penalty.equals(that.penalty)
				: that.penalty != null)
			return false;
		...
		if (rating != null ? !rating.equals(that.rating) : that.rating != null)
			return false;
		if (ratingVary != null ? !ratingVary.equals(that.ratingVary)
				: that.ratingVary != null)
			return false;
		...
		if (trainingContestByTrainingContestId != null ? !trainingContestByTrainingContestId
			...
			return false;
		if (trainingStatusId != null ? !trainingStatusId
				.equals(that.trainingStatusId) : that.trainingStatusId != null)
			return false;
		if (trainingUserByTrainingUserId != null ? !trainingUserByTrainingUserId
				.equals(that.trainingUserByTrainingUserId)
				: that.trainingUserByTrainingUserId != null)
			return false;
		if (version != null ? !version.equals(that.version)
				: that.version != null)
			return false;
		if (volatility != null ? !volatility.equals(that.volatility)
				: that.volatility != null)
			return false;
		if (volatilityVary != null ? !volatilityVary
				.equals(that.volatilityVary) : that.volatilityVary != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (volatilityVary != null ? volatilityVary.hashCode() : 0);
		result = 31 * result + (summary != null ? summary.hashCode() : 0);
		result = 31 * result + (version != null ? version.hashCode() : 0);
		result = 31
				* result
				+ (trainingUserByTrainingUserId != null ? trainingUserByTrainingUserId
						.hashCode() : 0);
		result = 31
				* result
	...
	public void setTrainingUserByTrainingUserId(
			TrainingUser trainingUserByTrainingUserId) {
