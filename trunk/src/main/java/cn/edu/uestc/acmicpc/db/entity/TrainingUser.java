...
public class TrainingUser implements Serializable {
	...
	@Column(name = "trainingUserId", nullable = false, insertable = true, updatable = true, length = 10, precision = 0, unique = true)
	@Id
	@GeneratedValue
	...
	@Column(name = "name", nullable = false, insertable = true, updatable = true, length = 24, precision = 0, unique = true)
	@Basic
	...
	@Column(name = "allow", nullable = false, insertable = true, updatable = true, length = 0, precision = 0)
	@Basic
	...
	@Column(name = "volatilityVary", nullable = true, insertable = true, updatable = true, precision = 0)
	@Basic
	...
	@Column(name = "competitions", nullable = false, insertable = true, updatable = true, precision = 0)
	...
	@Column(name = "member", nullable = false, insertable = true, updatable = true, length = 128, precision = 0)
	@Basic
	...
	public boolean equals(Object o) {
		...
		if (allow != null ? !allow.equals(that.allow) : that.allow != null)
			return false;
		if (competitions != null ? !competitions.equals(that.competitions)
				: that.competitions != null)
			return false;
		...
		if (trainingStatusesByTrainingUserId != null ? !trainingStatusesByTrainingUserId
			...
			return false;
		if (trainingUserId != null ? !trainingUserId
				.equals(that.trainingUserId) : that.trainingUserId != null)
			return false;
		if (type != null ? !type.equals(that.type) : that.type != null)
			return false;
		if (userByUserId != null ? !userByUserId.equals(that.userByUserId)
				: that.userByUserId != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (competitions != null ? competitions.hashCode() : 0);
		result = 31 * result + (member != null ? member.hashCode() : 0);
		result = 31 * result + (version != null ? version.hashCode() : 0);
		result = 31 * result
				+ (userByUserId != null ? userByUserId.hashCode() : 0);
		result = 31
				* result
