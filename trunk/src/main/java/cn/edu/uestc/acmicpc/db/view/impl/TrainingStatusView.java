...
public class TrainingStatusView extends View<TrainingStatus> {
	...
	public TrainingStatusView(TrainingStatus trainingStatus) {
		...
		setContestId(trainingStatus.getTrainingContestByTrainingContestId()
				.getTrainingContestId());
		setContestName(trainingStatus.getTrainingContestByTrainingContestId()
				.getTitle());
		setName(trainingStatus.getTrainingUserByTrainingUserId().getName());
		setUserName(trainingStatus.getTrainingUserByTrainingUserId()
				.getUserByUserId().getUserName());
		setUserEmail(trainingStatus.getTrainingUserByTrainingUserId()
				.getUserByUserId().getEmail());
	}
