...
public class UserAdminAction extends BaseAction implements DepartmentDAOAware,
		UserConditionAware, UserDTOAware {
	 ...
	 * "userList":<strong>query result</strong>}</li>
	 * <li>
	...
	@Validations(requiredStrings = {
			...
			@RequiredStringValidator(fieldName = "userDTO.nickName", key = "error.nickName.validation") }, stringLengthFields = {
			@StringLengthFieldValidator(fieldName = "userDTO.school", key = "error.school.validation", minLength = "1", maxLength = "100", trim = false),
			@StringLengthFieldValidator(fieldName = "userDTO.studentId", key = "error.studentId.validation", minLength = "1", maxLength = "20", trim = false) }, customValidators = { @CustomValidator(type = "regex", fieldName = "userDTO.nickName", key = "error.nickName.validation", parameters = {
			@ValidationParameter(name = "expression", value = "\\b^[^\\s]{2,20}$\\b"),
			@ValidationParameter(name = "trim", value = "false") }) }, fieldExpressions = {
			@FieldExpressionValidator(fieldName = "userDTO.departmentId", expression = "userDTO.departmentId in global.departmentList.{departmentId}", key = "error.department.validation"),
			@FieldExpressionValidator(fieldName = "userDTO.type", expression = "userDTO.type in global.authenticationTypeList.{ordinal()}", key = "error.type.validation") })
