...
@Service
public class TrainingPlatformInfoServiceImpl extends AbstractService implements TrainingPlatformInfoService {
  ...
  @Override
  public TrainingPlatformInfoDto getTrainingPlatformInfoDto(Integer trainingPlatformInfoId, TrainingPlatformInfoFields trainingPlatformInfoFields) throws AppException {
    AppExceptionUtil.assertNotNull(trainingPlatformInfoId);
    TrainingPlatformInfoCriteria trainingPlatformInfoCriteria = new TrainingPlatformInfoCriteria(trainingPlatformInfoFields);
  ...
  public void updateTrainingPlatformInfo(TrainingPlatformInfoDto trainingPlatformInfoDto) throws AppException {
    ...
    TrainingPlatformInfo trainingPlatformInfo = trainingPlatformInfoDao.get(trainingPlatformInfoDto.getTrainingPlatformInfoId());
