...
public class TrainingUserAdminAction extends BaseAction implements
	...
	public String toMemberList() {
		try {
			...
			Long count = trainingUserDAO.count(trainingUserCondition
					.getCondition());
				...
				if (id != null) {
					...
					try {
						...
						if ("delete".equals(method)) {
							...
							Method[] methods = trainingUser.getClass()
									.getMethods();
									...
									String setterName = StringUtil
											.getGetterOrSetter(
													...
													getter.getName().substring(
															3));
									Method setter = trainingUser.getClass()
											.getMethod(setterName,
													getter.getReturnType());
									setter.invoke(trainingUser, ReflectionUtil
											.valueOf(value,
													getter.getReturnType()));
								}
							}
