...
public class TrainingUserRankSummary {
	...
	public TrainingUserRankSummary(TrainingUser user, String[] userInfo,
			Integer type) throws ParserException {
		...
		if (type != Global.TrainingContestType.NORMAL.ordinal()
			...
			for (int i = 0; i < problemCount; i++) {
				TrainingProblemSummaryInfo trainingProblemSummaryInfo = TrainingRankListFormatParser
						.getProblemSummaryInfo(userInfo[i + 1]);
