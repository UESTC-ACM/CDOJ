...
INSERT INTO `uestcoj`.`article` (`articleId`, `title`, `content`, `author`, `time`, `clicked`, `order`, `isNotice`, `isVisible`, `parentId`, `problemId`, `contestId`, `userId`, `OPTLOCK`) VALUES (5, '', '', '', '2013-08-01 10:57:37', 0, 0, 0, 0, NULL, NULL, NULL, 1, 0);
