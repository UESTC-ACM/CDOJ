...
<div id="userEditModal" class="modal hide fade modal-large" tabindex="-1" role="dialog"
    ...
    <div class="modal-body">
        <form class="form-horizontal">
            <fieldset>
                <s:textfield name="userRegisterDTO.userId"
                             maxLength="20"
                             cssClass="span4"
                             label="User ID"
                             readonly="true"
                             theme="bootstrap"/>
                <s:textfield name="userRegisterDTO.nickName"
                             maxLength="20"
                             cssClass="span4"
                             label="Nick name"
                             readonly="false"
                             theme="bootstrap"/>
                <s:textfield name="userRegisterDTO.email"
                             maxLength="100"
                             cssClass="span4"
                             label="Email"
                             readonly="true"
                             theme="bootstrap"/>
                <s:textfield name="userRegisterDTO.school"
                             maxLength="50"
                             cssClass="span4"
                             value="UESTC"
                             label="School"
                             theme="bootstrap"/>
                <s:select name="userRegisterDTO.departmentId"
                          list="global.departmentList"
                          listKey="departmentId"
                          listValue="name"
                          cssClass="span4"
                          label="Department"
                          theme="bootstrap"/>
                <s:textfield name="userRegisterDTO.studentId"
                             maxLength="20"
                             cssClass="span4"
                             label="Student ID"
                             theme="bootstrap"/>
                <s:select name="userRegisterDTO.type"
                          list="global.authenticationTypeList"
                          listKey="ordinal()"
                          listValue="description"
                          cssClass="span4"
