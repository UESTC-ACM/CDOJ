...
<script
  src="<s:url value="/plugins/MathJax/MathJax.js?config=TeX-AMS-MML_HTMLorMML"/>"></script>
<title>Contest</title>
</head>
<body>

  <div id="contestStatus hero-unit" class="currentContestId"
    value="<s:property value="targetContest.contestId"/>">
    <h1 id="contestRunningState"
      value="<s:property value="targetContest.status"/>">
      ...
      <s:else>
        ...
        <span class="pull-right" id="timeLeft"
          ...
          type="milliseconds" timeStyle="length"> </span>
      </s:else>
    </h1>
  </div>
  ...
  <div class="subnav">
    <ul id="TabMenu" class="nav nav-tabs">
      <li class="active"><a href="#tab-contest-summary"
        data-toggle="tab">Summary</a></li>
      <li class="dropdown"><a class="dropdown-toggle"
        data-toggle="dropdown" href="#">Problems<b class="caret"></b></a>
        <ul class="dropdown-menu">
          <s:iterator value="contestProblems" id="problem">
            <li><a
              href="#tab-contest-problem-<s:property value="#problem.order"/>"
              data-toggle="tab"> <s:property value="#problem.order" />
                - ${problem.title}
            </a></li>
          </s:iterator>
        </ul></li>
      <li><a href="#tab-contest-submit" data-toggle="tab">Submit</a>
      </li>
      <li class="dropdown"><a class="dropdown-toggle"
        data-toggle="dropdown" href="#">Clarification<b
          class="caret"></b></a>
        <ul class="dropdown-menu">
          <li class="disabled"><a
            href="#tab-contest-clarification-request" data-toggle="tab">Request
              Clarification</a></li>
          <li class="disabled"><a
            href="#tab-contest-clarification-view" data-toggle="tab">View
              Clarifications</a></li>
        </ul></li>
      <li><a href="#tab-contest-status" data-toggle="tab">Status</a>
      </li>
      <li><a href="#tab-contest-rank" data-toggle="tab">Rank</a></li>
    </ul>
  </div>
    ...
    <div id="TabContent" class="tab-content">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th style="width: 140px;" class="orderButton"
                  field="solved">Status</th>
              </tr>
            </thead>
            <tbody id="contestSummary">
              <s:iterator value="contestProblems" id="problem">
                <tr>
                  ...
                  <td><s:if test="#problem.isSpj == true">
                      <span
                        class="label label-important tags pull-right">SPJ</span>
                    </s:if> <a class="pull-left problemHref" href="#"
                    target="<s:property value="#problem.order"/>">
                      ${problem.title} </a></td>

                  <td class="problemSummaryInfo"
                    value="<s:property value="#problem.order"/>"><span
                    class="problemSolved"><s:property
                        value="#problem.solved" /></span> / <span
                    class="problemTried"><s:property
                        value="#problem.tried" /></span></td>
                </tr>
              </s:iterator>
            </tbody>
          </table>
      ...
      <s:iterator value="contestProblems" id="problem">
        <div class="tab-pane fade"
          id="tab-contest-problem-<s:property value="#problem.order"/>">
          ...
          <div class="row problem">
            <div class="span12" id="problem_title">
              ...
              <s:if test="#problem.isSpj == true">
                <span class="label label-important tags"
                  style="margin: 12px 0 0 8px;">SPJ</span>
              </s:if>
            </div>
            ...
            <div class="span12">
              <dl class="dl-horizontal">
                <dt>Time limit</dt>
                <dd>
                  <span>${problem.javaTimeLimit} /
                    ${problem.timeLimit} ms (Java / others)</span>
                </dd>

                <dt>Memory limit</dt>
                <dd>
                  <span>${problem.javaMemoryLimit} /
                    ${problem.memoryLimit} kb (Java / others)</span>
                </dd>
            ...
            <div class="span12">
              ...
              <table
                class="table table-sample table-bordered table-striped">
                <thead>
                  <tr>
                    <th>Sample Input</th>
                    <th>Sample Output</th>
          ...
          <div id="language-selector" class="pull-left"
            ...
            <div class="btn-group" data-toggle="buttons-radio"
              ...
              <s:iterator value="global.languageList">
                <button
                  class="btn btn-info <s:if test="languageId == 2">active</s:if>"
        ...
        <table class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th>User</th>
              <th style="width: 60px;" class="orderButton"
                field="problemByProblemId">Problem</th>
              <th style="width: 260px;" class="orderButton"
                field="result">Judge's Response</th>
              <th style="width: 100px;" class="orderButton"
                field="length">Length</th>
              <th style="width: 70px;" class="orderButton"
                field="timeCost">Time</th>
              <th style="width: 80px;" class="orderButton"
                field="memoryCost">Memory</th>
              <th style="width: 140px;" class="orderButton" field="time">Submit
                Time</th>
            </tr>
          </thead>
          <tbody id="statusList">
      ...
      <div class="tab-pane fade" id="tab-contest-rank">
          ...
          <table class="table table-bordered">
            <thead id="rankListHead">
              <tr>
                ...
                <th style="width: 30px;" class="orderButton"
                  field="problemByProblemId">Slv.</th>
                <th style="width: 40px;" class="orderButton"
                  field="result">Time</th>

                <s:iterator value="contestProblems" id="problem">
                  <th class="problemSummaryInfo"
                    value="<s:property value="#problem.order"/>"><a
                    class="problemHref" href="#"
                    target="<s:property value="#problem.order"/>"> <s:property
                        value="#problem.order" />
                  </a> <br /> <span class="problemSolved"><s:property
                        value="#problem.solved" /></span> / <span
                    class="problemTried"><s:property
                        value="#problem.tried" /></span></th>
                </s:iterator>
              </tr>
            </thead>
            <tbody id="rankList">
        ...
        <div class="pull-right">
          <a class="btn btn-info"
            href="/contest/export/<s:property value="targetContest.contestId"/>">Export
            rank list</a>
        </div>
      </div>
  ...
  <page:applyDecorator name="body"
    page="/WEB-INF/views/status/modal.jsp" />
</body>
</html>