...
<head>
  ...
  /scripts/d3.js"/>"></script>
  <!--<
  ![endif]-->

  < script
  src = "<s:url value=" / scripts / cdoj / cdoj.training.rating.js
  "/>" ></script>
  <script src="<s:url value="
  /scripts/cdoj/cdoj.chart.rating.js"/>"></script>
  <
  script
  src = "<s:url value=" / scripts / cdoj / cdoj.training.index.js
  "/>" ></script>
            ...
            <form class="form-horizontal">
              <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" maxlength="24" value="<s:property value="
                           currentUser.userName"/>" id="account" class="span4" readonly="true">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="trainingUserDTO.name" maxlength="24" value=""
                           id="trainingUserDTO_name" class="span4"/>

                    <p class="help-block">组队赛名字需以UESTC_开头，其它学校请以自己学校名字开头，参考UESTC_HeavensFeel</p>

                    <p class="help-block">个人赛请用自己的真实姓名</p>

                    <p class="help-block">注意今后除了特殊通知的比赛，别的比赛中自己注册的用户的<strong>昵称</strong>均要和你注册的名称相同
                    </p>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="trainingUserDTO.member" maxlength="30" value=""
                           id="trainingUserDTO_member" class="span4"/>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <label for="trainingUserDTO.type-0" class="radio inline">
                      <input type="radio" name="trainingUserDTO.type" id="trainingUserDTO.type-0"
                             value="0" checked="">
                      Personal
                    </label>

                    <label for="trainingUserDTO.type-1" class="radio inline">
                      <input type="radio" name="trainingUserDTO.type" id="trainingUserDTO.type-1"
                             value="1">
                      Team
                    </label>
                ...
                <div class="form-actions">
                  <button type="submit" id="registerTrainingUserButton" class="btn btn-primary">
                    Register
                  </button>
                </div>
              </fieldset>
