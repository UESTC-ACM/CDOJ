        ...
        <form id="accountActivationForm" class="form-horizontal">
          <fieldset>
            <div class="control-group "><label class="control-label" for="userName">User Name</label><div class="controls">
              ...
              <input type="text" name="userName" maxlength="24" value="<c:out value="${userName}"/>" readonly="readonly" id="userName" class="span4"></div>
            </div>

            <div class="control-group "><label class="control-label" for="serialKey">Serial Key</label><div class="controls">

              <input type="text" name="serialKey" maxlength="48" value="<c:out value="${serialKey}"/>" readonly="readonly" id="serialKey" class="span4"></div>
            </div>
            ...
            <input type="submit" id="accountActivationSubmit" name="accountActivationSubmit" value="Submit" class="btn btn-primary pull-right">
