...
(function (window, undefined) {
    ...
    function EpicEditor(options) {
        ...
        var self = this
            ...
            , _defaultFileSchema
            , _defaultFile
            , defaults = { container: 'epiceditor', problemId: null, basePath: 'epiceditor', clientSideStorage: true, localStorageName: 'epiceditor', useNativeFullscreen: true, file: { name: null, defaultContent: '', autoSave: 100 // Set to false for no auto saving
    ...
    EpicEditor.prototype.load = function (callback) {
        ...
        _HtmlTemplates = {
            ...
            chrome: '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                ...
                '<img width="30" style="margin-left: 15px;" src="' + this.settings.basePath + '/images/picture.png" title="Insert pictures" class="epiceditor-toggle-btn epiceditor-picture-btn"> ' +
