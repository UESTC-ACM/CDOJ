  ...
  function EpicEditor(options) {
    ...
    var self = this
      ...
      , defaults = { container: 'epiceditor'
        ...
        , button: { fullscreen: true, preview: true, picture: true }
        }
      , defaultStorage;
	...
	self._pictureEnabled = typeof(buttons) === 'object' ? typeof buttons.picture === 'undefined' || buttons.picture : buttons === true;
    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  ...
                  '<div id="epiceditor-utilbar">' +
					...
					(self._pictureEnabled? '<img width="30" style="margin-left: 15px;" src="' + this.settings.basePath + '/images/picture.png" title="Insert pictures" class="epiceditor-toggle-btn epiceditor-picture-btn"> ' : '') +
