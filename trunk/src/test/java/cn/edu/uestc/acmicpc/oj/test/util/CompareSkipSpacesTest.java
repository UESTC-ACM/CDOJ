...
public class CompareSkipSpacesTest {
	...
	/**
	 * First string has some white space({@code ' '} in it, and they are same by
	...
	/**
	 * The string has some white space({@code ' '} in it,and the some at the end
	 * of the string.
	 */
	...
	public void testSameAboutEndingSpaces() {
		Assert.assertEquals(0,
				StringUtil.compareSkipSpaces("c a t    ", " c a t"));
	}
	...
	public void testDifferentAboutEndingSpaces() {
		Assert.assertEquals("cat".compareTo("dog"),
				StringUtil.compareSkipSpaces("c a t    ", " d o g"));
	}

	/**
	 * The string has some Tab character in it,I think they are also white and
	 * space.
	 */
	...
	/**
	 * The string has some Tab character in it,And this time the two string is
	 * not the same
	 */
	...
	public void testSameAboutSpecialCharacter() {
		Assert.assertEquals(0, StringUtil.compareSkipSpaces("\t\012\ta\tt\t",
				"\t\012\ta\tt\t"));
	}
	...
	public void testDifferentAboutSpecialCharacter() {
		Assert.assertEquals(1, StringUtil.compareSkipSpaces("\t\012\ta\tt\t",
				"\t\012\t\001a\tt\t"));
	}
}
