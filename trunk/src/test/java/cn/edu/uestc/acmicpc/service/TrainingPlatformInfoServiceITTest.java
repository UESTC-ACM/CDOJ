...
/**
 * Integration test case for {@link cn.edu.uestc.acmicpc.service.iface.TrainingPlatformInfoService}
 */
...
public class TrainingPlatformInfoServiceITTest extends AbstractTestNGSpringContextTests {
  ...
  public void testUpdateTrainingPlatformInfo() throws AppException {
    TrainingPlatformInfoDto dataBeforeUpdated = trainingPlatformInfoService.getTrainingPlatformInfoDto(1, TrainingPlatformInfoFields.ALL_FIELDS);
    ...
    TrainingPlatformInfoDto updatedData = trainingPlatformInfoService.getTrainingPlatformInfoDto(1, TrainingPlatformInfoFields.ALL_FIELDS);
    Assert.assertEquals(updatedData.getTrainingPlatformInfoId(), editDto.getTrainingPlatformInfoId());
  ...
  public void testUpdateTrainingPlatformInfo_nothing() throws AppException {
    ...
    trainingPlatformInfoService.updateTrainingPlatformInfo(editDto);
    TrainingPlatformInfoDto updatedData = trainingPlatformInfoService.getTrainingPlatformInfoDto(1, TrainingPlatformInfoFields.ALL_FIELDS);
    Assert.assertEquals(updatedData.getTrainingPlatformInfoId(), dataBeforeUpdated.getTrainingPlatformInfoId());
  ...
  public void testGetDao() throws AppException {
    TrainingPlatformInfoDao trainingPlatformInfoDao = (TrainingPlatformInfoDao) trainingPlatformInfoService.getDao();
  }
}
