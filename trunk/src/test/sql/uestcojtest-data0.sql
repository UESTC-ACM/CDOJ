...
INSERT INTO `problem` (`problemId`, `title`, `description`, `input`, `output`, `sampleInput`, `sampleOutput`, `hint`, `source`, `timeLimit`, `memoryLimit`, `solved`, `tried`, `isSPJ`, `isVisible`, `outputLimit`, `javaTimeLimit`, `javaMemoryLimit`, `dataCount`, `difficulty`, `type`, `OPTLOCK`) VALUES (2, 'a+b problem', 'description', 'input', 'output', 'sampleinput', 'sampleoutput', 'hint', 'source', 1000, 65535, 0, 0, 1, 1, 8192, 3000, 65535, 1, 1, 0, NULL);
INSERT INTO `problem` (`problemId`, `title`, `description`, `input`, `output`, `sampleInput`, `sampleOutput`, `hint`, `source`, `timeLimit`, `memoryLimit`, `solved`, `tried`, `isSPJ`, `isVisible`, `outputLimit`, `javaTimeLimit`, `javaMemoryLimit`, `dataCount`, `difficulty`, `type`, `OPTLOCK`) VALUES (3, 'a+b problem', 'description', 'input', 'output', 'sampleinput', 'sampleoutput', 'hint', 'source', 1000, 65535, 0, 0, 0, 1, 8192, 3000, 65535, 1, 1, 0, NULL);
INSERT INTO `problem` (`problemId`, `title`, `description`, `input`, `output`, `sampleInput`, `sampleOutput`, `hint`, `source`, `timeLimit`, `memoryLimit`, `solved`, `tried`, `isSPJ`, `isVisible`, `outputLimit`, `javaTimeLimit`, `javaMemoryLimit`, `dataCount`, `difficulty`, `type`, `OPTLOCK`) VALUES (4, 'a+b problem', 'description', 'input', 'output', 'sampleinput', 'sampleoutput', 'hint', 'source', 1000, 65535, 0, 0, 1, 1, 8192, 3000, 65535, 1, 1, 0, NULL);
INSERT INTO `problem` (`problemId`, `title`, `description`, `input`, `output`, `sampleInput`, `sampleOutput`, `hint`, `source`, `timeLimit`, `memoryLimit`, `solved`, `tried`, `isSPJ`, `isVisible`, `outputLimit`, `javaTimeLimit`, `javaMemoryLimit`, `dataCount`, `difficulty`, `type`, `OPTLOCK`) VALUES (5, '', 'description', 'input', 'output', 'sampleinput', 'sampleoutput', 'hint', 'source', 1000, 65535, 0, 0, 0, 1, 8192, 3000, 65535, 1, 1, 0, NULL);
