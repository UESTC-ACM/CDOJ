...
INSERT INTO `uestcojtest`.`user` (`userId`, `userName`, `studentId`, `departmentId`, `password`, `school`, `nickName`, `email`, `solved`, `tried`, `type`, `lastLogin`, `OPTLOCK`) VALUES (3, 'user_id3', '2010013100008', 2, '3669a3b6618e9b27d641666d764432e025fc5be7', 'UESTC', 'user_id3', 'user_id3@uestc.edu.cn', 0, 0, 2, '2013-01-30 13:17:26', 0);
