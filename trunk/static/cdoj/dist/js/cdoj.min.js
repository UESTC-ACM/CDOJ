/*
 ...
 License: MIT
*/
(function(S,U,s){'use strict';function v(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.2.20-build.286+sha.da0e3c9/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function db(b){if(null==
b||Ea(b))return!1;var a=b.length;return 1===b.nodeType&&a?!0:y(b)||L(b)||0===a||"number"===typeof a&&0<a&&a-1 in b}function q(b,a,c){var d;if(b)if(O(b))for(d in b)"prototype"==d||("length"==d||"name"==d||b.hasOwnProperty&&!b.hasOwnProperty(d))||a.call(c,b[d],d);else if(b.forEach&&b.forEach!==q)b.forEach(a,c);else if(db(b))for(d=0;d<b.length;d++)a.call(c,b[d],d);else for(d in b)b.hasOwnProperty(d)&&a.call(c,b[d],d);return b}function Vb(b){var a=[],c;for(c in b)b.hasOwnProperty(c)&&a.push(c);return a.sort()}
function Tc(b,a,c){for(var d=Vb(b),e=0;e<d.length;e++)a.call(c,b[d[e]],d[e]);return d}function Wb(b){return function(a,c){b(c,a)}}function eb(){for(var b=ka.length,a;b;){b--;a=ka[b].charCodeAt(0);if(57==a)return ka[b]="A",ka.join("");if(90==a)ka[b]="0";else return ka[b]=String.fromCharCode(a+1),ka.join("")}ka.unshift("0");return ka.join("")}function Xb(b,a){a?b.$$hashKey=a:delete b.$$hashKey}function E(b){var a=b.$$hashKey;q(arguments,function(a){a!==b&&q(a,function(a,c){b[c]=a})});Xb(b,a);return b}
function Z(b){return parseInt(b,10)}function Yb(b,a){return E(new (E(function(){},{prototype:b})),a)}function A(){}function Fa(b){return b}function $(b){return function(){return b}}function F(b){return"undefined"===typeof b}function B(b){return"undefined"!==typeof b}function T(b){return null!=b&&"object"===typeof b}function y(b){return"string"===typeof b}function yb(b){return"number"===typeof b}function Oa(b){return"[object Date]"===xa.call(b)}function O(b){return"function"===typeof b}function fb(b){return"[object RegExp]"===
xa.call(b)}function Ea(b){return b&&b.document&&b.location&&b.alert&&b.setInterval}function Uc(b){return!(!b||!(b.nodeName||b.prop&&b.attr&&b.find))}function Vc(b,a,c){var d=[];q(b,function(b,g,f){d.push(a.call(c,b,g,f))});return d}function Pa(b,a){if(b.indexOf)return b.indexOf(a);for(var c=0;c<b.length;c++)if(a===b[c])return c;return-1}function Qa(b,a){var c=Pa(b,a);0<=c&&b.splice(c,1);return a}function Ga(b,a,c,d){if(Ea(b)||b&&b.$evalAsync&&b.$watch)throw Ra("cpws");if(a){if(b===a)throw Ra("cpi");
...
var w=[],u;k.addPollFn=function(a){F(u)&&g(100,p);w.push(a);return a};var K=h.href,X=a.find("base"),z=null;k.url=function(a,c){h!==b.location&&(h=b.location);l!==b.history&&(l=b.history);if(a){if(K!=a)return K=a,d.history?c?l.replaceState(null,"",a):(l.pushState(null,"",a),X.attr("href",X.attr("href"))):(z=a,c?h.replace(a):h.href=a),k}else return z||h.href.replace(/%27/g,"'")};var ha=[],N=!1;k.onUrlChange=function(a){if(!N){if(d.history)x(b).on("popstate",f);if(d.hashchange)x(b).on("hashchange",f);
else k.addPollFn(f);N=!0}ha.push(a);return a};k.baseHref=function(){var a=X.attr("href");return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};var M={},ca="",C=k.baseHref();k.cookies=function(a,b){var d,e,g,k;if(a)b===s?m.cookie=escape(a)+"=;path="+C+";expires=Thu, 01 Jan 1970 00:00:00 GMT":y(b)&&(d=(m.cookie=escape(a)+"="+escape(b)+";path="+C).length+1,4096<d&&c.warn("Cookie '"+a+"' possibly not set or overflowed because it was too large ("+d+" > 4096 bytes)!"));else{if(m.cookie!==ca)for(ca=m.cookie,
...
c;X=a.controller;"@"==X&&(X=u[a.name]);c=t(X,b);ca[a.name]=c;Da||Q.data("$"+a.name+"Controller",c);a.controllerAs&&(b.$scope[a.controllerAs]=c)});f=0;for(z=m.length;f<z;f++)try{D=m[f],D(D.isolateScope?C:e,Q,u,D.require&&J(D.directiveName,D.require,Q,ca),nb)}catch(G){l(G,ga(Q))}f=e;M&&(M.template||null===M.templateUrl)&&(f=C);a&&a(f,g.childNodes,s,n);for(f=p.length-1;0<=f;f--)try{D=p[f],D(D.isolateScope?C:e,Q,u,D.require&&J(D.directiveName,D.require,Q,ca),nb)}catch(B){l(B,ga(Q))}}n=n||{};for(var u=
-Number.MAX_VALUE,X,N=n.controllerDirectives,M=n.newIsolateScopeDirective,H=n.templateDirective,ba=n.nonTlbTranscludeDirective,F=!1,E=!1,Da=n.hasElementTranscludeDirective,v=d.$$element=x(c),G,oa,W,S=e,R,P=0,pa=a.length;P<pa;P++){G=a[P];var V=G.$$start,Y=G.$$end;V&&(v=C(c,V,Y));W=s;if(u>G.priority)break;if(W=G.scope)X=X||G,G.templateUrl||(I("new/isolated scope",M,G,v),T(W)&&(M=G));oa=G.name;!G.templateUrl&&G.controller&&(W=G.controller,N=N||{},I("'"+oa+"' controller",N[oa],G,v),N[oa]=G);if(W=G.transclude)F=
!0,G.$$tlb||(I("transclusion",ba,G,v),ba=G),"element"==W?(Da=!0,u=G.priority,W=C(c,V,Y),v=d.$$element=x(U.createComment(" "+oa+": "+d[oa]+" ")),c=v[0],ob(g,x(za.call(W,0)),c),S=z(W,e,u,f&&f.name,{nonTlbTranscludeDirective:ba})):(W=x(Ib(c)).contents(),v.empty(),S=z(W,e));if(G.template)if(E=!0,I("template",H,G,v),H=G,W=O(G.template)?G.template(v,d):G.template,W=Z(W),G.replace){f=G;W=Gb.test(W)?x(aa(W)):[];c=W[0];if(1!=W.length||1!==c.nodeType)throw ia("tplrt",oa,"");ob(g,v,c);pa={$attr:{}};W=ca(c,[],
pa);var ue=a.splice(P+1,a.length-(P+1));M&&sc(W);a=a.concat(W).concat(ue);B(d,pa);pa=a.length}else v.html(W);if(G.templateUrl)E=!0,I("template",H,G,v),H=G,G.replace&&(f=G),K=A(a.splice(P,a.length-P),v,d,g,F&&S,m,p,{controllerDirectives:N,newIsolateScopeDirective:M,templateDirective:H,nonTlbTranscludeDirective:ba}),pa=a.length;else if(G.compile)try{R=G.compile(v,d,S),O(R)?w(null,R,V,Y):R&&w(R.pre,R.post,V,Y)}catch($){l($,ga(v))}G.terminal&&(K.terminal=!0,u=Math.max(u,G.priority))}K.scope=X&&!0===X.scope;
K.transcludeOnThisElement=F;K.templateOnThisElement=E;K.transclude=S;n.hasElementTranscludeDirective=Da;return K}function sc(a){for(var b=0,c=a.length;b<c;b++)a[b]=Yb(a[b],{$$isolateScope:!0})}function ba(b,e,g,f,h,r,p){if(e===h)return null;h=null;if(c.hasOwnProperty(e)){var n;e=a.get(e+d);for(var t=0,w=e.length;t<w;t++)try{n=e[t],(f===s||f>n.priority)&&-1!=n.restrict.indexOf(g)&&(r&&(n=Yb(n,{$$start:r,$$end:p})),b.push(n),h=n)}catch(J){l(J)}}return h}function B(a,b){var c=b.$attr,d=a.$attr,e=a.$$element;
...
c):w.templateUrl;b.empty();p.get(u.getTrustedResourceUrl(K),{cache:n}).success(function(p){var n,u;p=Z(p);if(w.replace){p=Gb.test(p)?x(aa(p)):[];n=p[0];if(1!=p.length||1!==n.nodeType)throw ia("tplrt",w.name,K);p={$attr:{}};ob(d,b,n);var z=ca(n,[],p);T(w.scope)&&sc(z);a=z.concat(a);B(c,p)}else n=t,b.html(p);a.unshift(J);l=H(a,n,c,e,b,w,g,f,m);q(d,function(a,c){a==n&&(d[c]=b[0])});for(r=N(b[0].childNodes,e);h.length;){p=h.shift();u=h.shift();var D=h.shift(),X=h.shift(),z=b[0];if(u!==t){var C=u.className;
m.hasElementTranscludeDirective&&w.replace||(z=Ib(n));ob(D,x(u),z);ha(x(z),C)}u=l.transcludeOnThisElement?M(p,l.transclude,X):X;l(r,p,z,d,u)}h=null}).error(function(a,b,c,d){throw ia("tpload",d.url);});return function(a,b,c,d,e){a=e;h?(h.push(b),h.push(c),h.push(d),h.push(a)):(l.transcludeOnThisElement&&(a=M(b,l.transclude,e)),l(r,b,c,d,a))}}function F(a,b){var c=b.priority-a.priority;return 0!==c?c:a.name!==b.name?a.name<b.name?-1:1:a.index-b.index}function I(a,b,c,d){if(b)throw ia("multidir",b.name,
c.name,a,ga(d));}function v(a,c){var d=b(c,!0);d&&a.push({priority:0,compile:function(a){var b=a.parent().length;b&&ha(a.parent(),"ng-binding");return function(a,c){var e=c.parent(),g=e.data("$binding")||[];g.push(d);e.data("$binding",g);b||ha(e,"ng-binding");a.$watch(d,function(a){c[0].nodeValue=a})}}})}function S(a,b){if("srcdoc"==b)return u.HTML;var c=La(a);if("xlinkHref"==b||"FORM"==c&&"action"==b||"IMG"!=c&&("src"==b||"ngSrc"==b))return u.RESOURCE_URL}function R(a,c,d,e){var g=b(d,!0);if(g){if("multiple"===
e&&"SELECT"===La(a))throw ia("selmulti",ga(a));c.push({priority:100,compile:function(){return{pre:function(c,d,m){d=m.$$observers||(m.$$observers={});if(f.test(e))throw ia("nodomevents");if(g=b(m[e],!0,S(a,e)))m[e]=g(c),(d[e]||(d[e]=[])).$$inter=!0,(m.$$observers&&m.$$observers[e].$$scope||c).$watch(g,function(a,b){"class"===e&&a!=b?m.$updateClass(a,b):m.$set(e,a)})}}}})}}function ob(a,b,c){var d=b[0],e=b.length,g=d.parentNode,f,m;if(a)for(f=0,m=a.length;f<m;f++)if(a[f]==d){a[f++]=c;m=f+e-1;for(var h=
...
Math.max(b,0);(200<=b&&300>b?u.resolve:u.reject)({data:a,status:b,headers:wc(d),config:c,statusText:e})}function t(){var a=Pa(r.pendingRequests,c);-1!==a&&r.pendingRequests.splice(a,1)}var u=p.defer(),q=u.promise,D,H,x=J(c.url,c.params);r.pendingRequests.push(c);q.then(t,t);(c.cache||e.cache)&&(!1!==c.cache&&"GET"==c.method)&&(D=T(c.cache)?c.cache:T(e.cache)?e.cache:w);if(D)if(H=D.get(x),B(H)){if(H.then)return H.then(t,t),H;L(H)?n(H[1],H[0],la(H[2]),H[3]):n(H,200,{},"OK")}else D.put(x,q);F(H)&&((H=
Lb(c.url)?b.cookies()[c.xsrfCookieName||e.xsrfCookieName]:s)&&(f[c.xsrfHeaderName||e.xsrfHeaderName]=H),a(c.method,x,g,h,f,c.timeout,c.withCredentials,c.responseType));return q}function J(a,b){if(!b)return a;var c=[];Tc(b,function(a,b){null===a||F(a)||(L(a)||(a=[a]),q(a,function(a){T(a)&&(a=sa(a));c.push(Aa(b)+"="+Aa(a))}))});0<c.length&&(a+=(-1==a.indexOf("?")?"?":"&")+c.join("&"));return a}var w=c("$http"),u=[];q(g,function(a){u.unshift(y(a)?n.get(a):n.invoke(a))});q(f,function(a,b){var c=y(a)?
n.get(a):n.invoke(a);u.splice(b,0,{response:function(a){return c(p.when(a))},responseError:function(a){return c(p.reject(a))}})});r.pendingRequests=[];(function(a){q(arguments,function(a){r[a]=function(b,c){return r(E(c||{},{method:a,url:b}))}})})("get","delete","head","jsonp");(function(a){q(arguments,function(a){r[a]=function(b,c,d){return r(E(d||{},{method:a,url:b,data:c}))}})})("post","put");r.defaults=e;return r}]}function we(b){if(8>=P&&(!b.match(/^(get|post|head|put|delete|options)$/i)||!S.XMLHttpRequest))return new S.ActiveXObject("Microsoft.XMLHTTP");
if(S.XMLHttpRequest)return new S.XMLHttpRequest;throw v("$httpBackend")("noxhr");}function Vd(){this.$get=["$browser","$window","$document",function(b,a,c){return xe(b,we,b.defer,a.angular.callbacks,c[0])}]}function xe(b,a,c,d,e){function g(a,b,c){var g=e.createElement("script"),f=null;g.type="text/javascript";g.src=a;g.async=!0;f=function(a){Xa(g,"load",f);Xa(g,"error",f);e.body.removeChild(g);g=null;var k=-1,t="unknown";a&&("load"!==a.type||d[b].called||(a={type:"error"}),t=a.type,k="error"===a.type?
404:200);c&&c(k,t)};pb(g,"load",f);pb(g,"error",f);8>=P&&(g.onreadystatechange=function(){y(g.readyState)&&/loaded|complete/.test(g.readyState)&&(g.onreadystatechange=null,f({type:"load"}))});e.body.appendChild(g);return f}var f=-1;return function(e,m,h,l,p,n,r,t){function J(){u=f;X&&X();z&&z.abort()}function w(a,d,e,g,f){N&&c.cancel(N);X=z=null;0===d&&(d=e?200:"file"==ta(m).protocol?404:0);a(1223===d?204:d,e,g,f||"");b.$$completeOutstandingRequest(A)}var u;b.$$incOutstandingRequestCount();m=m||b.url();
...
$watchCollection:function(a,b){var c=this,d,e,f,k=1<b.length,h=0,m=g(a),l=[],n={},p=!0,q=0;return this.$watch(function(){d=m(c);var a,b;if(T(d))if(db(d))for(e!==l&&(e=l,q=e.length=0,h++),a=d.length,q!==a&&(h++,e.length=q=a),b=0;b<a;b++)e[b]!==e[b]&&d[b]!==d[b]||e[b]===d[b]||(h++,e[b]=d[b]);else{e!==n&&(e=n={},q=0,h++);a=0;for(b in d)d.hasOwnProperty(b)&&(a++,e.hasOwnProperty(b)?e[b]!==d[b]&&(h++,e[b]=d[b]):(q++,e[b]=d[b],h++));if(q>a)for(b in h++,e)e.hasOwnProperty(b)&&!d.hasOwnProperty(b)&&(q--,
delete e[b])}else e!==d&&(e=d,h++);return h},function(){p?(p=!1,b(d,d,c)):b(d,f,c);if(k)if(T(d))if(db(d)){f=Array(d.length);for(var a=0;a<d.length;a++)f[a]=d[a]}else for(a in f={},d)gb.call(d,a)&&(f[a]=d[a]);else f=d})},$digest:function(){var d,g,f,k,h=this.$$asyncQueue,l=this.$$postDigestQueue,q,z,s=b,N,M=[],x,C,D;m("$digest");c=null;do{z=!1;for(N=this;h.length;){try{D=h.shift(),D.scope.$eval(D.expression)}catch(H){n.$$phase=null,e(H)}c=null}a:do{if(k=N.$$watchers)for(q=k.length;q--;)try{if(d=k[q])if((g=
...
return function(c,e){var g="",f=[],k,m;e=e||"mediumDate";e=b.DATETIME_FORMATS[e]||e;y(c)&&(c=Ie.test(c)?Z(c):a(c));yb(c)&&(c=new Date(c));if(!Oa(c))return c;for(;e;)(m=Je.exec(e))?(f=f.concat(za.call(m,1)),e=f.pop()):(f.push(e),e=null);q(f,function(a){k=Ke[a];g+=k?k(c,b.DATETIME_FORMATS):a.replace(/(^'|'$)/g,"").replace(/''/g,"'")});return g}}function Ee(){return function(b){return sa(b,!0)}}function Fe(){return function(b,a){if(!L(b)&&!y(b))return b;a=Infinity===Math.abs(Number(a))?Number(a):Z(a);
...
function(c,d){var f=c&1;if(f!==(d&1)){var h=e(g.$eval(k[b]));f===a?(f=m(h,1),k.$addClass(f)):(f=m(h,-1),k.$removeClass(f))}})}}}]}var Me="validity",I=function(b){return y(b)?b.toLowerCase():b},gb=Object.prototype.hasOwnProperty,Ha=function(b){return y(b)?b.toUpperCase():b},P,x,Ca,za=[].slice,Ne=[].push,xa=Object.prototype.toString,Ra=v("ng"),Ta=S.angular||(S.angular={}),Va,La,ka=["0","0","0"];P=Z((/msie (\d+)/.exec(I(navigator.userAgent))||[])[1]);isNaN(P)&&(P=Z((/trident\/.*; rv:(\d+)/.exec(I(navigator.userAgent))||
[])[1]));A.$inject=[];Fa.$inject=[];var L=function(){return O(Array.isArray)?Array.isArray:function(b){return"[object Array]"===xa.call(b)}}(),aa=function(){return String.prototype.trim?function(b){return y(b)?b.trim():b}:function(b){return y(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}();La=9>P?function(b){b=b.nodeName?b:b[0];return b.scopeName&&"HTML"!=b.scopeName?Ha(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var Yc=/[A-Z]/g,ad={full:"1.2.20-build.286+sha.da0e3c9",
major:1,minor:2,dot:20,codeName:"snapshot"};R.expando="ng339";var Ya=R.cache={},ne=1,pb=S.document.addEventListener?function(b,a,c){b.addEventListener(a,c,!1)}:function(b,a,c){b.attachEvent("on"+a,c)},Xa=S.document.removeEventListener?function(b,a,c){b.removeEventListener(a,c,!1)}:function(b,a,c){b.detachEvent("on"+a,c)};R._data=function(b){return this.cache[b[this.expando]]||{}};var ie=/([\:\-\_]+(.))/g,je=/^moz([A-Z])/,Fb=v("jqLite"),ke=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Gb=/<|&#?\w+;/,le=/<([\w:]+)/,
me=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,ea={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};ea.optgroup=ea.option;ea.tbody=ea.tfoot=ea.colgroup=ea.caption=ea.thead;ea.th=ea.td;var Ka=R.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===
U.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),R(S).on("load",a))},toString:function(){var b=[];q(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?x(this[b]):x(this[this.length+b])},length:0,push:Ne,sort:[].sort,splice:[].splice},mb={};q("multiple selected checked disabled readOnly required open".split(" "),function(b){mb[I(b)]=b});var qc={};q("input select option textarea button form details".split(" "),function(b){qc[Ha(b)]=!0});q({data:mc,inheritedData:lb,
scope:function(b){return x(b).data("$scope")||lb(b.parentNode||b,["$isolateScope","$scope"])},isolateScope:function(b){return x(b).data("$isolateScope")||x(b).data("$isolateScopeNoTemplate")},controller:nc,injector:function(b){return lb(b,"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:Jb,css:function(b,a,c){a=Wa(a);if(B(c))b.style[a]=c;else{var d;8>=P&&(d=b.currentStyle&&b.currentStyle[a],""===d&&(d="auto"));d=d||b.style[a];8>=P&&(d=""===d?s:d);return d}},attr:function(b,a,
c){var d=I(a);if(mb[d])if(B(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||A).specified?d:s;else if(B(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,2),null===b?s:b},prop:function(b,a,c){if(B(c))b[a]=c;else return b[a]},text:function(){function b(b,d){var e=a[b.nodeType];if(F(d))return e?b[e]:"";b[e]=d}var a=[];9>P?(a[1]="innerText",a[3]="nodeValue"):a[1]=a[3]="textContent";b.$dv="";return b}(),val:function(b,
...
b.$dv;f=e===s?Math.min(f,1):f;for(g=0;g<f;g++){var k=b(this[g],a,d);e=e?e+k:k}return e}for(e=0;e<f;e++)b(this[e],a,d);return this}});q({removeData:kc,dealoc:Ia,on:function a(c,d,e,g){if(B(g))throw Fb("onargs");var f=ma(c,"events"),k=ma(c,"handle");f||ma(c,"events",f={});k||ma(c,"handle",k=oe(c,f));q(d.split(" "),function(d){var g=f[d];if(!g){if("mouseenter"==d||"mouseleave"==d){var l=U.body.contains||U.body.compareDocumentPosition?function(a,c){var d=9===a.nodeType?a.documentElement:a,e=c&&c.parentNode;
...
y(c)?c:L(c)?c.join(" "):"";q(a,function(a){jb(a,c)});f&&d(f)},setClass:function(a,c,f,k){q(a,function(a){kb(a,c);jb(a,f)});k&&d(k)},enabled:A}}]}],ia=v("$compile");fc.$inject=["$provide","$$sanitizeUriProvider"];var ve=/^(x[\:\-_]|data[\:\-_])/i,yc=v("$interpolate"),Pe=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,ye={http:80,https:443,ftp:21},Ob=v("$location");Qb.prototype=Pb.prototype=Bc.prototype={$$html5:!1,$$replace:!1,absUrl:qb("$$absUrl"),url:function(a,c){if(F(a))return this.$$url;var d=Pe.exec(a);d[1]&&
...
EEE:sb("Day",!0),a:function(a,c){return 12>a.getHours()?c.AMPMS[0]:c.AMPMS[1]},Z:function(a){a=-1*a.getTimezoneOffset();return a=(0<=a?"+":"")+(Tb(Math[0<a?"floor":"ceil"](a/60),2)+Tb(Math.abs(a%60),2))}},Je=/((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,Ie=/^\-?\d+$/;Jc.$inject=["$locale"];var Ge=$(I),He=$(Ha);Lc.$inject=["$parse"];var dd=$({restrict:"E",compile:function(a,c){8>=P&&(c.href||c.name||c.$set("href",""),a.append(U.createComment("IE fix")));if(!c.href&&
!c.xlinkHref&&!c.name)return function(a,c){var g="[object SVGAnimatedString]"===xa.call(c.prop("href"))?"xlink:href":"href";c.on("click",function(a){c.attr(g)||a.preventDefault()})}}}),Db={};q(mb,function(a,c){if("multiple"!=a){var d=na("ng-"+c);Db[d]=function(){return{priority:100,link:function(a,g,f){a.$watch(f[d],function(a){f.$set(c,!!a)})}}}}});q(["src","srcset","href"],function(a){var c=na("ng-"+a);Db[c]=function(){return{priority:99,link:function(d,e,g){var f=a,k=a;"href"===a&&"[object SVGAnimatedString]"===
...
!1};pb(e[0],"submit",k);e.on("$destroy",function(){c(function(){Xa(e[0],"submit",k)},0,!1)})}var m=e.parent().controller("form"),h=g.name||g.ngForm;h&&rb(a,h,f,h);if(m)e.on("$destroy",function(){m.$removeControl(f);h&&rb(a,h,s,h);E(f,vb)})}}}}}]},ed=Rc(),rd=Rc(!0),Te=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,Ue=/^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,Ve=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,Sc={text:xb,
...
g:f})},hidden:A,button:A,submit:A,reset:A,file:A},We=["badInput"],gc=["$browser","$sniffer",function(a,c){return{restrict:"E",require:"?ngModel",link:function(d,e,g,f){f&&(Sc[I(g.type)]||Sc.text)(d,e,g,f,c,a)}}}],ub="ng-valid",tb="ng-invalid",Na="ng-pristine",wb="ng-dirty",Xe=["$scope","$exceptionHandler","$attrs","$element","$parse","$animate",function(a,c,d,e,g,f){function k(a,c){c=c?"-"+ib(c,"-"):"";f.removeClass(e,(a?tb:ub)+c);f.addClass(e,(a?ub:tb)+c)}this.$modelValue=this.$viewValue=Number.NaN;
...
a.join(", "):s});e.$isEmpty=function(a){return!a||!a.length}}}},Ye=/^(true|false|\d+)$/,Jd=function(){return{priority:100,compile:function(a,c){return Ye.test(c.ngValue)?function(a,c,g){g.$set("value",a.$eval(g.ngValue))}:function(a,c,g){a.$watch(g.ngValue,function(a){g.$set("value",a)})}}}},jd=wa({compile:function(a){a.addClass("ng-binding");return function(a,d,e){d.data("$binding",e.ngBind);a.$watch(e.ngBind,function(a){d.text(a==s?"":a)})}}}),ld=["$interpolate",function(a){return function(c,d,
...
k.src,h=k.onload||"",l=k.autoscroll;return function(f,k,q,t,J){var w=0,u,s,x,z=function(){s&&(s.remove(),s=null);u&&(u.$destroy(),u=null);x&&(e.leave(x,function(){s=null}),s=x,x=null)};f.$watch(g.parseAsResourceUrl(m),function(g){var m=function(){!B(l)||l&&!f.$eval(l)||d()},q=++w;g?(a.get(g,{cache:c}).success(function(a){if(q===w){var c=f.$new();t.template=a;a=J(c,function(a){z();e.enter(a,null,k,m)});u=c;x=a;u.$emit("$includeContentLoaded");f.$eval(h)}}).error(function(){q===w&&z()}),f.$emit("$includeContentRequested")):
...
a.put(d.id,c[0].text)}}}],Ze=v("ngOptions"),Ed=$({terminal:!0}),gd=["$compile","$parse",function(a,c){var d=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,e={$setViewValue:A};return{restrict:"E",require:["select","?ngModel"],controller:["$element","$scope","$attrs",function(a,c,d){var m=this,h={},l=e,p;m.databound=d.ngModel;m.init=function(a,c,d){l=
...
angular.module("monospaced.elastic",[]).constant("msdElasticConfig",{append:""}).directive("msdElastic",["$timeout","$window","msdElasticConfig",function(b,c,a){return{require:"ngModel",restrict:"A, C",link:function(d,e,u,p){var n=e[0],l=e;if(n.nodeName!=="TEXTAREA"||!c.getComputedStyle){return}l.css({overflow:"hidden","overflow-y":"hidden","word-wrap":"break-word"});var q=n.value;n.value="";n.value=q;var A=u.msdElastic||a.append,z=A==="\\n"?"\n":A,s=angular.element(c),D="position: absolute; top: -999px; right: auto; bottom: auto; left: 0 ;overflow: hidden; -webkit-box-sizing: content-box;-moz-box-sizing: content-box; box-sizing: content-box;min-height: 0 !important; height: 0 !important; padding: 0;word-wrap: break-word; border: 0;",w=angular.element('<textarea tabindex="-1" style="'+D+'"/>').data("elastic",true),r=w[0],m=getComputedStyle(n),B=m.getPropertyValue("resize"),o=m.getPropertyValue("box-sizing")==="border-box"||m.getPropertyValue("-moz-box-sizing")==="border-box"||m.getPropertyValue("-webkit-box-sizing")==="border-box",y=!o?{width:0,height:0}:{width:parseInt(m.getPropertyValue("border-right-width"),10)+parseInt(m.getPropertyValue("padding-right"),10)+parseInt(m.getPropertyValue("padding-left"),10)+parseInt(m.getPropertyValue("border-left-width"),10),height:parseInt(m.getPropertyValue("border-top-width"),10)+parseInt(m.getPropertyValue("padding-top"),10)+parseInt(m.getPropertyValue("padding-bottom"),10)+parseInt(m.getPropertyValue("border-bottom-width"),10)},f=parseInt(m.getPropertyValue("min-height"),10),x=parseInt(m.getPropertyValue("height"),10),j=Math.max(f,x)-y.height,t=parseInt(m.getPropertyValue("max-height"),10),k,i,g=["font-family","font-size","font-weight","font-style","letter-spacing","line-height","text-transform","word-spacing","text-indent"];if(l.data("elastic")){return}t=t&&t>0?t:90000;if(r.parentNode!==document.body){angular.element(document.body).append(r)}l.css({resize:(B==="none"||B==="vertical")?"none":"horizontal"}).data("elastic",true);function h(){k=n;m=getComputedStyle(n);angular.forEach(g,function(E){D+=E+":"+m.getPropertyValue(E)+";"});r.setAttribute("style",D)}function v(){var H,E,F,G,I;if(k!==n){h()}if(!i){i=true;r.value=n.value+z;r.style.overflowY=n.style.overflowY;H=n.style.height===""?"auto":parseInt(n.style.height,10);E=getComputedStyle(n).getPropertyValue("width");if(E.substr(E.length-2,2)==="px"){G=parseInt(E,10)-y.width;r.style.width=G+"px"}F=r.scrollHeight;if(F>t){F=t;I="scroll"}else{if(F<j){F=j}}F+=y.height;n.style.overflowY=I||"hidden";if(H!==F){n.style.height=F+"px";d.$emit("elastic:resize",l)}b(function(){i=false},1)}}function C(){i=false;v()}if("onpropertychange" in n&&"oninput" in n){n.oninput=n.onkeyup=v}else{n.oninput=v}s.bind("resize",C);d.$watch(function(){return p.$modelValue},function(E){C()});d.$on("elastic:adjust",function(){C()});b(v);d.$on("$destroy",function(){w.remove();s.unbind("resize",C)})}}}]);var CryptoJS=CryptoJS||(function(e,g){var a={};var b=a.lib={};var j=b.Base=(function(){function n(){}return{extend:function(p){n.prototype=this;var o=new n();if(p){o.mixIn(p)}if(!o.hasOwnProperty("init")){o.init=function(){o.$super.init.apply(this,arguments)}}o.init.prototype=o;o.$super=this;return o},create:function(){var o=this.extend();o.init.apply(o,arguments);return o},init:function(){},mixIn:function(p){for(var o in p){if(p.hasOwnProperty(o)){this[o]=p[o]}}if(p.hasOwnProperty("toString")){this.toString=p.toString}},clone:function(){return this.init.prototype.extend(this)}}}());var l=b.WordArray=j.extend({init:function(o,n){o=this.words=o||[];if(n!=g){this.sigBytes=n}else{this.sigBytes=o.length*4}},toString:function(n){return(n||h).stringify(this)},concat:function(t){var q=this.words;var p=t.words;var n=this.sigBytes;var s=t.sigBytes;this.clamp();if(n%4){for(var r=0;r<s;r++){var o=(p[r>>>2]>>>(24-(r%4)*8))&255;q[(n+r)>>>2]|=o<<(24-((n+r)%4)*8)}}else{if(p.length>65535){for(var r=0;r<s;r+=4){q[(n+r)>>>2]=p[r>>>2]}}else{q.push.apply(q,p)}}this.sigBytes+=s;return this},clamp:function(){var o=this.words;var n=this.sigBytes;o[n>>>2]&=4294967295<<(32-(n%4)*8);o.length=e.ceil(n/4)},clone:function(){var n=j.clone.call(this);n.words=this.words.slice(0);return n},random:function(p){var o=[];for(var n=0;n<p;n+=4){o.push((e.random()*4294967296)|0)}return new l.init(o,p)}});var m=a.enc={};var h=m.Hex={stringify:function(p){var r=p.words;var o=p.sigBytes;var q=[];for(var n=0;n<o;n++){var s=(r[n>>>2]>>>(24-(n%4)*8))&255;q.push((s>>>4).toString(16));q.push((s&15).toString(16))}return q.join("")},parse:function(p){var n=p.length;var q=[];for(var o=0;o<n;o+=2){q[o>>>3]|=parseInt(p.substr(o,2),16)<<(24-(o%8)*4)}return new l.init(q,n/2)}};var d=m.Latin1={stringify:function(q){var r=q.words;var p=q.sigBytes;var n=[];for(var o=0;o<p;o++){var s=(r[o>>>2]>>>(24-(o%4)*8))&255;n.push(String.fromCharCode(s))}return n.join("")},parse:function(p){var n=p.length;var q=[];for(var o=0;o<n;o++){q[o>>>2]|=(p.charCodeAt(o)&255)<<(24-(o%4)*8)}return new l.init(q,n)}};var c=m.Utf8={stringify:function(n){try{return decodeURIComponent(escape(d.stringify(n)))}catch(o){throw new Error("Malformed UTF-8 data")}},parse:function(n){return d.parse(unescape(encodeURIComponent(n)))}};var i=b.BufferedBlockAlgorithm=j.extend({reset:function(){this._data=new l.init();this._nDataBytes=0},_append:function(n){if(typeof n=="string"){n=c.parse(n)}this._data.concat(n);this._nDataBytes+=n.sigBytes},_process:function(w){var q=this._data;var x=q.words;var n=q.sigBytes;var t=this.blockSize;var v=t*4;var u=n/v;if(w){u=e.ceil(u)}else{u=e.max((u|0)-this._minBufferSize,0)}var s=u*t;var r=e.min(s*4,n);if(s){for(var p=0;p<s;p+=t){this._doProcessBlock(x,p)}var o=x.splice(0,s);q.sigBytes-=r}return new l.init(o,r)},clone:function(){var n=j.clone.call(this);n._data=this._data.clone();return n},_minBufferSize:0});var f=b.Hasher=i.extend({cfg:j.extend(),init:function(n){this.cfg=this.cfg.extend(n);this.reset()},reset:function(){i.reset.call(this);this._doReset()},update:function(n){this._append(n);this._process();return this},finalize:function(n){if(n){this._append(n)}var o=this._doFinalize();return o},blockSize:512/32,_createHelper:function(n){return function(p,o){return new n.init(o).finalize(p)}},_createHmacHelper:function(n){return function(p,o){return new k.HMAC.init(n,o).finalize(p)}}});var k=a.algo={};return a}(Math));(function(c){var a=CryptoJS;var b=a.lib;var i=b.WordArray;var e=b.Hasher;var j=a.algo;var f=[];(function(){for(var m=0;m<64;m++){f[m]=(c.abs(c.sin(m+1))*4294967296)|0}}());var k=j.MD5=e.extend({_doReset:function(){this._hash=new i.init([1732584193,4023233417,2562383102,271733878])},_doProcessBlock:function(s,n){for(var I=0;I<16;I++){var m=n+I;var o=s[m];s[m]=((((o<<8)|(o>>>24))&16711935)|(((o<<24)|(o>>>8))&4278255360))}var x=this._hash.words;var A=s[n+0];var z=s[n+1];var y=s[n+2];var w=s[n+3];var v=s[n+4];var u=s[n+5];var t=s[n+6];var r=s[n+7];var q=s[n+8];var p=s[n+9];var G=s[n+10];var F=s[n+11];var E=s[n+12];var D=s[n+13];var C=s[n+14];var B=s[n+15];var N=x[0];var L=x[1];var K=x[2];var J=x[3];N=h(N,L,K,J,A,7,f[0]);J=h(J,N,L,K,z,12,f[1]);K=h(K,J,N,L,y,17,f[2]);L=h(L,K,J,N,w,22,f[3]);N=h(N,L,K,J,v,7,f[4]);J=h(J,N,L,K,u,12,f[5]);K=h(K,J,N,L,t,17,f[6]);L=h(L,K,J,N,r,22,f[7]);N=h(N,L,K,J,q,7,f[8]);J=h(J,N,L,K,p,12,f[9]);K=h(K,J,N,L,G,17,f[10]);L=h(L,K,J,N,F,22,f[11]);N=h(N,L,K,J,E,7,f[12]);J=h(J,N,L,K,D,12,f[13]);K=h(K,J,N,L,C,17,f[14]);L=h(L,K,J,N,B,22,f[15]);N=d(N,L,K,J,z,5,f[16]);J=d(J,N,L,K,t,9,f[17]);K=d(K,J,N,L,F,14,f[18]);L=d(L,K,J,N,A,20,f[19]);N=d(N,L,K,J,u,5,f[20]);J=d(J,N,L,K,G,9,f[21]);K=d(K,J,N,L,B,14,f[22]);L=d(L,K,J,N,v,20,f[23]);N=d(N,L,K,J,p,5,f[24]);J=d(J,N,L,K,C,9,f[25]);K=d(K,J,N,L,w,14,f[26]);L=d(L,K,J,N,q,20,f[27]);N=d(N,L,K,J,D,5,f[28]);J=d(J,N,L,K,y,9,f[29]);K=d(K,J,N,L,r,14,f[30]);L=d(L,K,J,N,E,20,f[31]);N=l(N,L,K,J,u,4,f[32]);J=l(J,N,L,K,q,11,f[33]);K=l(K,J,N,L,F,16,f[34]);L=l(L,K,J,N,C,23,f[35]);N=l(N,L,K,J,z,4,f[36]);J=l(J,N,L,K,v,11,f[37]);K=l(K,J,N,L,r,16,f[38]);L=l(L,K,J,N,G,23,f[39]);N=l(N,L,K,J,D,4,f[40]);J=l(J,N,L,K,A,11,f[41]);K=l(K,J,N,L,w,16,f[42]);L=l(L,K,J,N,t,23,f[43]);N=l(N,L,K,J,p,4,f[44]);J=l(J,N,L,K,E,11,f[45]);K=l(K,J,N,L,B,16,f[46]);L=l(L,K,J,N,y,23,f[47]);N=g(N,L,K,J,A,6,f[48]);J=g(J,N,L,K,r,10,f[49]);K=g(K,J,N,L,C,15,f[50]);L=g(L,K,J,N,u,21,f[51]);N=g(N,L,K,J,E,6,f[52]);J=g(J,N,L,K,w,10,f[53]);K=g(K,J,N,L,G,15,f[54]);L=g(L,K,J,N,z,21,f[55]);N=g(N,L,K,J,q,6,f[56]);J=g(J,N,L,K,B,10,f[57]);K=g(K,J,N,L,t,15,f[58]);L=g(L,K,J,N,D,21,f[59]);N=g(N,L,K,J,v,6,f[60]);J=g(J,N,L,K,F,10,f[61]);K=g(K,J,N,L,y,15,f[62]);L=g(L,K,J,N,p,21,f[63]);x[0]=(x[0]+N)|0;x[1]=(x[1]+L)|0;x[2]=(x[2]+K)|0;x[3]=(x[3]+J)|0},_doFinalize:function(){var q=this._data;var v=q.words;var s=this._nDataBytes*8;var t=q.sigBytes*8;v[t>>>5]|=128<<(24-t%32);var r=c.floor(s/4294967296);var n=s;v[(((t+64)>>>9)<<4)+15]=((((r<<8)|(r>>>24))&16711935)|(((r<<24)|(r>>>8))&4278255360));v[(((t+64)>>>9)<<4)+14]=((((n<<8)|(n>>>24))&16711935)|(((n<<24)|(n>>>8))&4278255360));q.sigBytes=(v.length+1)*4;this._process();var p=this._hash;var u=p.words;for(var o=0;o<4;o++){var m=u[o];u[o]=(((m<<8)|(m>>>24))&16711935)|(((m<<24)|(m>>>8))&4278255360)}return p},clone:function(){var m=e.clone.call(this);m._hash=this._hash.clone();return m}});function h(p,o,w,u,m,r,q){var v=p+((o&w)|(~o&u))+m+q;return((v<<r)|(v>>>(32-r)))+o}function d(p,o,w,u,m,r,q){var v=p+((o&u)|(w&~u))+m+q;return((v<<r)|(v>>>(32-r)))+o}function l(p,o,w,u,m,r,q){var v=p+(o^w^u)+m+q;return((v<<r)|(v>>>(32-r)))+o}function g(p,o,w,u,m,r,q){var v=p+(w^(o|~u))+m+q;return((v<<r)|(v>>>(32-r)))+o}a.MD5=e._createHelper(k);a.HmacMD5=e._createHmacHelper(k)}(Math));(function(){var g=CryptoJS;var d=g.lib;var f=d.WordArray;var b=d.Hasher;var e=g.algo;var a=[];var c=e.SHA1=b.extend({_doReset:function(){this._hash=new f.init([1732584193,4023233417,2562383102,271733878,3285377520])},_doProcessBlock:function(m,j){var s=this._hash.words;var r=s[0];var q=s[1];var p=s[2];var o=s[3];var l=s[4];for(var k=0;k<80;k++){if(k<16){a[k]=m[j+k]|0}else{var h=a[k-3]^a[k-8]^a[k-14]^a[k-16];a[k]=(h<<1)|(h>>>31)}var u=((r<<5)|(r>>>27))+l+a[k];if(k<20){u+=((q&p)|(~q&o))+1518500249}else{if(k<40){u+=(q^p^o)+1859775393}else{if(k<60){u+=((q&p)|(q&o)|(p&o))-1894007588}else{u+=(q^p^o)-899497514}}}l=o;o=p;p=(q<<30)|(q>>>2);q=r;r=u}s[0]=(s[0]+r)|0;s[1]=(s[1]+q)|0;s[2]=(s[2]+p)|0;s[3]=(s[3]+o)|0;s[4]=(s[4]+l)|0},_doFinalize:function(){var j=this._data;var k=j.words;var h=this._nDataBytes*8;var i=j.sigBytes*8;k[i>>>5]|=128<<(24-i%32);k[(((i+64)>>>9)<<4)+14]=Math.floor(h/4294967296);k[(((i+64)>>>9)<<4)+15]=h;j.sigBytes=k.length*4;this._process();return this._hash},clone:function(){var h=b.clone.call(this);h._hash=this._hash.clone();return h}});g.SHA1=b._createHelper(c);g.HmacSHA1=b._createHmacHelper(c)}());window.PR_SHOULD_USE_CONTINUATION=true;var prettyPrintOne;var prettyPrint;(function(){var O=window;var j=["break,continue,do,else,for,if,return,while"];var v=[j,"auto,case,char,const,default,double,enum,extern,float,goto,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"];var q=[v,"catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"];var m=[q,"alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,dynamic_cast,explicit,export,friend,inline,late_check,mutable,namespace,nullptr,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"];var y=[q,"abstract,boolean,byte,extends,final,finally,implements,import,instanceof,null,native,package,strictfp,super,synchronized,throws,transient"];var T=[y,"as,base,by,checked,decimal,delegate,descending,dynamic,event,fixed,foreach,from,group,implicit,in,interface,internal,into,is,let,lock,object,out,override,orderby,params,partial,readonly,ref,sbyte,sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort,var,virtual,where"];var s="all,and,by,catch,class,else,extends,false,finally,for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then,throw,true,try,unless,until,when,while,yes";var x=[q,"debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"];var t="caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END";var J=[j,"and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"];var g=[j,"alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"];var I=[j,"case,done,elif,esac,eval,fi,function,in,local,set,then,until"];var B=[m,T,x,t+J,g,I];var f=/^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/;var D="str";var A="kwd";var k="com";var Q="typ";var H="lit";var M="pun";var G="pln";var n="tag";var F="dec";var K="src";var R="atn";var o="atv";var P="nocode";var N="(?:^^\\.?|[+-]|[!=]=?=?|\\#|%=?|&&?=?|\\(|\\*=?|[+\\-]=|->|\\/=?|::?|<<?=?|>>?>?=?|,|;|\\?|@|\\[|~|{|\\^\\^?=?|\\|\\|?=?|break|case|continue|delete|do|else|finally|instanceof|return|throw|try|typeof)\\s*";function l(ab){var af=0;var U=false;var ae=false;for(var X=0,W=ab.length;X<W;++X){var ag=ab[X];if(ag.ignoreCase){ae=true}else{if(/[a-z]/i.test(ag.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi,""))){U=true;ae=false;break}}}var aa={b:8,t:9,n:10,v:11,f:12,r:13};function ad(aj){var ai=aj.charCodeAt(0);if(ai!==92){return ai}var ah=aj.charAt(1);ai=aa[ah];if(ai){return ai}else{if("0"<=ah&&ah<="7"){return parseInt(aj.substring(1),8)}else{if(ah==="u"||ah==="x"){return parseInt(aj.substring(2),16)}else{return aj.charCodeAt(1)}}}}function V(ah){if(ah<32){return(ah<16?"\\x0":"\\x")+ah.toString(16)}var ai=String.fromCharCode(ah);return(ai==="\\"||ai==="-"||ai==="]"||ai==="^")?"\\"+ai:ai}function Z(an){var ar=an.substring(1,an.length-1).match(new RegExp("\\\\u[0-9A-Fa-f]{4}|\\\\x[0-9A-Fa-f]{2}|\\\\[0-3][0-7]{0,2}|\\\\[0-7]{1,2}|\\\\[\\s\\S]|-|[^-\\\\]","g"));var ah=[];var ap=ar[0]==="^";var ao=["["];if(ap){ao.push("^")}for(var at=ap?1:0,al=ar.length;at<al;++at){var aj=ar[at];if(/\\[bdsw]/i.test(aj)){ao.push(aj)}else{var ai=ad(aj);var am;if(at+2<al&&"-"===ar[at+1]){am=ad(ar[at+2]);at+=2}else{am=ai}ah.push([ai,am]);if(!(am<65||ai>122)){if(!(am<65||ai>90)){ah.push([Math.max(65,ai)|32,Math.min(am,90)|32])}if(!(am<97||ai>122)){ah.push([Math.max(97,ai)&~32,Math.min(am,122)&~32])}}}}ah.sort(function(aw,av){return(aw[0]-av[0])||(av[1]-aw[1])});var ak=[];var aq=[];for(var at=0;at<ah.length;++at){var au=ah[at];if(au[0]<=aq[1]+1){aq[1]=Math.max(aq[1],au[1])}else{ak.push(aq=au)}}for(var at=0;at<ak.length;++at){var au=ak[at];ao.push(V(au[0]));if(au[1]>au[0]){if(au[1]+1>au[0]){ao.push("-")}ao.push(V(au[1]))}}ao.push("]");return ao.join("")}function Y(an){var al=an.source.match(new RegExp("(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)","g"));var aj=al.length;var ap=[];for(var am=0,ao=0;am<aj;++am){var ai=al[am];if(ai==="("){++ao}else{if("\\"===ai.charAt(0)){var ah=+ai.substring(1);if(ah){if(ah<=ao){ap[ah]=-1}else{al[am]=V(ah)}}}}}for(var am=1;am<ap.length;++am){if(-1===ap[am]){ap[am]=++af}}for(var am=0,ao=0;am<aj;++am){var ai=al[am];if(ai==="("){++ao;if(!ap[ao]){al[am]="(?:"}}else{if("\\"===ai.charAt(0)){var ah=+ai.substring(1);if(ah&&ah<=ao){al[am]="\\"+ap[ah]}}}}for(var am=0;am<aj;++am){if("^"===al[am]&&"^"!==al[am+1]){al[am]=""}}if(an.ignoreCase&&U){for(var am=0;am<aj;++am){var ai=al[am];var ak=ai.charAt(0);if(ai.length>=2&&ak==="["){al[am]=Z(ai)}else{if(ak!=="\\"){al[am]=ai.replace(/[a-zA-Z]/g,function(aq){var ar=aq.charCodeAt(0);return"["+String.fromCharCode(ar&~32,ar|32)+"]"})}}}}return al.join("")}var ac=[];for(var X=0,W=ab.length;X<W;++X){var ag=ab[X];if(ag.global||ag.multiline){throw new Error(""+ag)}ac.push("(?:"+Y(ag)+")")}return new RegExp(ac.join("|"),ae?"gi":"g")}function b(aa,Y){var W=/(?:^|\s)nocode(?:\s|$)/;var ab=[];var Z=0;var X=[];var V=0;function U(ac){switch(ac.nodeType){case 1:if(W.test(ac.className)){return}for(var af=ac.firstChild;af;af=af.nextSibling){U(af)}var ae=ac.nodeName.toLowerCase();if("br"===ae||"li"===ae){ab[V]="\n";X[V<<1]=Z++;X[(V++<<1)|1]=ac}break;case 3:case 4:var ad=ac.nodeValue;if(ad.length){if(!Y){ad=ad.replace(/[ \t\r\n]+/g," ")}else{ad=ad.replace(/\r\n?/g,"\n")}ab[V]=ad;X[V<<1]=Z;Z+=ad.length;X[(V++<<1)|1]=ac}break}}U(aa);return{sourceCode:ab.join("").replace(/\n$/,""),spans:X}}function C(U,W,Y,V){if(!W){return}var X={sourceCode:W,basePos:U};Y(X);V.push.apply(V,X.decorations)}var w=/\S/;function p(U){var X=undefined;for(var W=U.firstChild;W;W=W.nextSibling){var V=W.nodeType;X=(V===1)?(X?U:W):(V===3)?(w.test(W.nodeValue)?U:X):X}return X===U?undefined:X}function h(W,V){var U={};var X;(function(){var af=W.concat(V);var aj=[];var ai={};for(var ad=0,ab=af.length;ad<ab;++ad){var aa=af[ad];var ae=aa[3];if(ae){for(var ag=ae.length;--ag>=0;){U[ae.charAt(ag)]=aa}}var ah=aa[1];var ac=""+ah;if(!ai.hasOwnProperty(ac)){aj.push(ah);ai[ac]=null}}aj.push(/[\0-\uffff]/);X=l(aj)})();var Z=V.length;var Y=function(aj){var ab=aj.sourceCode,aa=aj.basePos;var af=[aa,G];var ah=0;var ap=ab.match(X)||[];var al={};for(var ag=0,at=ap.length;ag<at;++ag){var ai=ap[ag];var ar=al[ai];var ak=void 0;var ao;if(typeof ar==="string"){ao=false}else{var ac=U[ai.charAt(0)];if(ac){ak=ai.match(ac[1]);ar=ac[0]}else{for(var aq=0;aq<Z;++aq){ac=V[aq];ak=ai.match(ac[1]);if(ak){ar=ac[0];break}}if(!ak){ar=G}}ao=ar.length>=5&&"lang-"===ar.substring(0,5);if(ao&&!(ak&&typeof ak[1]==="string")){ao=false;ar=K}if(!ao){al[ai]=ar}}var ad=ah;ah+=ai.length;if(!ao){af.push(aa+ad,ar)}else{var an=ak[1];var am=ai.indexOf(an);var ae=am+an.length;if(ak[2]){ae=ai.length-ak[2].length;am=ae-an.length}var au=ar.substring(5);C(aa+ad,ai.substring(0,am),Y,af);C(aa+ad+am,an,r(au,an),af);C(aa+ad+ae,ai.substring(ae),Y,af)}}aj.decorations=af};return Y}function i(V){var Y=[],U=[];if(V.tripleQuotedStrings){Y.push([D,/^(?:\'\'\'(?:[^\'\\]|\\[\s\S]|\'{1,2}(?=[^\']))*(?:\'\'\'|$)|\"\"\"(?:[^\"\\]|\\[\s\S]|\"{1,2}(?=[^\"]))*(?:\"\"\"|$)|\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$))/,null,"'\""])}else{if(V.multiLineStrings){Y.push([D,/^(?:\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$)|\`(?:[^\\\`]|\\[\s\S])*(?:\`|$))/,null,"'\"`"])}else{Y.push([D,/^(?:\'(?:[^\\\'\r\n]|\\.)*(?:\'|$)|\"(?:[^\\\"\r\n]|\\.)*(?:\"|$))/,null,"\"'"])}}if(V.verbatimStrings){U.push([D,/^@\"(?:[^\"]|\"\")*(?:\"|$)/,null])}var ab=V.hashComments;if(ab){if(V.cStyleComments){if(ab>1){Y.push([k,/^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/,null,"#"])}else{Y.push([k,/^#(?:(?:define|e(?:l|nd)if|else|error|ifn?def|include|line|pragma|undef|warning)\b|[^\r\n]*)/,null,"#"])}U.push([D,/^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h(?:h|pp|\+\+)?|[a-z]\w*)>/,null])}else{Y.push([k,/^#[^\r\n]*/,null,"#"])}}if(V.cStyleComments){U.push([k,/^\/\/[^\r\n]*/,null]);U.push([k,/^\/\*[\s\S]*?(?:\*\/|$)/,null])}if(V.regexLiterals){var aa=("/(?=[^/*])(?:[^/\\x5B\\x5C]|\\x5C[\\s\\S]|\\x5B(?:[^\\x5C\\x5D]|\\x5C[\\s\\S])*(?:\\x5D|$))+/");U.push(["lang-regex",new RegExp("^"+N+"("+aa+")")])}var X=V.types;if(X){U.push([Q,X])}var W=(""+V.keywords).replace(/^ | $/g,"");if(W.length){U.push([A,new RegExp("^(?:"+W.replace(/[\s,]+/g,"|")+")\\b"),null])}Y.push([G,/^\s+/,null," \r\n\t\xA0"]);var Z=/^.[^\s\w\.$@\'\"\`\/\\]*/;U.push([H,/^@[a-z_$][a-z_$@0-9]*/i,null],[Q,/^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/,null],[G,/^[a-z_$][a-z_$@0-9]*/i,null],[H,new RegExp("^(?:0x[a-f0-9]+|(?:\\d(?:_\\d+)*\\d*(?:\\.\\d*)?|\\.\\d\\+)(?:e[+\\-]?\\d+)?)[a-z]*","i"),null,"0123456789"],[G,/^\\[\s\S]?/,null],[M,Z,null]);return h(Y,U)}var L=i({keywords:B,hashComments:true,cStyleComments:true,multiLineStrings:true,regexLiterals:true});function S(W,ah,aa){var V=/(?:^|\s)nocode(?:\s|$)/;var ac=/\r\n?|\n/;var ad=W.ownerDocument;var ag=ad.createElement("li");while(W.firstChild){ag.appendChild(W.firstChild)}var X=[ag];function af(am){switch(am.nodeType){case 1:if(V.test(am.className)){break}if("br"===am.nodeName){ae(am);if(am.parentNode){am.parentNode.removeChild(am)}}else{for(var ao=am.firstChild;ao;ao=ao.nextSibling){af(ao)}}break;case 3:case 4:if(aa){var an=am.nodeValue;var ak=an.match(ac);if(ak){var aj=an.substring(0,ak.index);am.nodeValue=aj;var ai=an.substring(ak.index+ak[0].length);if(ai){var al=am.parentNode;al.insertBefore(ad.createTextNode(ai),am.nextSibling)}ae(am);if(!aj){am.parentNode.removeChild(am)}}}break}}function ae(al){while(!al.nextSibling){al=al.parentNode;if(!al){return}}function aj(am,at){var ar=at?am.cloneNode(false):am;var ap=am.parentNode;if(ap){var aq=aj(ap,1);var ao=am.nextSibling;aq.appendChild(ar);for(var an=ao;an;an=ao){ao=an.nextSibling;aq.appendChild(an)}}return ar}var ai=aj(al.nextSibling,0);for(var ak;(ak=ai.parentNode)&&ak.nodeType===1;){ai=ak}X.push(ai)}for(var Z=0;Z<X.length;++Z){af(X[Z])}if(ah===(ah|0)){X[0].setAttribute("value",ah)}var ab=ad.createElement("ol");ab.className="linenums";var Y=Math.max(0,((ah-1))|0)||0;for(var Z=0,U=X.length;Z<U;++Z){ag=X[Z];ag.className="L"+((Z+Y)%10);if(!ag.firstChild){ag.appendChild(ad.createTextNode("\xA0"))}ab.appendChild(ag)}W.appendChild(ab)}function E(af){var X=/\bMSIE\s(\d+)/.exec(navigator.userAgent);X=X&&+X[1]<=8;var ao=/\n/g;var an=af.sourceCode;var ap=an.length;var Y=0;var ad=af.spans;var V=ad.length;var aj=0;var aa=af.decorations;var ab=aa.length;var ac=0;aa[ab]=ap;var av,at;for(at=av=0;at<ab;){if(aa[at]!==aa[at+2]){aa[av++]=aa[at++];aa[av++]=aa[at++]}else{at+=2}}ab=av;for(at=av=0;at<ab;){var aw=aa[at];var ae=aa[at+1];var Z=at+2;while(Z+2<=ab&&aa[Z+1]===ae){Z+=2}aa[av++]=aw;aa[av++]=ae;at=Z}ab=aa.length=av;var au=af.sourceNode;var ak;if(au){ak=au.style.display;au.style.display="none"}try{var ah=null;while(aj<V){var ai=ad[aj];var U=ad[aj+2]||ap;var ar=aa[ac+2]||ap;var Z=Math.min(U,ar);var am=ad[aj+1];var W;if(am.nodeType!==1&&(W=an.substring(Y,Z))){if(X){W=W.replace(ao,"\r")}am.nodeValue=W;var al=am.ownerDocument;var aq=al.createElement("span");aq.className=aa[ac+1];var ag=am.parentNode;ag.replaceChild(aq,am);aq.appendChild(am);if(Y<U){ad[aj+1]=am=al.createTextNode(an.substring(Z,U));ag.insertBefore(am,aq.nextSibling)}}Y=Z;if(Y>=U){aj+=2}if(Y>=ar){ac+=2}}}finally{if(au){au.style.display=ak}}}var u={};function d(W,X){for(var U=X.length;--U>=0;){var V=X[U];if(!u.hasOwnProperty(V)){u[V]=W}else{if(O.console){console.warn("cannot override language handler %s",V)}}}}function r(V,U){if(!(V&&u.hasOwnProperty(V))){V=/^\s*</.test(U)?"default-markup":"default-code"}return u[V]}d(L,["default-code"]);d(h([],[[G,/^[^<?]+/],[F,/^<!\w[^>]*(?:>|$)/],[k,/^<\!--[\s\S]*?(?:-\->|$)/],["lang-",/^<\?([\s\S]+?)(?:\?>|$)/],["lang-",/^<%([\s\S]+?)(?:%>|$)/],[M,/^(?:<[%?]|[%?]>)/],["lang-",/^<xmp\b[^>]*>([\s\S]+?)<\/xmp\b[^>]*>/i],["lang-js",/^<script\b[^>]*>([\s\S]*?)(<\/script\b[^>]*>)/i],["lang-css",/^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i],["lang-in.tag",/^(<\/?[a-z][^<>]*>)/i]]),["default-markup","htm","html","mxml","xhtml","xml","xsl"]);d(h([[G,/^[\s]+/,null," \t\r\n"],[o,/^(?:\"[^\"]*\"?|\'[^\']*\'?)/,null,"\"'"]],[[n,/^^<\/?[a-z](?:[\w.:-]*\w)?|\/?>$/i],[R,/^(?!style[\s=]|on)[a-z](?:[\w:-]*\w)?/i],["lang-uq.val",/^=\s*([^>\'\"\s]*(?:[^>\'\"\s\/]|\/(?=\s)))/],[M,/^[=<>\/]+/],["lang-js",/^on\w+\s*=\s*\"([^\"]+)\"/i],["lang-js",/^on\w+\s*=\s*\'([^\']+)\'/i],["lang-js",/^on\w+\s*=\s*([^\"\'>\s]+)/i],["lang-css",/^style\s*=\s*\"([^\"]+)\"/i],["lang-css",/^style\s*=\s*\'([^\']+)\'/i],["lang-css",/^style\s*=\s*([^\"\'>\s]+)/i]]),["in.tag"]);d(h([],[[o,/^[\s\S]+/]]),["uq.val"]);d(i({keywords:m,hashComments:true,cStyleComments:true,types:f}),["c","cc","cpp","cxx","cyc","m"]);d(i({keywords:"null,true,false"}),["json"]);d(i({keywords:T,hashComments:true,cStyleComments:true,verbatimStrings:true,types:f}),["cs"]);d(i({keywords:y,cStyleComments:true}),["java"]);d(i({keywords:I,hashComments:true,multiLineStrings:true}),["bsh","csh","sh"]);d(i({keywords:J,hashComments:true,multiLineStrings:true,tripleQuotedStrings:true}),["cv","py"]);d(i({keywords:t,hashComments:true,multiLineStrings:true,regexLiterals:true}),["perl","pl","pm"]);d(i({keywords:g,hashComments:true,multiLineStrings:true,regexLiterals:true}),["rb"]);d(i({keywords:x,cStyleComments:true,regexLiterals:true}),["js"]);d(i({keywords:s,hashComments:3,cStyleComments:true,multilineStrings:true,tripleQuotedStrings:true,regexLiterals:true}),["coffee"]);d(h([],[[D,/^[\s\S]+/]]),["regex"]);function e(X){var W=X.langExtension;try{var U=b(X.sourceNode,X.pre);var V=U.sourceCode;X.sourceCode=V;X.spans=U.spans;X.basePos=0;r(W,V)(X);E(X)}catch(Y){if(O.console){console.log(Y&&Y.stack?Y.stack:Y)}}}function z(Y,X,W){var U=document.createElement("pre");U.innerHTML=Y;if(W){S(U,W,true)}var V={langExtension:X,numberLines:W,sourceNode:U,pre:1};e(V);return U.innerHTML}function c(aj){function ab(al){return document.getElementsByTagName(al)}var ah=[ab("pre"),ab("code"),ab("xmp")];var V=[];for(var ae=0;ae<ah.length;++ae){for(var ac=0,Y=ah[ae].length;ac<Y;++ac){V.push(ah[ae][ac])}}ah=null;var Z=Date;if(!Z.now){Z={now:function(){return +(new Date)}}}var aa=0;var U;var af=/\blang(?:uage)?-([\w.]+)(?!\S)/;var ak=/\bprettyprint\b/;var W=/\bprettyprinted\b/;var ag=/pre|xmp/i;var ai=/^code$/i;var ad=/^(?:pre|code|xmp)$/i;function X(){var ar=(O.PR_SHOULD_USE_CONTINUATION?Z.now()+250:Infinity);for(;aa<V.length&&Z.now()<ar;aa++){var at=V[aa];var au=at.className;if(ak.test(au)&&!W.test(au)){var aw=false;for(var ao=at.parentNode;ao;ao=ao.parentNode){var ax=ao.tagName;if(ad.test(ax)&&ao.className&&ak.test(ao.className)){aw=true;break}}if(!aw){at.className+=" prettyprinted";var aq=au.match(af);var am;if(!aq&&(am=p(at))&&ai.test(am.tagName)){aq=am.className.match(af)}if(aq){aq=aq[1]}var ap;if(ag.test(at.tagName)){ap=1}else{var an=at.currentStyle;var al=(an?an.whiteSpace:(document.defaultView&&document.defaultView.getComputedStyle)?document.defaultView.getComputedStyle(at,null).getPropertyValue("white-space"):0);ap=al&&"pre"===al.substring(0,3)}var av=at.className.match(/\blinenums\b(?::(\d+))?/);av=av?av[1]&&av[1].length?+av[1]:true:false;if(av){S(at,av,ap)}U={langExtension:aq,sourceNode:at,numberLines:av,pre:ap};e(U)}}}if(aa<V.length){setTimeout(X,250)}else{if(aj){aj()}}}X()}var a=O.PR={createSimpleLexer:h,registerLangHandler:d,sourceDecorator:i,PR_ATTRIB_NAME:R,PR_ATTRIB_VALUE:o,PR_COMMENT:k,PR_DECLARATION:F,PR_KEYWORD:A,PR_LITERAL:H,PR_NOCODE:P,PR_PLAIN:G,PR_PUNCTUATION:M,PR_SOURCE:K,PR_STRING:D,PR_TAG:n,PR_TYPE:Q,prettyPrintOne:O.prettyPrintOne=z,prettyPrint:O.prettyPrint=c};if(typeof define==="function"&&define.amd){define(function(){return a})}})();(function(){var d={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:l,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,nptable:l,lheading:/^([^\n]+)\n *(=|-){2,} *(?:\n+|$)/,blockquote:/^( *>[^\n]+(\n(?!def)[^\n]+)*\n*)+/,list:/^( *)(bull) [\s\S]+?(?:hr|def|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,table:l,paragraph:/^((?:[^\n]+\n?(?!hr|heading|lheading|blockquote|tag|def))+)\n*/,text:/^[^\n]+/};d.bullet=/(?:[*+-]|\d+\.)/;d.item=/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/;d.item=c(d.item,"gm")(/bull/g,d.bullet)();d.list=c(d.list)(/bull/g,d.bullet)("hr","\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def","\\n+(?="+d.def.source+")")();d.blockquote=c(d.blockquote)("def",d.def)();d._tag="(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b";d.html=c(d.html)("comment",/<!--[\s\S]*?-->/)("closed",/<(tag)[\s\S]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,d._tag)();d.paragraph=c(d.paragraph)("hr",d.hr)("heading",d.heading)("lheading",d.lheading)("blockquote",d.blockquote)("tag","<"+d._tag)("def",d.def)();d.normal=i({},d);d.gfm=i({},d.normal,{fences:/^ *(`{3,}|~{3,}) *(\S+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/});d.gfm.paragraph=c(d.paragraph)("(?!","(?!"+d.gfm.fences.source.replace("\\1","\\2")+"|"+d.list.source.replace("\\1","\\3")+"|")();d.tables=i({},d.gfm,{nptable:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,table:/^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/});function b(m){this.tokens=[];this.tokens.links={};this.options=m||a.defaults;this.rules=d.normal;if(this.options.gfm){if(this.options.tables){this.rules=d.tables}else{this.rules=d.gfm}}}b.rules=d;b.lex=function(o,m){var n=new b(m);return n.lex(o)};b.prototype.lex=function(m){m=m.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ").replace(/\u00a0/g," ").replace(/\u2424/g,"\n");return this.token(m,true)};b.prototype.token=function(n,t,x){var n=n.replace(/^ +$/gm,""),r,p,v,s,u,w,m,q,o;while(n){if(v=this.rules.newline.exec(n)){n=n.substring(v[0].length);if(v[0].length>1){this.tokens.push({type:"space"})}}if(v=this.rules.code.exec(n)){n=n.substring(v[0].length);v=v[0].replace(/^ {4}/gm,"");this.tokens.push({type:"code",text:!this.options.pedantic?v.replace(/\n+$/,""):v});continue}if(v=this.rules.fences.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:"code",lang:v[2],text:v[3]});continue}if(v=this.rules.heading.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:"heading",depth:v[1].length,text:v[2]});continue}if(t&&(v=this.rules.nptable.exec(n))){n=n.substring(v[0].length);w={type:"table",header:v[1].replace(/^ *| *\| *$/g,"").split(/ *\| */),align:v[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:v[3].replace(/\n$/,"").split("\n")};for(q=0;q<w.align.length;q++){if(/^ *-+: *$/.test(w.align[q])){w.align[q]="right"}else{if(/^ *:-+: *$/.test(w.align[q])){w.align[q]="center"}else{if(/^ *:-+ *$/.test(w.align[q])){w.align[q]="left"}else{w.align[q]=null}}}}for(q=0;q<w.cells.length;q++){w.cells[q]=w.cells[q].split(/ *\| */)}this.tokens.push(w);continue}if(v=this.rules.lheading.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:"heading",depth:v[2]==="="?1:2,text:v[1]});continue}if(v=this.rules.hr.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:"hr"});continue}if(v=this.rules.blockquote.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:"blockquote_start"});v=v[0].replace(/^ *> ?/gm,"");this.token(v,t,true);this.tokens.push({type:"blockquote_end"});continue}if(v=this.rules.list.exec(n)){n=n.substring(v[0].length);s=v[2];this.tokens.push({type:"list_start",ordered:s.length>1});v=v[0].match(this.rules.item);r=false;o=v.length;q=0;for(;q<o;q++){w=v[q];m=w.length;w=w.replace(/^ *([*+-]|\d+\.) +/,"");if(~w.indexOf("\n ")){m-=w.length;w=!this.options.pedantic?w.replace(new RegExp("^ {1,"+m+"}","gm"),""):w.replace(/^ {1,4}/gm,"")}if(this.options.smartLists&&q!==o-1){u=d.bullet.exec(v[q+1])[0];if(s!==u&&!(s.length>1&&u.length>1)){n=v.slice(q+1).join("\n")+n;q=o-1}}p=r||/\n\n(?!\s*$)/.test(w);if(q!==o-1){r=w.charAt(w.length-1)==="\n";if(!p){p=r}}this.tokens.push({type:p?"loose_item_start":"list_item_start"});this.token(w,false,x);this.tokens.push({type:"list_item_end"})}this.tokens.push({type:"list_end"});continue}if(v=this.rules.html.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:this.options.sanitize?"paragraph":"html",pre:v[1]==="pre"||v[1]==="script"||v[1]==="style",text:v[0]});continue}if((!x&&t)&&(v=this.rules.def.exec(n))){n=n.substring(v[0].length);this.tokens.links[v[1].toLowerCase()]={href:v[2],title:v[3]};continue}if(t&&(v=this.rules.table.exec(n))){n=n.substring(v[0].length);w={type:"table",header:v[1].replace(/^ *| *\| *$/g,"").split(/ *\| */),align:v[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:v[3].replace(/(?: *\| *)?\n$/,"").split("\n")};for(q=0;q<w.align.length;q++){if(/^ *-+: *$/.test(w.align[q])){w.align[q]="right"}else{if(/^ *:-+: *$/.test(w.align[q])){w.align[q]="center"}else{if(/^ *:-+ *$/.test(w.align[q])){w.align[q]="left"}else{w.align[q]=null}}}}for(q=0;q<w.cells.length;q++){w.cells[q]=w.cells[q].replace(/^ *\| *| *\| *$/g,"").split(/ *\| */)}this.tokens.push(w);continue}if(t&&(v=this.rules.paragraph.exec(n))){n=n.substring(v[0].length);this.tokens.push({type:"paragraph",text:v[1].charAt(v[1].length-1)==="\n"?v[1].slice(0,-1):v[1]});continue}if(v=this.rules.text.exec(n)){n=n.substring(v[0].length);this.tokens.push({type:"text",text:v[0]});continue}if(n){throw new Error("Infinite loop on byte: "+n.charCodeAt(0))}}return this.tokens};var h={escape:/^\\([\\`*{}\[\]()#+\-.!_>])/,autolink:/^<([^ >]+(@|:\/)[^ >]+)>/,url:l,tag:/^<!--[\s\S]*?-->|^<\/?\w+(?:"[^"]*"|'[^']*'|[^'">])*?>/,link:/^!?\[(inside)\]\(href\)/,reflink:/^!?\[(inside)\]\s*\[([^\]]*)\]/,nolink:/^!?\[((?:\[[^\]]*\]|[^\[\]])*)\]/,strong:/^__([\s\S]+?)__(?!_)|^\*\*([\s\S]+?)\*\*(?!\*)/,em:/^\b_((?:__|[\s\S])+?)_\b|^\*((?:\*\*|[\s\S])+?)\*(?!\*)/,code:/^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/,br:/^ {2,}\n(?!\s*$)/,del:l,text:/^[\s\S]+?(?=[\\<!\[_*`]| {2,}\n|$)/};h._inside=/(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/;h._href=/\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/;h.link=c(h.link)("inside",h._inside)("href",h._href)();h.reflink=c(h.reflink)("inside",h._inside)();h.normal=i({},h);h.pedantic=i({},h.normal,{strong:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/});h.gfm=i({},h.normal,{escape:c(h.escape)("])","~|])")(),url:/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,del:/^~~(?=\S)([\s\S]*?\S)~~/,text:c(h.text)("]|","~]|")("|","|https?://|")()});h.breaks=i({},h.gfm,{br:c(h.br)("{2,}","*")(),text:c(h.gfm.text)("{2,}","*")()});function j(m,n){this.options=n||a.defaults;this.links=m;this.rules=h.normal;this.renderer=this.options.renderer||new f;this.renderer.options=this.options;if(!this.links){throw new Error("Tokens array requires a `links` property.")}if(this.options.gfm){if(this.options.breaks){this.rules=h.breaks}else{this.rules=h.gfm}}else{if(this.options.pedantic){this.rules=h.pedantic}}}j.rules=h;j.output=function(p,m,n){var o=new j(m,n);return o.output(p)};j.prototype.output=function(r){var n="",p,q,m,o;while(r){if(o=this.rules.escape.exec(r)){r=r.substring(o[0].length);n+=o[1];continue}if(o=this.rules.autolink.exec(r)){r=r.substring(o[0].length);if(o[2]==="@"){q=o[1].charAt(6)===":"?this.mangle(o[1].substring(7)):this.mangle(o[1]);m=this.mangle("mailto:")+q}else{q=k(o[1]);m=q}n+=this.renderer.link(m,null,q);continue}if(!this.inLink&&(o=this.rules.url.exec(r))){r=r.substring(o[0].length);q=k(o[1]);m=q;n+=this.renderer.link(m,null,q);continue}if(o=this.rules.tag.exec(r)){if(!this.inLink&&/^<a /i.test(o[0])){this.inLink=true}else{if(this.inLink&&/^<\/a>/i.test(o[0])){this.inLink=false}}r=r.substring(o[0].length);n+=this.options.sanitize?k(o[0]):o[0];continue}if(o=this.rules.link.exec(r)){r=r.substring(o[0].length);this.inLink=true;n+=this.outputLink(o,{href:o[2],title:o[3]});this.inLink=false;continue}if((o=this.rules.reflink.exec(r))||(o=this.rules.nolink.exec(r))){r=r.substring(o[0].length);p=(o[2]||o[1]).replace(/\s+/g," ");p=this.links[p.toLowerCase()];if(!p||!p.href){n+=o[0].charAt(0);r=o[0].substring(1)+r;continue}this.inLink=true;n+=this.outputLink(o,p);this.inLink=false;continue}if(o=this.rules.strong.exec(r)){r=r.substring(o[0].length);n+=this.renderer.strong(this.output(o[2]||o[1]));continue}if(o=this.rules.em.exec(r)){r=r.substring(o[0].length);n+=this.renderer.em(this.output(o[2]||o[1]));continue}if(o=this.rules.code.exec(r)){r=r.substring(o[0].length);n+=this.renderer.codespan(k(o[2],true));continue}if(o=this.rules.br.exec(r)){r=r.substring(o[0].length);n+=this.renderer.br();continue}if(o=this.rules.del.exec(r)){r=r.substring(o[0].length);n+=this.renderer.del(this.output(o[1]));continue}if(o=this.rules.text.exec(r)){r=r.substring(o[0].length);n+=k(this.smartypants(o[0]));continue}if(r){throw new Error("Infinite loop on byte: "+r.charCodeAt(0))}}return n};j.prototype.outputLink=function(n,o){var m=k(o.href),p=o.title?k(o.title):null;return n[0].charAt(0)!=="!"?this.renderer.link(m,p,this.output(n[1])):this.renderer.image(m,p,k(n[1]))};j.prototype.smartypants=function(m){if(!this.options.smartypants){return m}return m.replace(/--/g,"\u2014").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1\u2018").replace(/'/g,"\u2019").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1\u201c").replace(/"/g,"\u201d").replace(/\.{3}/g,"\u2026")};j.prototype.mangle=function(q){var n="",m=q.length,o=0,p;for(;o<m;o++){p=q.charCodeAt(o);if(Math.random()>0.5){p="x"+p.toString(16)}n+="&#"+p+";"}return n};function f(m){this.options=m||{}}f.prototype.code=function(n,p,o){if(this.options.highlight){var m=this.options.highlight(n,p);if(m!=null&&m!==n){o=true;n=m}}if(!p){return"<pre><code>"+(o?n:k(n,true))+"\n</code></pre>"}return'<pre><code class="'+this.options.langPrefix+k(p,true)+'">'+(o?n:k(n,true))+"\n</code></pre>\n"};f.prototype.blockquote=function(m){return"<blockquote>\n"+m+"</blockquote>\n"};f.prototype.html=function(m){return m};f.prototype.heading=function(n,o,m){return"<h"+o+' id="'+this.options.headerPrefix+m.toLowerCase().replace(/[^\w]+/g,"-")+'">'+n+"</h"+o+">\n"};f.prototype.hr=function(){return this.options.xhtml?"<hr/>\n":"<hr>\n"};f.prototype.list=function(m,n){var o=n?"ol":"ul";return"<"+o+">\n"+m+"</"+o+">\n"};f.prototype.listitem=function(m){return"<li>"+m+"</li>\n"};f.prototype.paragraph=function(m){return"<p>"+m+"</p>\n"};f.prototype.table=function(n,m){return"<table>\n<thead>\n"+n+"</thead>\n<tbody>\n"+m+"</tbody>\n</table>\n"};f.prototype.tablerow=function(m){return"<tr>\n"+m+"</tr>\n"};f.prototype.tablecell=function(p,n){var o=n.header?"th":"td";var m=n.align?"<"+o+' style="text-align:'+n.align+'">':"<"+o+">";return m+p+"</"+o+">\n"};f.prototype.strong=function(m){return"<strong>"+m+"</strong>"};f.prototype.em=function(m){return"<em>"+m+"</em>"};f.prototype.codespan=function(m){return"<code>"+m+"</code>"};f.prototype.br=function(){return this.options.xhtml?"<br/>":"<br>"};f.prototype.del=function(m){return"<del>"+m+"</del>"};f.prototype.link=function(m,r,q){if(this.options.sanitize){try{var o=decodeURIComponent(g(m)).replace(/[^\w:]/g,"").toLowerCase()}catch(p){return""}if(o.indexOf("javascript:")===0){return""}}var n='<a href="'+m+'"';if(r){n+=' title="'+r+'"'}n+=">"+q+"</a>";return n};f.prototype.image=function(m,p,o){var n='<img src="'+m+'" alt="'+o+'"';if(p){n+=' title="'+p+'"'}n+=this.options.xhtml?"/>":">";return n};function e(m){this.tokens=[];this.token=null;this.options=m||a.defaults;this.options.renderer=this.options.renderer||new f;this.renderer=this.options.renderer;this.renderer.options=this.options}e.parse=function(o,m,n){var p=new e(m,n);return p.parse(o)};e.prototype.parse=function(n){this.inline=new j(n.links,this.options,this.renderer);this.tokens=n.reverse();var m="";while(this.next()){m+=this.tok()}return m};e.prototype.next=function(){return this.token=this.tokens.pop()};e.prototype.peek=function(){return this.tokens[this.tokens.length-1]||0};e.prototype.parseText=function(){var m=this.token.text;while(this.peek().type==="text"){m+="\n"+this.next().text}return this.inline.output(m)};e.prototype.tok=function(){switch(this.token.type){case"space":return"";case"hr":return this.renderer.hr();case"heading":return this.renderer.heading(this.inline.output(this.token.text),this.token.depth,this.token.text);case"code":return this.renderer.code(this.token.text,this.token.lang,this.token.escaped);case"table":var q="",s="",o,u,t,m,n;t="";for(o=0;o<this.token.header.length;o++){m={header:true,align:this.token.align[o]};t+=this.renderer.tablecell(this.inline.output(this.token.header[o]),{header:true,align:this.token.align[o]})}q+=this.renderer.tablerow(t);for(o=0;o<this.token.cells.length;o++){u=this.token.cells[o];t="";for(n=0;n<u.length;n++){t+=this.renderer.tablecell(this.inline.output(u[n]),{header:false,align:this.token.align[n]})}s+=this.renderer.tablerow(t)}return this.renderer.table(q,s);case"blockquote_start":var s="";while(this.next().type!=="blockquote_end"){s+=this.tok()}return this.renderer.blockquote(s);case"list_start":var s="",r=this.token.ordered;while(this.next().type!=="list_end"){s+=this.tok()}return this.renderer.list(s,r);case"list_item_start":var s="";while(this.next().type!=="list_item_end"){s+=this.token.type==="text"?this.parseText():this.tok()}return this.renderer.listitem(s);case"loose_item_start":var s="";while(this.next().type!=="list_item_end"){s+=this.tok()}return this.renderer.listitem(s);case"html":var p=!this.token.pre&&!this.options.pedantic?this.inline.output(this.token.text):this.token.text;return this.renderer.html(p);case"paragraph":return this.renderer.paragraph(this.inline.output(this.token.text));case"text":return this.renderer.paragraph(this.parseText())}};function k(m,n){return m.replace(!n?/&(?!#?\w+;)/g:/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function g(m){return m.replace(/&([#\w]+);/g,function(o,p){p=p.toLowerCase();if(p==="colon"){return":"}if(p.charAt(0)==="#"){return p.charAt(1)==="x"?String.fromCharCode(parseInt(p.substring(2),16)):String.fromCharCode(+p.substring(1))}return""})}function c(o,n){o=o.source;n=n||"";return function m(p,q){if(!p){return new RegExp(o,n)}q=q.source||q;q=q.replace(/(^|[^\[])\^/g,"$1");o=o.replace(p,q);return m}}function l(){}l.exec=l;function i(p){var n=1,o,m;for(;n<arguments.length;n++){o=arguments[n];for(m in o){if(Object.prototype.hasOwnProperty.call(o,m)){p[m]=o[m]}}}return p}function a(m,o,u){if(u||typeof o==="function"){if(!u){u=o;o=null}o=i({},a.defaults,o||{});var p=o.highlight,t,n,r=0;try{t=b.lex(m,o)}catch(s){return u(s)}n=t.length;var q=function(){var v,w;try{v=e.parse(t,o)}catch(x){w=x}o.highlight=p;return w?u(w):u(null,v)};if(!p||p.length<3){return q()}delete o.highlight;if(!n){return q()}for(;r<t.length;r++){(function(v){if(v.type!=="code"){return --n||q()}return p(v.text,v.lang,function(x,w){if(w==null||w===v.text){return --n||q()}v.text=w;v.escaped=true;--n||q()})})(t[r])}return}try{if(o){o=i({},a.defaults,o)}return e.parse(b.lex(m,o),o)}catch(s){s.message+="\nPlease report this to https://github.com/chjj/marked.";if((o||a.defaults).silent){return"<p>An error occured:</p><pre>"+k(s.message+"",true)+"</pre>"}throw s}}a.options=a.setOptions=function(m){i(a.defaults,m);return a};a.defaults={gfm:true,tables:true,breaks:false,pedantic:false,sanitize:false,smartLists:false,silent:false,highlight:null,langPrefix:"lang-",smartypants:false,headerPrefix:"",renderer:new f,xhtml:false};a.Parser=e;a.parser=e.parse;a.Renderer=f;a.Lexer=b;a.lexer=b.lex;a.InlineLexer=j;a.inlineLexer=j.output;a.parse=a;if(typeof exports==="object"){module.exports=a}else{if(typeof define==="function"&&define.amd){define(function(){return a})}else{this.marked=a}}}).call(function(){return this||(typeof window!=="undefined"?window:global)}());(function(){var c,d,a,b;a={Version:"V2.2.2",OnlineJudgeReturnType:{OJ_WAIT:0,OJ_AC:1,OJ_PE:2,OJ_TLE:3,OJ_MLE:4,OJ_WA:5,OJ_OLE:6,OJ_CE:7,OJ_RE_SEGV:8,OJ_RE_FPE:9,OJ_RE_BUS:10,OJ_RE_ABRT:11,OJ_RE_UNKNOWN:12,OJ_RF:13,OJ_SE:14,OJ_RE_JAVA:15,OJ_JUDGING:16,OJ_RUNNING:17,OJ_REJUDGING:18},ContestType:{PUBLIC:0,PRIVATE:1,DIY:2,INVITED:3,INHERIT:4,ONSITE:5},ContestStatus:{PENDING:"Pending",RUNNING:"Running",ENDED:"Ended"},AuthenticationType:{NORMAL:0,ADMIN:1,CONSTANT:2,NOOP:3,CURRENT_USER:4},AuthorStatusType:{NONE:0,PASS:1,FAIL:2},ContestRegistryStatus:{PENDING:0,ACCEPTED:1,REFUSED:2},ArticleType:{NOTICE:0,ARTICLE:1,COMMENT:2}};d={articleCondition:{currentPage:null,startId:void 0,endId:void 0,keyword:void 0,title:void 0,userId:void 0,userName:void 0,type:void 0,orderFields:"id",orderAsc:"false"},problemCondition:{currentPage:null,startId:void 0,endId:void 0,title:void 0,source:void 0,isSpj:void 0,startDifficulty:void 0,endDifficulty:void 0,keyword:void 0,orderFields:"id",orderAsc:"true"},contestCondition:{currentPage:null,startId:void 0,endId:void 0,keyword:void 0,title:void 0,orderFields:"time",orderAsc:"false"},statusCondition:{currentPage:null,startId:void 0,endId:void 0,userName:void 0,problemId:void 0,languageId:void 0,contestId:-1,result:0,orderFields:"statusId",orderAsc:"false"},userCondition:{currentPage:null,startId:void 0,endId:void 0,userName:void 0,nickName:void 0,type:void 0,school:void 0,departmentId:void 0,orderFields:"solved,tried,id",orderAsc:"false,false,true"},teamCondition:{currentPage:null,userId:void 0,leaderId:void 0,teamName:void 0,orderFields:"team.teamId",orderAsc:"false"},messageCondition:{currentPage:null,senderId:null,receiverId:null,isOpened:null,userId:null,userAId:null,userBId:null,orderFields:"time",orderAsc:"false"},contestTeamCondition:{currentPage:null,contestId:null,teamId:null,status:null,orderFields:"contestTeamId",orderAsc:"false"},trainingCriteria:{currentPage:null,startId:null,endId:null,keyword:null,orderFields:"trainingId",orderAsc:"false"},trainingUserCriteria:{currentPage:null,startId:null,endId:null,trainingId:null,keyword:null,type:null,orderFields:"currentRating,trainingUserName",orderAsc:"true,false"}};_.mixin(_.str.exports());b=angular.module("cdoj",["ui.bootstrap","ngRoute","ngCookies","monospaced.elastic","frapontillo.bootstrap-switch","ui.sortable","pasvaz.bindonce"]);b.config(["$routeProvider",function(e){return e.when("/contest/list",{templateUrl:"template/contest/list.html",controller:"ContestListController"}).when("/contest/show/:contestId",{templateUrl:"template/contest/show.html",controller:"ContestShowController",resolve:{contest:["$q","$route","$http","Error",function(g,k,j,i){var h,f;f=g.defer();h=k.current.params.contestId;j.get("/contest/data/"+h).success(function(m){var l;if(m.result==="success"){l=m.contest;l.problemList=m.problemList;return f.resolve(l)}else{return i.error(m.error_msg)}}).error(function(){return i.error("Network error.")});return f.promise}]}}).when("/contest/editor/:action",{templateUrl:"template/contest/editor.html",controller:"ContestEditorController",resolve:{contest:["$q","$route","$http","Error","$rootScope",function(h,j,i,g,l){var f,m,k,n;n=h.defer();f=j.current.params.action;m={action:f,type:l.ContestType.PUBLIC,time:Date.create().format("{yyyy}-{MM}-{dd} {HH}:{mm}"),lengthMinutes:0,lengthHours:5,lengthDays:0,needFrozen:false,frozenLengthMinutes:0,frozenLengthHours:1,frozenLengthDays:0};if(f!=="new"){k=f;i.post("/contest/data/"+k).success(function(p){var o;if(p.result==="success"){m.action=f;m.contestId=p.contest.contestId;m.title=p.contest.title;m.type=p.contest.type;m.time=Date.create(p.contest.startTime).format("{yyyy}-{MM}-{dd} {HH}:{mm}");o=Math.floor(p.contest.length/1000);o=Math.floor(o/60);m.lengthMinutes=o%60;o=Math.floor(o/60);m.lengthHours=o%24;o=Math.floor(o/24);m.lengthDays=o;if(angular.isDefined(p.contest.frozenTime)){m.needFrozen=true;o=Math.floor(p.contest.frozenTime/1000);o=Math.floor(o/60);m.frozenLengthMinutes=o%60;o=Math.floor(o/60);m.frozenLengthHours=o%24;o=Math.floor(o/24);m.frozenLengthDays=o}else{m.needFrozen=false}m.description=p.contest.description;if(angular.isDefined(p.contest.parentId)){m.type=l.ContestType.INHERIT;m.parentId=p.contest.parentId}m.problemList=p.problemList;return n.resolve(m)}else{return g.error(p.error_msg)}}).error(function(){return g.error("Network error!")})}else{n.resolve(m)}return n.promise}]}}).when("/contest/register/:contestId",{templateUrl:"template/contest/register.html",controller:"ContestRegisterController",resolve:{contest:["$q","$route","$http","Error","$rootScope",function(h,m,l,j,f){var k,i,g;g=h.defer();i=m.current.params.contestId;k=angular.copy(f.contestCondition);k.startId=k.endId=i;l.post("/contest/search",k).success(function(o){var n;if(o.result==="success"){if(o.list.length!==1){j.error("Incorrect contest ID!")}n=o.list[0];if(n.type!==f.ContestType.INVITED){j.error("Incorrect contest ID!")}return g.resolve(n)}else{return j.error(o.error_msg)}}).error(function(){return j.error("Network error!")});return g.promise}]}})}]);b.config(["$httpProvider",function(e){if(!e.defaults.headers.get){e.defaults.headers.get={}}e.defaults.headers.get["Cache-Control"]="no-cache";return e.defaults.headers.get.Pragma="no-cache"}]);b.config(["$routeProvider",function(e){return e.when("/problem/list",{templateUrl:"template/problem/list.html",controller:"ProblemListController"}).when("/problem/show/:problemId",{templateUrl:"template/problem/show.html",controller:"ProblemShowController",resolve:{problem:["$q","$route","$http","Error",function(g,k,j,h){var f,i;f=g.defer();i=k.current.params.problemId;j.post("/problem/data/"+i).success(function(l){if(l.result==="success"){return f.resolve(l.problem)}else{return h.error(l.error_msg)}}).error(function(){return h.error("Network error!")});return f.promise}]}}).when("/problem/editor/:action",{templateUrl:"template/problem/editor.html",controller:"ProblemEditorController",resolve:{problem:["$q","$route","$http","Error",function(g,l,k,h){var i,f,j;f=g.defer();i=l.current.params.action;if(i!=="new"){j=i;k.post("/problem/data/"+j).success(function(o){var n,m;if(o.result==="success"){o.problem.action=i;n=o.problem.sampleInput;try{n=JSON.parse(n)}catch(p){}if(!(n instanceof Array)){n=[n]}m=o.problem.sampleOutput;try{m=JSON.parse(m)}catch(p){}if(!(m instanceof Array)){m=[m]}if(n.length!==m.length){h.error("Sample input has not same number of cases with sample output!")}else{o.problem.samples=_.map(_.zip(n,m),function(q){return{input:q[0].toString(),output:q[1].toString()}})}return f.resolve(o.problem)}else{return h.error(o.error_msg)}}).error(function(){return h.error("Network error!")})}else{f.resolve({action:i,description:"",title:"",isSpj:false,timeLimit:1000,javaTimeLimit:3000,memoryLimit:65535,javaMemoryLimit:65535,outputLimit:65535,isVisible:false,input:"",output:"",sampleInput:"",sampleOutput:"",hint:"",source:""})}return f.promise}]}})}]);b.config(["$routeProvider",function(e){return e.when("/",{templateUrl:"template/index/index.html",controller:"IndexController"}).when("/status/list",{templateUrl:"template/status/list.html",controller:"StatusListController"}).when("/article/show/:articleId",{templateUrl:"template/article/show.html",controller:"ArticleShowController"}).when("/article/editor/:userName/:action",{templateUrl:"template/article/editor.html",controller:"ArticleEditorController"}).when("/admin/dashboard",{templateUrl:"template/admin/dashboard.html",controller:"AdminDashboardController"}).when("/404/",{templateUrl:"template/index/404.html"}).when("/error/:message",{templateUrl:"template/index/error.html",controller:"ErrorController"}).otherwise({redirectTo:"/404/"})}]);b.config(["$routeProvider",function(e){return e.when("/training/list",{templateUrl:"template/training/list.html",controller:"TrainingListController"}).when("/training/editor/:action",{templateUrl:"template/training/editor.html",controller:"TrainingEditorController",resolve:{trainingDto:["$q","$route","$http","Error",function(g,l,k,i){var j,f,h;f=g.defer();j=l.current.params.action;if(j!=="new"){h=j;k.post("/training/data/"+h).success(function(m){if(m.result==="success"){m.trainingDto.action=j;return f.resolve(m.trainingDto)}else{return i.error(m.error_msg)}}).error(function(){return i.error("Network error!")})}else{f.resolve({action:j,description:"",title:""})}return f.promise}]}}).when("/training/show/:trainingId",{templateUrl:"template/training/show.html",controller:"TrainingShowController",resolve:{trainingDto:["$q","$route","$http","Error",function(g,k,j,i){var f,h;f=g.defer();h=k.current.params.trainingId;j.post("/training/data/"+h).success(function(l){if(l.result==="success"){return f.resolve(l.trainingDto)}else{return i.error(l.error_msg)}}).error(function(){return i.error("Network error!")});return f.promise}]}})}]);b.config(["$routeProvider",function(e){return e.when("/user/list",{templateUrl:"template/user/list.html",controller:"UserListController"}).when("/user/center/:userName/:tab",{templateUrl:"template/user/center.html",controller:"UserCenterController",resolve:{targetUser:["$q","$route","$http","Error","$rootScope",function(h,l,k,i,f){var g,j;g=h.defer();j=l.current.params.userName;k.get("/user/userCenterData/"+j).success(function(m){if(m.result==="success"){return g.resolve({targetUser:m.targetUser,problemStatus:m.problemStatus})}else{return i.error(m.error_msg)}}).error(function(){return i.error("Network error!")});return g.promise}],userEditDTO:["$q","$route","$http","Error","$rootScope",function(h,m,l,j,f){var g,i,k;g=h.defer();k=m.current.params.userName;i=m.current.params.tab;if(i==="edit"){l.get("/user/profile/"+k).success(function(n){if(n.result==="success"){return g.resolve(n.user)}else{return j.error(n.error_msg)}}).error(function(){return j.error("Network error!")})}else{g.resolve(null)}return g.promise}]}}).when("/user/center/:userName",{templateUrl:"template/user/center.html",controller:"UserCenterController",resolve:{targetUser:function(){return{targetUser:void 0,problemStatus:void 0}},userEditDTO:function(){return void 0}}}).when("/user/activate/:userName/:serialKey",{templateUrl:"template/user/activation.html",controller:"PasswordResetController"}).when("/user/register",{templateUrl:"template/user/register.html",controller:"UserRegisterController"})}]);b.run(["$rootScope",function(e){e.hasLogin=false;e.currentUser={email:""};e.isAdmin=false;e.$on("currentUser:login",function(g,f){_.extend(e.currentUser,f);e.hasLogin=true;return e.$broadcast("currentUser:changed")});e.$on("currentUser:logout",function(){e.hasLogin=false;e.currentUser={email:""};return e.$broadcast("currentUser:changed")});e.$on("currentUser:changed",function(){return e.$broadcast("currentUser:updated")});return e.$on("currentUser:updated",function(){if(e.hasLogin&&e.currentUser.type===1){e.isAdmin=true}else{e.isAdmin=false}return e.$broadcast("permission:check")})}]);b.run(["$rootScope","$http","$timeout","$window",function(e,j,h,i){var f,g;_.extend(e,a);_.extend(e,d);e.finalTitle="UESTC Online Judge";g=function(){return j.get("/globalData").success(function(k){return _.extend(e,k)}).error(function(){return h(g,500)})};f=function(){return j.get("/data").success(function(k){if(k.result==="success"){if(e.hasLogin&&k.hasLogin===false){i.alert("You has been logged out by server.");e.$broadcast("currentUser:logout")}_.extend(e,k);e.$broadcast("currentUser:updated")}return h(f,10000)}).error(function(){return h(f,500)})};e.$on("globalData:refresh",function(){return h(g,0)});return e.$on("data:refresh",function(){return h(f,0)})}]);b.run(["$rootScope","$window","Error",function(e,g,f){e.currentPermission={value:e.AuthenticationType.NOOP,userName:void 0};e.editPermission={userName:void 0};e.hasEditPermission=false;e.$on("permission:setPermission",function(j,h,i){return e.currentPermission={value:h,userName:i}});e.$on("permission:setEditPermission",function(i,h){return e.editPermission={userName:h}});return e.$on("permission:check",function(){if(e.currentPermission.value===e.AuthenticationType.ADMIN){if(e.isAdmin===false){f.error("Permission denied!")}}else{if(e.currentPermission.value===e.AuthenticationType.NORMAL){if(e.hasLogin===false){f.error("Please login first!")}}else{if(e.currentPermission.value===e.AuthenticationType.CURRENT_USER){if(e.hasLogin===false||(e.isAdmin===false&&e.currentUser.userName!==e.currentPermission.userName)){f.error("Permission denied!")}}}}if(e.hasLogin===false){e.hasEditPermission=false}else{if(e.currentUser.type!==e.AuthenticationType.CONSTANT&&e.currentUser.userName===e.editPermission.userName){e.hasEditPermission=true}}return e.$broadcast("permission:changed")})}]);b.run(["$rootScope",function(e){e.$on("all:refresh",function(){e.$broadcast("data:refresh");e.$broadcast("globalData:refresh");return e.$broadcast("list:refresh")});return e.$broadcast("all:refresh")}]);b.factory("Error",["$location",function(e){return{error:function(f){return e.path("/error/"+f.escapeURL())}}}]);b.factory("UserProfile",["$http","$window","$rootScope",function(h,g,f){var e;e=0;return{setProfile:function(i){return h.get("/user/profile/"+i).success(function(j){if(j.result==="success"){e=j.user;return f.$broadcast("UserProfile:success")}else{return g.alert(j.error_msg)}})},getProfile:function(){return e}}}]);b.controller("ContestEditorController",["$scope","$rootScope","$http","$window","contest",function(f,e,i,h,g){f.$emit("permission:setPermission",e.AuthenticationType.ADMIN);h.scrollTo(0,0);f.contest=g;f.problemList=[];f.fieldInfo=[];f.action=g.action;if(f.action!=="new"){f.title="Edit contest "+f.action;f.problemList=_.map(g.problemList,function(j){return{problemId:j.problemId,title:j.title}})}else{f.title="New contest"}f.$watch("problemList",function(){return f.contest.problemList=_.map(f.problemList,function(j){return j.problemId}).join(",")},true);f.updateProblemTitle=function(j){if(isNaN(parseInt(j.problemId))){return j.title="Invalid problem id!"}else{return i.get("/problem/query/"+j.problemId+"/title").success(function(k){if(k.result==="success"){if(k.list.length===1){return j.title=k.list[0]}else{return j.title="No such problem!"}}else{return j.title=k.error_msg}})}};f.addProblem=function(){var l,j,k;k="";if(f.problemList.length>0){l=parseInt(f.problemList.last().problemId);if(!isNaN(l)){k=l+1}}j={problemId:k,title:""};f.updateProblemTitle(j);return f.problemList.add(j)};f.removeProblem=function(j){return f.problemList.splice(j,1)};f.fieldInfo=[];f.submit=function(){var j,k,l;j=angular.copy(f.contest);if(j.type===e.ContestType.PRIVATE){if(angular.isUndefined(j.password)||angular.isUndefined(j.passwordRepeat)){h.scrollTo(0,0);return}}else{if(j.type===e.ContestType.INHERIT){if(angular.isUndefined(j.parentId)){h.scrollTo(0,0);return}}}j.time=Date.create(j.time).getTime();k=CryptoJS.SHA1(j.password).toString();j.password=k;l=CryptoJS.SHA1(j.passwordRepeat).toString();j.passwordRepeat=l;return i.post("/contest/edit",j).success(function(m){if(m.result==="success"){return h.location.href="#/contest/show/"+m.contestId}else{if(m.result==="field_error"){f.fieldInfo=m.field;return h.scrollTo(0,0)}else{return h.alert(m.error_msg)}}}).error(function(){return h.alert("Network error.")})};f.searchContest=function(j){var k;k={keyword:j};return i.post("/contest/search",k).then(function(l){var m;m=l.data;if(m.result==="success"){return m.list}})};f.onsiteUsers=[];f.$on("onsiteUserFileUploader:complete",function(k,j){return f.onsiteUsers=j});if(f.contest.type===e.ContestType.ONSITE){i.get("/contest/fetchAllOnsiteUsers/"+f.contest.contestId).success(function(j){if(j.result==="success"){return f.onsiteUsers=_.map(j.list,function(k){return{userName:k.userName,password:"Encrypted password",teamName:k.nickName,members:k.name}})}else{return h.alert(j.error_msg)}}).error(function(){return h.alert("Network error.")})}f.updateOnsiteUsers=function(){var j;j=_.map(f.onsiteUsers,function(k){return{userName:k.userName,password:CryptoJS.SHA1(k.password).toString(),nickName:k.teamName,name:k.members}});return i.post("/contest/updateOnsiteUser",{userList:j,contestId:f.contest.contestId}).success(function(k){if(k.result==="success"){return h.alert("Update onsite users information successful!")}else{return h.alert(k.error_msg)}}).error(function(){return h.alert("Network error.")})};return f.onsiteUserFileHelp='You should upload user config file in csv format.\n\nYou need to specify the corresponding attribute in the header row, see\nthe example below for more details.\n\n(Use `,` as the separators and `"` as the quote character)\n\n```\n"id", "userName", "password", "teamName", "members"\n"team001", "12th_team001", "123456789", "UESTC_Dage", "大哥, 大哥, 大哥"\n```\n\nPlease check the list carefully after you upload it, and click the update\nbutton below to commit changes.'}]);b.controller("ContestListController",["$scope","$rootScope","$window","$modal","$http",function(f,e,h,g,i){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);h.scrollTo(0,0);f.showAddContestModal=function(){if(e.isAdmin===false){return}return g.open({templateUrl:"template/modal/add-contest-modal.html",controller:"AddContestModalController"})};return f.enterContest=function(k){var l,j;if(k.type===e.ContestType.INHERIT){j=k.parentType}else{j=k.type}if(j===e.ContestType.PRIVATE){if(e.hasLogin===false){return h.alert("Please login first!")}else{l={contestId:k.contestId,password:"1234567890123456789012345678901234567890"};return i.post("/contest/loginContest",l).success(function(m){if(m.result==="success"){return h.location.href="/#/contest/show/"+k.contestId}else{return g.open({templateUrl:"template/modal/contest-password-modal.html",controller:"ContestPasswordModalController",resolve:{contest:function(){return k}}})}}).error(function(){return h.alert("Network error!")})}}else{if(j===e.ContestType.INVITED){l={contestId:k.contestId,password:"1234567890123456789012345678901234567890"};return i.post("/contest/loginContest",l).success(function(m){if(m.result==="success"){return h.location.href="/#/contest/show/"+k.contestId}else{return h.alert(m.error_msg)}}).error(function(){return h.alert("Network error!")})}else{return h.location.href="/#/contest/show/"+k.contestId}}}}]);b.controller("ContestPasswordModalController",["$scope","$rootScope","$window","$modalInstance","contest","$http",function(f,e,i,h,g,j){f.contest=g;f.fieldInfo=[];f.enter=function(){var k;k={contestId:g.contestId,password:CryptoJS.SHA1(g.password).toString()};return j.post("/contest/loginContest",k).success(function(l){if(l.result==="success"){h.close();return i.location.href="/#/contest/show/"+g.contestId}else{if(l.result==="field_error"){return f.fieldInfo=l.field}else{return i.alert(l.error_msg)}}}).error(function(){return i.alert("Network error!")})};return f.cancel=function(){return h.dismiss()}}]);b.controller("ContestRegisterController",["$scope","$rootScope","$http","$window","$modal","contest",function(f,e,k,j,g,h){var i;f.$emit("permission:setPermission",e.AuthenticationType.NOOP);j.scrollTo(0,0);f.contest=h;i=h.contestId;f.contestTeamCondition=angular.copy(e.contestTeamCondition);f.contestTeamCondition.contestId=i;f.team={teamName:"",invitedUsers:[],leaderId:null,teamId:null,teamUsers:[]};f.searchTeam=function(m){var l;l=angular.copy(e.teamCondition);l.teamName=m;l.userId=e.currentUser.userId;l.allow=true;return k.post("/team/typeAHeadSearch",l).then(function(n){var o;o=n.data;if(o.result==="success"){return o.list}else{return[]}})};f.showRegisterButton=false;f.selectTeam=function(){return k.get("/team/typeAHeadItem/"+f.team.teamName).success(function(l){if(l.result==="success"){f.team=l.team;return f.showRegisterButton=true}else{return j.alert(l.error_msg)}}).error(function(){return j.alert("Network error.")})};f.register=function(){return k.get("/contest/register/"+f.team.teamId+"/"+i).success(function(l){if(l.result==="success"){j.alert("Register success! please wait for verify");f.team={teamName:"",invitedUsers:[],leaderId:null,teamId:null,teamUsers:[]};f.showRegisterButton=false;return e.$broadcast("list:refresh:team")}else{return j.alert(l.error_msg)}}).error(function(){return j.alert("Network error.")})};return f.review=function(l){return g.open({templateUrl:"template/modal/contest-registry-review-modal.html",controller:"ContestRegistryReviewModalController",resolve:{team:function(){return l}}})}}]);b.controller("ContestRegistryReviewModalController",["$scope","$rootScope","$http","$modalInstance","team","$window",function(f,e,j,h,g,i){f.team=g;f.review={result:""};f.teamUsers=angular.copy(f.team.teamUsers).concat(angular.copy(f.team.invitedUsers));_.each(f.teamUsers,function(k){return j.get("/user/profile/"+k.userName).success(function(l){if(l.result==="success"){_.extend(k,l.user);k.sex=_.findWhere(e.genderTypeList,{genderTypeId:l.user.sex}).description;k.departmentId=_.findWhere(e.departmentList,{departmentId:l.user.departmentId}).name;k.grade=_.findWhere(e.gradeTypeList,{gradeTypeId:l.user.grade}).description;k.size=_.findWhere(e.tShirtsSizeTypeList,{sizeTypeId:l.user.size}).description;return k.type=_.findWhere(e.authenticationTypeList,{authenticationTypeId:l.user.type}).description}else{return i.alert(l.error_msg)}}).error(function(){return i.alert("Network error.")})});f.review=function(k){return j.post("/contest/registryReview",k).success(function(l){if(l.result==="success"){i.alert("Success!");f.team.status=k.status;if(k.status===e.ContestRegistryStatus.ACCEPTED){f.team.statusName="Accepted"}else{f.team.statusName="Refused"}return h.close()}}).error(function(){return i.alert("Network error.")})};f.accept=function(){return f.review({contestTeamId:f.team.contestTeamId,status:e.ContestRegistryStatus.ACCEPTED,comment:f.review.result})};f.refuse=function(){return f.review({contestTeamId:f.team.contestTeamId,status:e.ContestRegistryStatus.REFUSED,comment:f.review.result})};f.reasonList=[];return f.$on("$routeChangeStart",function(){return h.dismiss()})}]);b.controller("ContestShowController",["$scope","$rootScope","$http","$window","$modal","$routeParams","$timeout","$interval","$cookieStore","contest",function(n,i,w,m,k,f,u,o,v,j){var e,p,q,h,t,s,r,g,l;n.$emit("permission:setPermission",i.AuthenticationType.NOOP);m.scrollTo(0,0);n.currentTeam="";n.progressbar={max:100,value:0,type:"success",active:true};p="contest"+n.contestId;if(angular.isUndefined(v.get(p))){v.put(p,{lastClarificationCount:0})}n.$on("currentUser:logout",function(){return m.location.href="/#/contest/list"});n.contestId=angular.copy(f.contestId);n.contest=j;n.problemList=j.problemList;if(n.problemList.length>0){n.currentProblem=n.problemList[0]}q=void 0;l=function(){var C,B,x,A,D,y,z;n.contest.currentTime=n.contest.currentTime+1000;if(n.contest.status===i.ContestStatus.PENDING){B=0;z="primary";C=true;if(n.contest.currentTime>=n.contest.startTime){u(function(){return m.location.reload()},500)}}else{if(n.contest.status===i.ContestStatus.RUNNING){B=n.contest.currentTime-n.contest.startTime;A=Math.floor(B/1000);y=A%60;A=(A-y)/60;D=A%60;A=(A-D)/60;x=A;n.currentTimePassed=_.sprintf("%d:%02d:%02d",x,D,y);z="danger";C=true;if(n.contest.currentTime>=n.contest.endTime){u(function(){return m.location.reload()},500)}}else{B=n.contest.length;z="success";C=false}}n.progressbar.value=B*100/n.contest.length;n.progressbar.type=z;return n.progressbar.active=C};q=o(l,1000);e=void 0;s=void 0;n.$on("$destroy",function(){o.cancel(q);u.cancel(s);return u.cancel(e)});n.totalUnreadedClarification=0;n.lastClarificationCount=0;r=function(){return i.$broadcast("list:refresh:comment",function(x){n.totalUnreadedClarification=Math.max(0,x.pageInfo.totalItems-v.get(p).lastClarificationCount);n.lastClarificationCount=x.pageInfo.totalItems;return e=u(r,30000)})};e=u(r,100);n.selectClarificationTab=function(){u.cancel(e);e=u(r,0);j=v.get(p);j.lastClarificationCount=n.lastClarificationCount;v.put(p,j);return n.totalUnreadedClarification=0};n.showProblemTab=function(){return n.$$childHead.$$nextSibling.$$nextSibling.tabs[1].select()};n.chooseProblem=function(x){n.showProblemTab();return n.currentProblem=_.findWhere(n.problemList,{order:x})};n.resetStatusCondition=function(){n.contestStatusCondition.problemId=void 0;n.contestStatusCondition.result=0;n.contestStatusCondition.language=void 0;if(i.isAdmin){return n.contestStatusCondition.userName=void 0}};n.$on("contestShow:showProblemTab",function(y,x){return n.chooseProblem(x)});n.showStatusTab=function(){n.$$childHead.$$nextSibling.$$nextSibling.tabs[3].select();n.contestStatusCondition.problemId=n.currentProblem.problemId;return n.refreshStatus()};n.openSubmitModal=function(){return k.open({templateUrl:"template/modal/submit-modal.html",controller:"SubmitModalController",resolve:{submitDTO:function(){return{codeContent:"",problemId:n.currentProblem.problemId,contestId:n.contest.contestId,languageId:2}},title:function(){return n.currentProblem.orderCharacter+" - "+n.currentProblem.title}}}).result.then(function(x){if(x==="success"){return n.showStatusTab()}})};n.contestStatusCondition=angular.copy(i.statusCondition);n.contestStatusCondition.contestId=n.contestId;n.refreshStatus=function(){return n.$broadcast("list:refresh:status")};h=function(x,y,A){var z,B;if(A===0||y===0){return""}B=(A-x)/A*200;z="white";if(B>128){z="black"}return _.sprintf("background-color: rgb(%.0f, %.0f, %.0f); color: %s;",B,B,B,z)};t=function(x,y){if(y===0){return""}return _.sprintf("%.0f",x/y*100)};g=function(){var x;x=angular.copy(n.contestId);return w.get("/contest/rankList/"+x).success(function(A){var z,y;if(A.result==="success"){n.rankList=A.rankList.rankList;_.each(n.problemList,function(C,B){C.tried=A.rankList.problemList[B].tried;return C.solved=A.rankList.problemList[B].solved});z=_.reduce(n.problemList,function(B,C){return Math.max(B,C.solved)},0);_.each(n.problemList,function(C,B){C.stateStyle=h(C.solved,C.tried,z);return C.successRatio=t(C.solved,C.tried)});if(i.hasLogin){y=void 0;if(n.contest.type===i.ContestType.INVITED){_.each(A.rankList.rankList,function(C){var B;B=_.findWhere(C.teamUsers,{userName:n.currentUser.userName});if(angular.isDefined(B)){n.currentTeam=C.userName;return y=C}})}else{y=_.findWhere(A.rankList.rankList,{userName:i.currentUser.userName})}if(angular.isDefined(y)){return _.each(n.problemList,function(C,B){C.hasSolved=y.itemList[B].solved;return C.hasTried=y.itemList[B].tried>0})}}}}).error(function(){return m.alert("Network error!")})};n.refreshRankList=function(){return g()};s=u(g,100);n.submitDTO={codeContent:""};return n.printCode=function(){var x;x=angular.copy(n.submitDTO);if(angular.isUndefined(x.codeContent)){return}if(i.hasLogin===false){return m.alert("Please login first!")}else{if(m.confirm("Are you sure?")){return w.post("/status/print",x).success(function(y){if(y.result==="success"){return m.alert("Your print request has been send to the stuff, please wait patiently.")}else{return m.alert(y.error_msg)}}).error(function(){return m.alert("Network error.")})}}}}]);b.controller("ProblemEditorController",["$scope","$http","$window","$rootScope","problem",function(f,i,h,e,g){f.$emit("permission:setPermission",e.AuthenticationType.ADMIN);h.scrollTo(0,0);f.problem=g;f.fieldInfo=[];f.action=g.action;f.samples=[];f.addSample=function(){return f.samples.add({input:"",output:""})};f.removeSample=function(j){return f.samples.splice(j,1)};if(f.action!=="new"){f.title="Edit problem "+f.action;f.samples=f.problem.samples}else{f.title="New problem";f.addSample()}return f.submit=function(){var j;j=angular.copy(f.problem);j.action=angular.copy(f.action);j.sampleInput=JSON.stringify(_.map(f.samples,function(k){return k.input}));j.sampleOutput=JSON.stringify(_.map(f.samples,function(k){return k.output}));return i.post("/problem/edit",j).success(function(k){if(k.result==="success"){return h.location.href="/#/problem/show/"+k.problemId}else{if(k.result==="field_error"){return f.fieldInfo=k.field}else{return h.alert(k.error_msg)}}}).error(function(){return h.alert("Network error.")})}}]);b.controller("ProblemListController",["$scope","$rootScope","$window",function(f,e,g){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);g.scrollTo(0,0);return e.title="Problem list"}]);b.controller("ProblemShowController",["$scope","$rootScope","$window","$modal","problem",function(f,e,i,g,h){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);i.scrollTo(0,0);f.problem=h;f.openSubmitModal=function(){return g.open({templateUrl:"template/modal/submit-modal.html",controller:"SubmitModalController",resolve:{submitDTO:function(){return{codeContent:"",problemId:f.problem.problemId,contestId:null,languageId:2}},title:function(){return""+f.problem.title}}}).result.then(function(j){if(j==="success"){return i.location.href="/#/status/list?problemId="+f.problem.problemId}})};return f.gotoStatusList=function(){return i.location.href="/#/status/list?problemId="+f.problem.problemId}}]);b.controller("TrainingEditorController",["$scope","$http","$rootScope","$window","trainingDto",function(f,i,e,h,g){f.$emit("permission:setPermission",e.AuthenticationType.ADMIN);h.scrollTo(0,0);f.trainingDto=g;f.fieldInfo=[];f.action=g.action;if(f.action!=="new"){f.title="Edit training "+f.action}else{f.title="New training"}return f.submit=function(){var j;j=angular.copy(f.trainingDto);return i.post("/training/edit",{action:angular.copy(f.action),trainingEditDto:j}).success(function(k){if(k.result==="success"){return h.location.href="/#/training/show/"+k.trainingId}else{if(k.result==="field_error"){return f.fieldInfo=k.field}else{return h.alert(k.error_msg)}}}).error(function(){return h.alert("Network error.")})}}]);b.controller("TrainingListController",["$scope","$rootScope","$window",function(f,e,g){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);g.scrollTo(0,0);return e.title="Training list"}]);b.controller("TrainingMemberEditorController",["$scope","$http","$modalInstance","action","trainingUserDto",function(e,j,h,i,f){var g;e.action=i;e.trainingUserDto=f;if(e.action==="new"){e.title="Add new member"}else{e.title="Edit"}e.fieldInfo=[];e.searchUser=function(k){var l;l={keyword:k};return j.post("/user/typeAheadList",l).then((function(m){var n;n=m.data;if(n.result==="success"){return n.list}else{return $window.alert(n.error_msg)}}))};g=function(k){console.log(k);return j.post("/training/editTrainingUser",k).success(function(l){if(l.result==="success"){return h.close()}else{if(l.result==="field_error"){return e.fieldInfo=l.field}else{return $window.alert(l.error_msg)}}}).error(function(){return $window.alert("Network error.")})};e["new"]=function(){var k;k=angular.copy(e.trainingUserDto);return g({action:"new",trainingUserEditDto:k})};e.edit=function(){var k;k=angular.copy(e.trainingUserDto);return g({action:"edit",trainingUserEditDto:k})};return e.dismiss=function(){return h.dismiss("close")}}]);b.controller("TrainingShowController",["$scope","$http","$rootScope","$window","trainingDto","$modal",function(f,k,e,j,i,h){var g;f.$emit("permission:setPermission",e.AuthenticationType.NOOP);j.scrollTo(0,0);f.trainingDto=i;g=angular.copy(e.trainingUserCriteria);g.trainingId=i.trainingId;f.trainingUserCriteria=g;f.editTrainingUser=function(m){var l;l=h.open({templateUrl:"template/modal/training-member-editor-modal.html",controller:"TrainingMemberEditorController",resolve:{action:function(){return"edit"},trainingUserDto:["$q","$http","Error",function(o,q,p){var n;n=o.defer();q.get("/training/trainingUserData/"+m).success(function(r){if(r.result==="success"){return n.resolve(r.trainingUserDto)}else{return p.error(r.error_msg)}}).error(function(){return p.error("Network error!")});return n.promise}]}});return l.result.then(function(){return f.$broadcast("list:refresh:trainingRankList")})};return f.addNewMember=function(){var l;l=h.open({templateUrl:"template/modal/training-member-editor-modal.html",controller:"TrainingMemberEditorController",resolve:{action:function(){return"new"},trainingUserDto:function(){return{trainingId:i.trainingId,trainingUserName:"",type:0}}}});return l.result.then(function(){return f.$broadcast("list:refresh:trainingRankList")})}}]);b.controller("UserAdminModalController",["$scope","$http","$modalInstance","UserProfile","$window",function(e,i,g,f,h){e.userEditDTO=0;e.$watch(function(){return f.getProfile()},function(){return e.userEditDTO=f.getProfile()},true);e.fieldInfo=[];e.edit=function(){var l,j,k;k=angular.copy(e.userEditDTO);if(k.newPassword===""){k.newPassword=void 0}if(k.newPasswordRepeat===""){k.newPasswordRepeat=void 0}if(angular.isUndefined(k.newPassword&&angular.isUndefined(k.newPasswordRepeat))){k=_.omit(k,"newPassword");k=_.omit(k,"newPassowrdRepeat")}else{l=CryptoJS.SHA1(k.newPassword).toString();k.newPassword=l;j=CryptoJS.SHA1(k.newPasswordRepeat).toString();k.newPasswordRepeat=j}return i.post("/user/adminEdit",k).success(function(m){if(m.result==="success"){h.alert("Success!");return g.close()}else{if(m.result==="field_error"){return e.fieldInfo=m.field}else{return h.alert(m.error_msg)}}}).error(function(){return h.alert("Network error.")})};e.dismiss=function(){return g.dismiss("close")};return e.$on("$routeChangeStart",function(){return g.dismiss()})}]);b.controller("UserCenterController",["$scope","$rootScope","$http","$routeParams","$modal","$window","$location","targetUser","userEditDTO",function(p,l,j,m,n,f,h,k,i){var o,e,g,q;q=angular.copy(m.userName);e=angular.copy(m.tab);if(angular.isUndefined(e)){h.path("/user/center/"+q+"/problems")}p.$emit("permission:setPermission",l.AuthenticationType.NOOP);f.scrollTo(0,0);p.targetUser={email:""};p.teamCondition=angular.copy(l.teamCondition);p.messageCondition=angular.copy(l.messageCondition);p.userEditDTO=i;g=function(){if(l.hasEditPermission===false){p.messagesTabTitle="Your messages with "+p.targetUser.userName;p.messageCondition.userAId=p.currentUser.userId;return p.messageCondition.userBId=p.targetUser.userId}else{p.messagesTabTitle=p.targetUser.userName+"'s messages";return p.messageCondition.userId=p.currentUser.userId}};p.$on("permission:changed",function(){return g()});p.$on("currentUser:changed",function(){return g()});p.activeProblemsTab=false;p.activeTeamsTab=false;p.activeMessagesTab=false;p.activeEditTab=false;p.activeBlogTab=false;if(e==="teams"){p.activeTeamsTab=true}else{if(e==="messages"){p.activeMessagesTab=true}else{if(e==="edit"){p.activeEditTab=true}else{if(e==="blog"){p.activeBlogTab=true}else{p.activeProblemsTab=true}}}}p.selectBlogTab=function(){return p.$broadcast("list:refresh:article")};p.selectTeamTab=function(){return p.$broadcast("list:refresh:team")};p.selectMessagesTab=function(){return p.$broadcast("list:refresh:message")};p.$emit("permission:setEditPermission",q);p.$emit("permission:check");p.targetUser=k.targetUser;p.problemStatus=k.problemStatus;p.teamCondition.userId=k.targetUser.userId;o=angular.copy(l.articleCondition);o.userName=q;p.articleCondition=o;p.fieldInfo=[];p.edit=function(){var t,r,s;if(l.currentUser.hasLogin===false||l.currentUser.type===l.AuthenticationType.CONSTANT){f.alert("Permission denied!");return}i=angular.copy(p.userEditDTO);if(i.newPassword===""){i.newPassword=void 0}if(i.newPasswordRepeat===""){i.newPasswordRepeat=void 0}if(angular.isUndefined(i.newPassword&&angular.isUndefined(i.newPasswordRepeat))){i=_.omit(i,"newPassword");i=_.omit(i,"newPassowrdRepeat")}else{t=CryptoJS.SHA1(i.newPassword).toString();i.newPassword=t;r=CryptoJS.SHA1(i.newPasswordRepeat).toString();i.newPasswordRepeat=r}if(angular.isUndefined(i.oldPassword)){f.scrollTo(0,0);return}s=CryptoJS.SHA1(i.oldPassword).toString();i.oldPassword=s;return j.post("/user/edit",i).success(function(u){if(u.result==="success"){f.alert("Success!");return f.location.href="/#/"}else{if(u.result==="field_error"){f.scrollTo(0,0);return p.fieldInfo=u.field}else{return f.alert(u.error_msg)}}}).error(function(){return f.alert("Network error.")})};p.newTeam={teamName:""};p.createNewTeam=function(){var r;r=angular.copy(p.newTeam);return j.post("/team/createTeam",r).success(function(s){if(s.result==="success"){return p.$broadcast("list:refresh:team",function(t){return n.open({templateUrl:"template/modal/team-editor-modal.html",controller:"TeamEditorModalController",resolve:{team:function(){return t.list[0]}}})})}else{return f.alert(s.error_msg)}}).error(function(){return f.alert("Network error.")})};return p.selectEditTab=function(){return j.get("/user/profile/"+p.targetUser.userName).success(function(r){if(r.result==="success"){return p.userEditDTO=r.user}else{return f.alert(r.error_msg)}}).error(function(){return f.alert("Network error!")})}}]);b.controller("UserListController",["$scope","$rootScope","$window",function(f,e,g){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);g.scrollTo(0,0);e.title="User list";return f.resetStatusCondition=function(){return f.$broadcast("list:reset:user")}}]);b.controller("UserRegisterController",["$scope","$rootScope","$http","$window",function(f,e,h,g){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);g.scrollTo(0,0);f.userRegisterDTO={departmentId:1,email:"",motto:"",nickName:"",password:"",passwordRepeat:"",school:"",studentId:"",userName:"",sex:0,size:2,phone:"",grade:3,name:""};f.fieldInfo=[];return f.register=function(){var j,k,i;i=angular.copy(f.userRegisterDTO);if(angular.isUndefined(i.password||angular.isUndefined(i.passwordRepeat))){g.scrollTo(0,0);return}j=CryptoJS.SHA1(i.password).toString();i.password=j;k=CryptoJS.SHA1(i.passwordRepeat).toString();i.passwordRepeat=k;return h.post("/user/register",i).success(function(l){if(l.result==="success"){e.hasLogin=true;e.currentUser={userName:l.userName,email:l.email,type:l.type};e.$broadcast("data:refresh");return g.history.back()}else{if(l.result==="field_error"){g.scrollTo(0,0);return f.fieldInfo=l.field}else{return g.alert(l.error_msg)}}}).error(function(){return g.alert("Network error.")})}}]);b.controller("AddContestModalController",["$scope","$rootScope","$modalInstance","$window",function(f,e,g,h){f.$on("$routeChangeStart",function(){return g.close()});f.$on("contestUploader:complete",function(j,i){return h.location.href="/#/contest/show/"+i});return f.$on("$routeChangeStart",function(){return g.dismiss()})}]);b;b.controller("AdminDashboardController",["$scope","$rootScope","$window","$http","$timeout",function(g,e,k,l,h){var f,j,i;g.$emit("permission:setPermission",e.AuthenticationType.ADMIN);k.scrollTo(0,0);f=angular.copy(e.articleCondition);f.type=e.ArticleType.NOTICE;f.orderFields="order";f.orderAsc="true";g.list=[];j="";i=function(){return l.post("/article/search",f).success(function(m){if(m.result==="success"){g.list=m.list;j=_.map(g.list,function(n){return n.articleId}).join(",");return g.pageInfo=m.pageInfo}else{return k.alert(m.error_msg)}}).error(function(){return h(i,500)})};h(i,0);g.listChanged=false;g.sortableOptions={stop:function(){var m;m=_.map(g.list,function(n){return n.articleId}).join(",");return g.listChanged=!angular.equals(m,j)}};return g.save=function(){var m;m=_.map(g.list,function(n){return n.articleId}).join(",");return l.post("/article/changeNoticeOrder",{order:m}).success(function(n){if(n.result==="success"){k.alert("Done");i();return g.listChanged=false}else{return k.alert(n.error_msg)}}).error(function(){return k.alert("Network error.")})}}]);b.controller("ArticleEditorController",["$rootScope","$scope","$http","$routeParams","$window",function(e,f,j,h,i){var g;f.$emit("permission:setPermission",e.AuthenticationType.CURRENT_USER,h.userName);i.scrollTo(0,0);f.article={content:"",title:""};f.fieldInfo=[];f.action=h.action;f.userName=h.userName;if(f.action!=="new"){g=angular.copy(f.action);j.get("/article/data/"+g).success(function(k){if(k.result==="success"){f.article=k.article;f.title="Edit: "+f.article.title;return f.isNotice=f.article.type===e.ArticleType.NOTICE}else{return i.alert(k.error_msg)}}).error(function(){return i.alert("Network error, please refresh page manually.")})}else{f.title="New article"}return f.submit=function(){var k;k=angular.copy(f.article);if(f.isNotice){k.type=e.ArticleType.NOTICE}else{k.type=e.ArticleType.ARTICLE}return j.post("/article/edit",{action:angular.copy(f.action),articleEditDto:k}).success(function(l){if(l.result==="success"){return i.location.href="/#/article/show/"+l.articleId}else{if(l.result==="field_error"){return f.fieldInfo=l.field}else{return i.alert(l.error_msg)}}}).error(function(){return i.alert("Network error.")})}}]);b.controller("ArticleShowController",["$scope","$rootScope","$routeParams","$http","$window",function(f,e,h,j,i){var g;f.$emit("permission:setPermission",e.AuthenticationType.NOOP);i.scrollTo(0,0);f.article={content:"",title:""};g=angular.copy(h.articleId);return j.get("/article/data/"+g).success(function(k){if(k.result==="success"){f.article=k.article;e.title=f.article.title;return f.article.content=f.article.content.replace("!!!more!!!","")}else{return i.alert(k.error_msg)}}).error(function(){return i.alert("Network error, please refresh page manually.")})}]);b.controller("CodeModalController",["$scope","$http","$modalInstance","statusId",function(e,h,f,g){e.code="Loading...";h.post("/status/info/"+g).success(function(k){var j,i;i="";if(k.result==="success"){i=k.compileInfo}else{i=k.error_msg}j="";if(k.result==="success"){j=k.code}else{j=k.error_msg}return e.code=j}).error(function(){return e.code="Network error."});return e.$on("$routeChangeStart",function(){return f.dismiss()})}]);b.controller("CompileInfoModalController",["$scope","$http","$modalInstance","statusId",function(e,h,f,g){e.compileInfo="Loading...";h.post("/status/info/"+g).success(function(j){var i;i="";if(j.result==="success"){i=j.compileInfo}else{i=j.error_msg}return e.compileInfo=i}).error(function(){return e.compileInfo="Network error."});return e.$on("$routeChangeStart",function(){return f.dismiss()})}]);b.controller("ErrorController",["$routeParams","$scope",function(f,e){return e.message=f.message}]);b.controller("ForgetPasswordModalController",["$scope","$http","$modalInstance","$window",function(e,h,f,g){e.DTO={userName:""};e.userName="";e.buttonText="Send Email";e.onSend=false;e.sendSerialKey=function(){var i;i=angular.copy(e.DTO.userName);if(i.length>0){e.buttonText="Sending...";e.onSend=true;return h.post("/user/sendSerialKey/"+i).success(function(j){if(j.result==="success"){g.alert("We send you an Email with the url to reset your password right now, please check your mail box.");f.close()}else{if(j.result==="failed"){g.alert("Unknown error occurred.")}else{g.alert(j.error_msg)}}e.buttonText="Send Email";return e.onSend=false}).error(function(){return g.alert("Network error.")})}else{return g.alert("Please input your user name!")}};e.dismiss=function(){return f.dismiss()};return e.$on("$routeChangeStart",function(){return f.dismiss()})}]);b.controller("HeaderController",["$scope","$rootScope","$http","$element","$compile","$window","$modal",function(g,e,k,f,i,j,h){g.userLoginDTO={userName:"",password:""};g.fieldInfo=[];g.login=function(){var m,l;g.userLoginDTO.userName=c("#userName").val();g.userLoginDTO.password=c("#password").val();l=angular.copy(g.userLoginDTO);m=CryptoJS.SHA1(l.password).toString();l.password=m;return k.post("/user/login",l).success(function(n){if(n.result==="success"){return e.$broadcast("currentUser:login",{userName:n.userName,email:n.email,type:n.type})}else{if(n.result==="field_error"){return g.fieldInfo=n.field}else{return j.alert(n.error_msg)}}}).error(function(){return j.alert("Network error")})};g.logout=function(){return k.post("/user/logout").success(function(l){if(l.result==="success"){return e.$broadcast("currentUser:logout")}}).error(function(){return j.alert("Network error")})};return g.openForgetPasswordModal=function(){return h.open({templateUrl:"template/modal/forget-password-modal.html",controller:"ForgetPasswordModalController"})}}]);b.controller("IndexController",["$scope","$rootScope","$window","$http",function(g,e,i,j){var f,h;g.$emit("permission:setPermission",e.AuthenticationType.NOOP);i.scrollTo(0,0);e.title="Home";f=angular.copy(e.articleCondition);f.type=e.ArticleType.NOTICE;f.orderFields="order";f.orderAsc="true";g.articleCondition=f;g.isRecentNews=true;g.isRecentContests=false;g.isArticle=false;g.currentArticleId=0;h=function(){g.isRecentNews=false;g.isRecentContests=false;return g.isArticle=false};g.showRecentNews=function(){g.$broadcast("list:refresh:article");h();return g.isRecentNews=true};g.recentContestsDescription="该数据源允许直接引用，但请注明本段文字。\n\n数据来源：http://contests.acmicpc.info/contests.json 。\n\n本数据源力求支持所有国内ACMer的常用OJ，如果希望添加某个OJ或者发现某个OJ无法正常获取比赛信息，\n请联系doraemonok#163.com (#替换成@)。";g.recentContests=[];g.showRecentContests=function(){j.get("/recentContest").success(function(k){return g.recentContests=_.map(k.recentContestList,function(l){l.link=l.link.unescapeHTML();return l})}).error(function(){return i.alert("Network error, please refresh page manually.")});h();return g.isRecentContests=true};g.article={content:""};return g.showArticle=function(k){j.get("/article/data/"+k).success(function(l){if(l.result==="success"){return g.article=l.article}else{return i.alert(l.error_msg)}}).error(function(){return i.alert("Network error, please refresh page manually.")});h();g.isArticle=true;return g.currentArticleId=k}}]);b.controller("ListController",["$scope","$rootScope","$http","$window","$routeParams",function(f,e,k,j,i){var g,h;f.pageInfo={countPerPage:20,currentPage:1,displayDistance:2,totalPages:1};f.itemsPerPage=20;f.showPages=10;f.$on("currentUser:changed",function(){return f.refresh()});f.$on("list:refresh",function(l,m){return f.refresh(m)});g="list:refresh:"+f.name;f.$on(g,function(l,m){return f.refresh(m)});f.$on("list:reset",function(){return f.reset()});h="list:reset:"+f.name;f.$on(h,function(){return f.reset()});_.each(f.condition,function(m,l){if(angular.isDefined(i[l])){if(!isNaN(parseInt(i[l]))){return f.condition[l]=parseInt(i[l])}else{return f.condition[l]=i[l]}}});f.refresh=function(m){var l;if(f.requestUrl!==0){l=angular.copy(f.condition);return k.post(f.requestUrl,l).success(function(n){if(n.result==="success"){f.$$nextSibling.list=n.list;f.pageInfo=n.pageInfo;f.itemsPerPage=f.pageInfo.countPerPage;if(angular.isFunction(m)){return m(n)}}})}};f.reset=function(){_.each(f.condition,function(m,l){if(l==="orderFields"||l==="orderAsc"){return}return f.condition[l]=void 0});return f.condition.currentPage=null};return f.$watch("condition",function(m,l){if(m.currentPage===l.currentPage){f.condition.currentPage=1}return f.refresh()},true)}]);b.controller("MessageModalController",["$scope","$rootScope","$http","$modalInstance","message","$window",function(f,e,j,h,g,i){f.message=g;f.message.content="Loading...";j.get("/message/fetch/"+f.message.messageId).success(function(k){if(k.result==="success"){if(f.message.isOpened===false){e.$broadcast("all:refresh")}return _.extend(f.message,k.message)}else{return i.alert(k.error_msg)}}).error(function(){return i.alert("Network error.")});f.$on("$routeChangeStart",function(){return h.dismiss()});return f.printMessage=function(){var l,m,k;k=i.open("","print");k.document.write("<html><head><title>print</title>");k.document.write("</head><body >");m=angular.copy(f.message.content);m=marked(m);l=c("<div></div>").append(m);MathJax.Hub.Queue(["Typeset",MathJax.Hub,l[0]]);console.log(l.find("pre"));l.find("pre").each(function(q,o){var n,p;n=c(o);if(n.attr("type")!=="no-prettify"){p=prettyPrintOne(n[0].innerText.escapeHTML());return n.empty().append(p)}});k.document.write(l[0].innerHTML);k.document.write("</body></html>");k.print();return k.close()}}]);b.controller("PasswordResetController",["$scope","$http","$window","$routeParams","$rootScope",function(f,i,h,g,e){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);h.scrollTo(0,0);f.userActivateDTO={userName:g.userName,serialKey:g.serialKey,password:"",passwordRepeat:""};f.filedInfo=[];return f.submit=function(){var k,l,j;j=angular.copy(f.userActivateDTO);k=CryptoJS.SHA1(j.password).toString();j.password=k;l=CryptoJS.SHA1(j.passwordRepeat).toString();j.passwordRepeat=l;return i.post("/user/resetPassword",j).success(function(m){if(m.result==="success"){h.alert("Success, please login manually!");return h.location.href="/"}else{if(m.result==="field_error"){return f.fieldInfo=m.field}else{return h.alert(m.error_msg)}}}).error(function(){return h.alert("Network error.")})}}]);b.controller("StatusListController",["$scope","$rootScope","$window",function(f,e,g){f.$emit("permission:setPermission",e.AuthenticationType.NOOP);g.scrollTo(0,0);f.refresh=function(){return f.$broadcast("list:refresh:status")};return f.resetStatusCondition=function(){return f.$broadcast("list:reset:status")}}]);b.controller("SubmitModalController",["$scope","$rootScope","$window","$http","$modalInstance","submitDTO","title",function(f,e,j,k,h,g,i){f.submitDTO=g;f.title=i;f.submit=function(){g=angular.copy(f.submitDTO);if(angular.isUndefined(g.codeContent)){return}if(e.hasLogin===false){j.alert("Please login first!");return h.dismiss("close")}else{return k.post("/status/submit",g).success(function(l){if(l.result==="success"){return h.close("success")}else{if(l.result==="field_error"){return f.fieldInfo=l.field}else{return j.alert(l.error_msg)}}}).error(function(){return j.alert("Network error.")})}};return f.close=function(){return h.dismiss("close")}}]);b.controller("TeamEditorModalController",["$scope","$rootScope","$http","$window","$modalInstance","team",function(f,e,j,i,h,g){f.teamDTO={teamId:g.teamId,teamName:g.teamName,memberList:""};f.newMember={userName:""};f.memberList=[].concat(g.teamUsers,g.invitedUsers);f.searchUser=function(k){var l;l={keyword:k};return j.post("/user/typeAheadList",l).then((function(m){var n;n=m.data;if(n.result==="success"){return n.list}else{return i.alert(n.error_msg)}}))};f.addMemberClick=function(){if(f.memberList.length<3){return j.get("/user/typeAheadItem/"+f.newMember.userName).success(function(l){var k;if(l.result==="success"){k=l.user;if(_.where(f.memberList,{userId:k.userId}).length>0){return i.alert("You can not add the same member twice")}else{return f.addMember(k)}}else{return i.alert(l.error_msg)}}).error(function(){return i.alert("Network error.")})}};f.addMember=function(k){var l;if(f.memberList.length>=3){return i.alert("Member number should no more than 3.")}else{if(i.confirm("Are you sure that invite "+k.userName+" into team "+f.teamDTO.teamName+"?")){l=angular.copy(f.teamDTO);l.memberList=""+k.userId;return j.post("/team/addMember",l).success(function(m){if(m.result==="success"){f.memberList.add(k);return e.$broadcast("list:refresh:team")}else{return i.alert(m.error_msg)}}).error(function(){return i.alert("Network error.")})}}};f.removeMember=function(m){var l,k;if(m>=1&&m<3){k=f.memberList[m];if(i.confirm("Are you sure that remove "+k.userName+" from team "+f.teamDTO.teamName+"?")){l=angular.copy(f.teamDTO);l.memberList=""+k.userId;return j.post("/team/removeMember",l).success(function(n){if(n.result==="success"){f.memberList.splice(m,1);return e.$broadcast("list:refresh:team")}else{return i.alert(n.error_msg)}}).error(function(){return i.alert("Network error.")})}}};f.deleteTeam=function(){var k;if(i.confirm("This action will delete team "+f.teamDTO.teamName+" forever, are you sure?")){k=angular.copy(f.teamDTO);return j.post("/team/deleteTeam",k).success(function(l){if(l.result==="success"){i.alert("Done!");h.close();return e.$broadcast("list:refresh:team")}else{return i.alert(l.error_msg)}}).error(function(){return i.alert("Network error.")})}};f.dismiss=function(){return h.dismiss()};return f.$on("$routeChangeStart",function(){return h.dismiss()})}]);b.directive("activeLink",["$location",function(e){return{restrict:"A",link:function(h,g,i){var f;f=i.activeLink;h.location=e;return h.$watch("location.path()",function(j){var k;k=j.split("/")[1];if(angular.isUndefined(k)){k=""}if(k===f){return g.addClass("active")}else{return g.removeClass("active")}})}}}]);b.directive("articleItem",function(){return{restrict:"E",scope:{article:"="},templateUrl:"template/article/article-summary.html"}});b.directive("autoFillSync",["$timeout",function(e){return{require:"ngModel",link:function(h,g,f,i){return e(function(){var j;j=g.val();if(i.$pristine){return i.$setViewValue(j)}},500)}}}]);b.directive("uiAvatar",function(){return{restrict:"A",scope:{email:"=",rating:"@",image:"@",size:"@"},controller:["$scope","$element",function(f,e){return f.$watch("email",function(){var g;if(angular.isUndefined(f.email)||f.email===null||f.email===""){return}if(f.size===void 0){f.size=c(e).width()}if(f.image===void 0){f.image="retro"}if(f.rating===void 0){f.rating="pg"}g="http://www.gravatar.com/avatar/"+CryptoJS.MD5(f.email).toString()+".jpg?"+(f.size?"s="+f.size+"&":"")+(f.rating?"r="+f.rating+"&":"")+(f.image?"d="+encodeURIComponent(f.image):"");return e.attr("src",g)})}]}});b.directive("uiCode",function(){return{restrict:"E",scope:{code:"="},link:function(f,e){return f.$watch("code",function(){var g;g=prettyPrintOne(f.code.trim().escapeHTML());return c(e).empty().append(g)})},template:"<pre></pre>",replace:true}});b.directive("uiCodeHref",function(){return{restrict:"A",scope:{status:"=",alwaysShowHref:"@"},controller:["$scope","$rootScope","$http","$modal",function(f,e,i,g){var h;f.showHref=false;h=function(){if(f.alwaysShowHref){return f.showHref=true}else{if(e.hasLogin&&(e.currentUser.type===1||e.currentUser.userName===f.status.userName)){return f.showHref=true}else{return f.showHref=false}}};h();f.$on("currentUser:changed",function(){return h()});return f.showCode=function(){var j;j=f.status.statusId;return g.open({templateUrl:"template/modal/code-modal.html",controller:"CodeModalController",size:"lg",resolve:{statusId:function(){return j}}})}}],template:'<a href="javascript:void(0);"\n   ng-show="showHref"\n   ng-click="showCode()">{{status.length}} B</a>\n<span ng-hide="showHref">{{status.length}} B</span>'}});b.directive("comment",function(){return{restrict:"E",scope:{contestId:"=",problemId:"=",articleId:"="},controller:["$rootScope","$scope","$http","$window",function(g,h,j,i){var f,e;f=angular.copy(g.articleCondition);f.contestId=h.contestId;f.problemId=h.problemId;f.parentId=h.articleId;h.commentCondition=f;e=function(k){return j.post("/article/edit",k).success(function(l){if(l.result==="success"){h.newComment="";return h.$broadcast("list:refresh:comment")}else{if(l.result==="field_error"){return h.fieldInfo=l.field}else{return i.alert(l.error_msg)}}}).error(function(){return i.alert("Network error.")})};h.newComment="";h.comment=function(){var k;k={content:h.newComment,title:"Comment",type:g.ArticleType.COMMENT,problemId:h.problemId,contestId:h.contestId,parentId:h.articleId};e({action:"new",articleEditDto:k});h.stashCommentList=false;return i.scrollTo(0,0)};h.stashCommentList=false;h.cancel=function(){h.newComment="";h.stashCommentList=false;return i.scrollTo(0,0)};h.reply=function(k){h.newComment="@"+k.ownerName+" : ";h.$broadcast("flandre:focus");return h.stashCommentList=true};return h["delete"]=function(l){var k;if(i.confirm("Are you sure?")){k={content:"This comment is deleted by administrator.",type:g.ArticleType.COMMENT,articleId:l.articleId};return e({articleEditDto:k,action:"edit"})}}}],replace:true,templateUrl:"template/article/comment.html"}});b.directive("uiContestAdminSpan",function(){return{restrict:"A",scope:{contestId:"=",isVisible:"="},controller:["$scope","$http","$window",function(e,g,f){return e.editVisible=function(){var h;h="/contest/operator/"+e.contestId+"/isVisible/"+(!e.isVisible);return g.post(h).success(function(i){if(i.result==="success"){return e.isVisible=!e.isVisible}else{return f.alert(i.error_msg)}}).error(function(){return f.alert("Network error.")})}}],template:'<div class="btn-toolbar" role="toolbar">\n  <div class="btn-group">\n    <button type="button"\n            class="btn btn-default btn-sm"\n            ng-click="editVisible()"\n            style="padding: 1px 5px;">\n      <i class="fa"\n         ng-class="{\n          \'fa-eye\': isVisible == true,\n          \'fa-eye-slash\': isVisible == false\n         }"></i>\n    </button>\n    <a href="/#/contest/editor/{{contestId}}"\n       class="btn btn-default btn-sm"\n       style="padding: 1px 5px;">\n      <i class="fa fa-pencil"></i>\n    </a>\n  </div>\n</div>'}});b.directive("uiContestProblemHref",function(){return{restrict:"E",scope:{problemId:"=",problemList:"="},controller:["$scope",function(e){e.order=-1;e.orderCharacter="-";e.$watch("problemId + problemList",function(){var f;f=_.findWhere(e.problemList,{problemId:e.problemId});if(f!==void 0){e.orderCharacter=f.orderCharacter;return e.order=f.order}});return e.select=function(){if(e.order!==-1){return e.$emit("contestShow:showProblemTab",e.order)}}}],template:'<a href="javascript:void(0);" ng-bind="orderCharacter" ng-click="select()"></a>',replace:true}});b.directive("uiContestUploader",["$window",function(e){return{restrict:"E",replace:true,link:function(g,f){var h;return h=new qq.FineUploaderBasic({button:c(f)[0],request:{endpoint:"/contest/createContestByArchiveFile",inputName:"uploadFile"},validation:{allowedExtensions:["zip"],sizeLimit:100*1000*1000},multiple:false,callbacks:{onComplete:function(k,j,i){if(i.success==="true"){return g.$emit("contestUploader:complete",i.contestId)}else{return e.alert(i.error_msg)}}}})},template:'<button class="btn btn-danger">Upload zip file</button>'}}]);b.directive("uiDatetimepicker",function(){return{restrict:"A",require:"ngModel",link:function(h,g,f,e){return c(g).datetimepicker().on("changeDate",function(i){return h.$apply(function(){var j;j=i.date.valueOf()-8*60*60*1000;return e.$setViewValue(j)})})}}});b.directive("uiDropdownMenu",function(){return{restrict:"A",link:function(f,e){return e.find("form").on("click",function(g){return g.stopPropagation()})}}});b.directive("equals",function(){return{restrict:"A",require:"?ngModel",link:function(g,f,e,h){var i;if(angular.isUndefined(h)){return}g.$watch(e.ngModel,function(){return i()});e.$observe("equals",function(){return i()});return i=function(){var k,j;k=angular.copy(h.$viewValue);j=angular.copy(e.equals);if(angular.isUndefined(j)){j=""}if(angular.isUndefined(k)){k=""}return h.$setValidity("equals",k===j)}}}});c=jQuery;c.fn.getCursorPosition=function(){if(this.length===0){return -1}return c(this).getSelectionStart()};c.fn.setCursorPosition=function(e){if(this.length===0){return this}return c(this).setSelection(e,e)};c.fn.getSelection=function(){var g,f;if(this.length===0){return -1}f=c(this).getSelectionStart();g=c(this).getSelectionEnd();return this[0].value.substring(f,g)};c.fn.getSelectionStart=function(){var e,g,f;if(this.length===0){return -1}e=this[0];g=e.value.length;if(e.createTextRange){f=document.selection.createRange().duplicate();f.moveEnd("character",e.value.length);if(f.text===""){g=e.value.length}g=e.value.lastIndexOf(f.text)}else{if(typeof e.selectionStart!=="undefined"){g=e.selectionStart}}return g};c.fn.getSelectionEnd=function(){var e,g,f;if(this.length===0){return -1}e=this[0];g=e.value.length;if(e.createTextRange){f=document.selection.createRange().duplicate();f.moveStart("character",-e.value.length);if(f.text===""){g=e.value.length}g=e.value.lastIndexOf(f.text)}else{if(typeof e.selectionEnd!=="undefined"){g=e.selectionEnd}}return g};c.fn.setSelection=function(g,h){var f,e;if(this.length===0){return this}f=this[0];if(f.createTextRange){e=f.createTextRange();e.collapse(true);e.moveEnd("character",h);e.moveStart("character",g);e.select()}else{if(f.setSelectionRange){f.focus();f.setSelectionRange(g,h)}}return this};b.directive("uiFlandre",function(){return{restrict:"A",scope:{content:"=ngModel",uploadUrl:"@"},controller:["$scope","$element","$window",function(f,e,i){var h,g;f.mode="edit";f.previewContent="";h=c(e).find(".flandre-editor");f.togglePreview=function(){if(f.mode==="edit"){f.previewContent=f.content;return f.mode="preview"}else{return f.mode="edit"}};f.$on("flandre:focus",function(){return c(e).find(".flandre-editor").focus()});return g=new qq.FineUploaderBasic({button:c(e).find(".flandre-picture-uploader")[0],request:{endpoint:f.uploadUrl,inputName:"uploadFile"},validation:{allowedExtensions:["jpeg","jpg","gif","png"],sizeLimit:10*1000*1000},multiple:false,callbacks:{onComplete:function(o,n,m){var k,j,l;if(m.success===true){l="![title]("+m.uploadedFileUrl+")";j=h.getCursorPosition();k=h.val();k=k.insert(l,j);f.$apply(function(){return f.content=k});return h.setSelection(j+2,j+7)}else{return i.alert(m.error_msg)}}}})}],template:'<div class="panel panel-default" style="margin-bottom: 6px;">\n  <div class="panel-heading flandre-heading">\n    <div class="btn-toolbar" role="toolbar">\n      <div class="btn-group">\n        <button type="button"\n                class="btn btn-default btn-sm"\n                ng-click="togglePreview()"\n                ng-class="{active: mode == \'preview\'}">\n          Preview\n        </button>\n      </div>\n      <div class="btn-group flandre-tools">\n        <span class="btn btn-default btn-sm">\n          <i class="fa fa-smile-o"></i>\n        </span>\n        <span class="btn btn-default btn-sm flandre-picture-uploader">\n          <i class="fa fa-picture-o"></i>\n        </span>\n      </div>\n      <span class="pull-right"\n            style="padding-top: 6px;">\n        Contents are parsed with <a href="/#/article/show/2">Markdown</a>\n      </span>\n    </div>\n  </div>\n  <textarea class="tex2jax_ignore form-control flandre-editor"\n            msd-elastic\n            ng-class="{\'flandre-show\': mode == \'edit\'}"\n            ng-model="content"></textarea>\n  <div class="flandre-preview" ng-class="{\'flandre-show\': mode == \'preview\'}">\n    <markdown content="previewContent"></markdown>\n  </div>\n</div>',replace:true}});b.directive("list",function(){return{restrict:"EA",replace:true,transclude:true,scope:{condition:"=",requestUrl:"@",name:"@"},controller:"ListController",template:'<div>\n  <div class="col-md-12" ng-show="pageInfo.totalItems > itemsPerPage">\n    <pagination total-items="pageInfo.totalItems"\n                items-per-page="itemsPerPage"\n                ng-model="condition.currentPage"\n                max-size="showPages"\n                class="pagination-sm"\n                boundary-links="true"\n                previous-text="&lsaquo;"\n                next-text="&rsaquo;"\n                first-text="&laquo;"\n                last-text="&raquo;"></pagination>\n  </div>\n  <div ng-transclude></div>\n</div>'}});b.directive("uiLoadingNotification",function(){return{restrict:"E",controller:["$scope","$rootScope","$window",function(f,e,g){f.show=false;f.marginTopValue=((g.innerHeight-100)/2)+"px";return e.$on("loading:on",function(){return f.show=true})}],template:'<div>\n<div ng-if="show"\n     style="position: fixed;\n            top: 0;\n            left: 0;\n            z-index: 999998;\n            width: 100%;\n            height: 100%;\n            background: #000;\n            filter: alpha(opacity=60);\n            opacity: 0.6;">\n</div>\n<div ng-if="show"\n     style="position: fixed;\n            top: 0;\n            left: 0;\n            z-index: 999999;\n            width: 100%;\n            height: 100%;">\n  <div style="margin-left: auto;\n              margin-right: auto;\n              width: 200px;\n              height: 100px;\n              background: #FFF;"\n      ng-style="{\'margin-top\': marginTopValue}">\n    <div class="text-center"\n         style="padding-top: 36px;\n                font-size: 24px;\n                color: #F00;\n                font-weight: bold;">\n      LOADING\n    </div>\n  </div>\n</div>\n</div>'}});MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"],["\\[","\\]"]]}});b.directive("markdown",function(){return{restrict:"EA",scope:{content:"="},link:function(f,e){if(angular.isDefined(f.content)){return f.$watch("content",function(){var g;g=angular.copy(f.content);g=g.replace(/@([a-zA-Z0-9_]{4,24})\s/g,"[@$1](/#/user/center/$1)");g=marked(g);e.empty().append(g);MathJax.Hub.Queue(["Typeset",MathJax.Hub,e[0]]);return c(e).find("pre").each(function(k,i){var h,j;h=c(i);if(h.attr("type")!=="no-prettify"){j=prettyPrintOne(h[0].innerText.escapeHTML());return h.empty().append(j)}})},true)}},template:"<div></div>"}});b.directive("messagelink",function(){return{restrict:"EA",scope:{message:"="},replace:true,controller:["$scope","$modal","$rootScope",function(f,g,e){return f.readMessage=function(){e.$broadcast("list:refresh:message");e.$broadcast("data:refresh");return g.open({templateUrl:"template/modal/message-modal.html",controller:"MessageModalController",resolve:{message:function(){return f.message}}})}}],template:'<a href="javascript:void(0);"\n   ng-click="readMessage()"\n   ng-bind="message.title"></a>'}});b.directive("uiOnsiteUserFileUploader",["$window",function(e){return{restrict:"E",replace:true,link:function(g,f){var h;g.label="Load from CSV file";return h=new qq.FineUploaderBasic({button:c(f)[0],request:{endpoint:"/contest/uploadOnsiteUserFile",inputName:"uploadFile"},validation:{allowedExtensions:["csv","txt"],sizeLimit:10*1000*1000},multiple:false,callbacks:{onSubmit:function(){return g.$apply(function(){return g.label="Uploading..."})},onComplete:function(k,j,i){if(i.success==="true"){return g.$apply(function(){g.$emit("onsiteUserFileUploader:complete",i.list);return g.label="Load from CSV file"})}},onError:function(k,j,i){return e.alert(i)}}})},template:'<button class="btn btn-danger">{{label}}</button>'}}]);b.directive("uiPenalty",function(){return{restrict:"A",link:function(l,m,i){var k,f,h,j,g,e;j=l.$eval(i.penalty);f=parseInt(j);g=f%60;f=(f-g)/60;h=f%60;f=(f-h)/60;k=f;e=_.sprintf("%d:%02d:%02d",k,h,g);return c(m).text(e)}}});b.directive("problem",function(){return{restrict:"E",replace:true,transclude:true,scope:{problem:"="},link:function(e){return e.$watch("problem",function(){var g,f;g=e.problem.sampleInput;try{g=JSON.parse(g)}catch(h){}if(!(g instanceof Array)){g=[g]}f=e.problem.sampleOutput;try{f=JSON.parse(f)}catch(h){}if(!(f instanceof Array)){f=[f]}if(g.length!==f.length){return alert("Sample input has not same number of cases with sample output!")}else{return e.samples=_.map(_.zip(g,f),function(i){return{input:i[0].toString(),output:i[1].toString()}})}},true)},templateUrl:"template/problem/problem.html"}});b.directive("uiProblemAdminSpan",function(){return{restrict:"A",scope:{problemId:"=",isVisible:"="},controller:["$scope","$http","$window",function(e,g,f){return e.editVisible=function(){var h;h="/problem/operator/"+e.problemId+"/isVisible/"+(!e.isVisible);return g.post(h).success(function(i){if(i.result==="success"){return e.isVisible=!e.isVisible}else{return f.alert(i.error_msg)}}).error(function(){return f.alert("Network error.")})}}],template:'<div class="btn-toolbar" role="toolbar">\n  <div class="btn-group">\n    <button type="button"\n            class="btn btn-default btn-sm"\n            ng-click="editVisible()"\n            style="padding: 1px 5px;">\n      <i class="fa"\n         ng-class="{\n          \'fa-eye\': isVisible == true,\n          \'fa-eye-slash\': isVisible == false\n         }"></i>\n    </button>\n    <a href="#/problem/editor/{{problemId}}"\n       class="btn btn-default btn-sm"\n       style="padding: 1px 5px;">\n      <i class="fa fa-pencil"></i>\n    </a>\n  </div>\n</div>'}});b.directive("uiProblemDataUploader",function(){return{restrict:"E",scope:{uploadUrl:"@"},controller:["$scope","$element","$window",function(f,e,h){var g;f.hint="Upload";f.hasError=false;return g=new qq.FineUploaderBasic({button:e[0],request:{endpoint:f.uploadUrl,inputName:"uploadFile"},validation:{allowedExtensions:["zip"],sizeLimit:300*1024*1024},multiple:false,callbacks:{onComplete:function(k,j,i){if(i.success===true){return f.$apply(function(){f.hint="Total data: "+i.total;return f.hasError=false})}else{return f.$apply(function(){f.hint=i.error;return f.hasError=true})}},onProgress:function(l,k,i,j){return f.$apply(function(){var m;m=Math.round(i/j*100);return f.hint=""+m+" %"})},onError:function(k,j,i){return h.alert(i)}}})}],template:'<span class="btn"\n    ng-class="{\'btn-success\': hasError == false,\n\'btn-danger\': hasError == true}">\n  <i class="fa fa-upload"></i><span ng-bind="hint"></span>\n</span>',replace:true}});b.directive("uiReadmore",function(){return{restrict:"A",scope:{hasMore:"=",articleId:"="},link:function(f,e){if(f.hasMore){return e.empty().append('<a href="#/article/show/'+f.articleId+'">Read more >></a>')}}}});b.directive("uiRejudgeButton",function(){return{restrict:"A",scope:{condition:"="},controller:["$scope","$rootScope","$http","$window",function(f,e,h,g){return f.rejudge=function(){return h.post("/status/rejudgeStatusCount",f.condition).success(function(i){if(i.result==="success"){if(confirm("Rejudge all "+i.count+" records")){return h.post("/status/rejudge",f.condition).success(function(j){if(j.result==="success"){return g.alert("Done!")}else{return g.alert(j.error_msg)}}).error(function(){return g.alert("Network error.")})}}else{return g.alert(i.error_msg)}}).error(function(){return g.alert("Network error.")})}}],template:'<a href="javascript:void(0);"\n   ng-show="$root.isAdmin"\n   class="btn btn-danger btn-xs"\n   ng-click="rejudge()">Rejudge</a>'}});angular.module("ui.sortable",[]).value("uiSortableConfig",{}).directive("uiSortable",["uiSortableConfig","$timeout","$log",function(f,e,g){return{require:"?ngModel",link:function(p,j,o,k){var m,n,l,h,i;l=c(j);n=function(r,q){if(q&&typeof q==="function"){return function(t,s){r(t,s);q(t,s)}}return r};i=void 0;h={};m={receive:null,remove:null,start:null,stop:null,update:null};angular.extend(h,f);if(k){p.$watch(o.ngModel+".length",function(){e(function(){l.sortable("refresh")})});m.start=function(r,q){q.item.sortable={index:q.item.index(),cancel:function(){q.item.sortable._isCanceled=true},isCanceled:function(){return q.item.sortable._isCanceled},_isCanceled:false}};m.activate=function(){var s,q,r;i=l.contents();r=l.sortable("option","placeholder");if(r&&r.element&&typeof r.element==="function"){q=r.element();if(!q.jquery){q=angular.element(q)}s=l.find('[class="'+q.attr("class")+'"]');i=i.not(s)}};m.update=function(r,q){if(!q.item.sortable.received){q.item.sortable.dropindex=q.item.index();q.item.sortable.droptarget=q.item.parent();l.sortable("cancel")}if(l.sortable("option","helper")==="clone"){i=i.not(i.last())}i.appendTo(l);if(q.item.sortable.received&&!q.item.sortable.isCanceled()){p.$apply(function(){k.$modelValue.splice(q.item.sortable.dropindex,0,q.item.sortable.moved)})}};m.stop=function(r,q){if(!q.item.sortable.received&&"dropindex" in q.item.sortable&&!q.item.sortable.isCanceled()){p.$apply(function(){k.$modelValue.splice(q.item.sortable.dropindex,0,k.$modelValue.splice(q.item.sortable.index,1)[0])})}else{if((("dropindex" in q.item.sortable)||q.item.sortable.isCanceled())&&l.sortable("option","helper")!=="clone"){i.appendTo(l)}}};m.receive=function(r,q){q.item.sortable.received=true};m.remove=function(r,q){if(!q.item.sortable.isCanceled()){p.$apply(function(){q.item.sortable.moved=k.$modelValue.splice(q.item.sortable.index,1)[0]})}};p.$watch(o.uiSortable,(function(q){angular.forEach(q,function(s,r){if(m[r]){if(r==="stop"){s=n(s,function(){p.$apply()})}s=n(m[r],s)}l.sortable("option",r,s)})}),true);angular.forEach(m,function(r,q){h[q]=n(r,h[q])})}else{g.info("ui.sortable: ngModel not provided!",l)}l.sortable(h)}}}]);b.directive("uiStatus",function(){return{restrict:"A",scope:{status:"=",alwaysShowHref:"@"},controller:["$scope","$rootScope","$http","$modal",function(h,f,l,i){var k,j,g,e;h.showHref=false;k=function(){if(h.status.returnTypeId===7){if(h.alwaysShowHref){return h.showHref=true}else{if(f.hasLogin&&(f.currentUser.type===1||f.currentUser.userName===h.status.userName)){return h.showHref=true}else{return h.showHref=false}}}else{return h.showHref=false}};k();h.$on("currentUser:updated",function(){return k()});h.showCompileInfo=function(){var m;m=h.status.statusId;return i.open({templateUrl:"template/modal/compile-info-modal.html",controller:"CompileInfoModalController",size:"lg",resolve:{statusId:function(){return m}}})};e=function(){return clearInterval(g)};j=function(){var m;m={currentPage:null,startId:h.status.statusId,endId:h.status.statusId,userName:void 0,problemId:void 0,languageId:void 0,contestId:h.status.contestId};if(angular.isUndefined(m.contestId)){m.contestId=-1}return l.post("/status/search",m).success(function(n){if(n.result==="success"&&n.list.length===1){h.status=n.list[0];k();if([0,16,17,18].none(h.status.returnTypeId)){return e()}}}).error(function(){return $window.alert("Network error.")})};if([0,16,17,18].some(h.status.returnTypeId)){g=setInterval(j,1000)}return h.$on("$locationChangeStart",function(){return e()})}],template:'<a href="javascript:void(0);"\n   ng-show="showHref"\n   ng-click="showCompileInfo()">{{status.returnType}}</a>\n<span ng-hide="showHref">{{status.returnType}}</span>'}});"use strict";angular.module("frapontillo.bootstrap-switch",[]);angular.module("frapontillo.bootstrap-switch").directive("bsSwitch",["$timeout",function(e){return{restrict:"EA",require:"ngModel",template:"<input>",replace:true,scope:{switchToggle:"&",switchActive:"@",switchSize:"@",switchOn:"@",switchOff:"@",switchOnLabel:"@",switchOffLabel:"@",switchLabel:"@",switchIcon:"@",switchAnimate:"@"},link:function(l,g,j,f){var k,i,h;k=c(g);i=function(){f.$formatters.push(function(m){if(angular.isDefined(m)){return e(function(){return k.bootstrapSwitch("setState",m||false,true)})}});l.$watch("switchActive",function(n){var m;m=n===true||n==="true"||!n;return k.bootstrapSwitch("setDisabled",!m)});l.$watch("switchOnLabel",function(m){return k.bootstrapSwitch("setOnLabel",m||"Yes")});l.$watch("switchOffLabel",function(m){return k.bootstrapSwitch("setOffLabel",m||"No")});l.$watch("switchOn",function(m){j.dataOn=m;return k.bootstrapSwitch("setOnClass",m||"")});l.$watch("switchOff",function(m){j.dataOff=m;return k.bootstrapSwitch("setOffClass",m||"")});l.$watch("switchAnimate",function(m){return k.bootstrapSwitch("setAnimated",l.$eval(m||"true"))});l.$watch("switchSize",function(m){return k.bootstrapSwitch("setSizeClass",l.getSizeClass(m))});l.$watch("switchLabel",function(m){return k.bootstrapSwitch("setTextLabel",m)});return l.$watch("switchIcon",function(m){return k.bootstrapSwitch("setTextIcon",m)})};h=function(){return k.on("switch-change",function(n,m){return l.$apply(function(){f.$setViewValue(m.value);return l.switchToggle()})})};l.getSizeClass=function(){if(j.switchSize){return"switch-"+j.switchSize}else{return""}};i();h();k.bootstrapSwitch();e(function(){return k.bootstrapSwitch("setState",f.$modelValue||false,true)});return l.$on("$destroy",function(){return k.bootstrapSwitch("destroy")})}}}]);b.directive("team",function(){return{restrict:"E",replace:true,templateUrl:"template/team/team.html",scope:{user:"=",team:"="},controller:["$scope","$rootScope","$http","$modal",function(f,e,h,g){f.editPermission=false;if(e.hasLogin){if(e.currentUser.userId===f.user.userId||e.isAdmin){f.editPermission=true}}f.joinIn=function(i){return h.get("/team/changeAllowState/"+f.user.userId+"/"+i.teamId+"/"+i.allow).success(function(){return h.get("/team/typeAHeadItem/"+f.team.teamName).success(function(j){if(j.result==="success"){return f.team=j.team}else{return $window.alert(j.error_msg)}}).error(function(){return $window.alert("Network error.")})}).error(function(){return $window.alert("Network error.")})};return f.showTeamEditor=function(i){return g.open({templateUrl:"template/modal/team-editor-modal.html",controller:"TeamEditorModalController",resolve:{team:function(){return i}}})}}]}});b.directive("uiTime",function(){return{restrict:"A",scope:{time:"=",inline:"=",format:"@",show:"@",change:"@"},controller:["$scope",function(e){e.timeString="";e.showRelativeTime=function(){return e.timeString=Date.create(e.time).relative()};e.showRealTime=function(){return e.timeString=Date.create(e.time).format("{yyyy}-{MM}-{dd} {HH}:{mm}:{ss}")};e.showTime=function(){if(e.show==="real"){return e.showRealTime()}else{return e.showRelativeTime()}};e.$watch("time",function(){return e.showTime()});e.mouseOver=function(){if(e.change==="false"){return}if(e.show==="real"){return e.showRelativeTime()}else{return e.showRealTime()}};e.mouseLeave=function(){if(e.change==="false"){return}return setTimeout(function(){return e.$apply(function(){return e.showTime()})},400)};return e.getInline=function(){if(e.inline){return"inline"}else{return"block"}}}],template:'<div ng-mouseover="mouseOver()"\n     ng-mouseleave="mouseLeave()"\n     style="width: 100%;"\n     ng-style="{display: getInline()}">{{timeString}}</div>'}});b.directive("uiTimeLength",function(){return{restrict:"A",scope:{length:"="},controller:["$scope",function(e){e.timeString="";e.$watch("length",function(){return e.showTimeLength()});return e.showTimeLength=function(){var j,f,h,i,g;h=Math.floor(parseInt(e.length)/1000);g=h%60;h=(h-g)/60;i=h%60;h=(h-i)/60;f=h%24;h=(h-f)/24;j=h;e.timeString="";if(j>0){e.timeString=e.timeString+j+(" "+(j===1?"day":"days")+" ")}return e.timeString=e.timeString+_.sprintf("%d:%02d:%02d",f,i,g)}}],template:"{{timeString}}"}});b.directive("uiUserAdminSpan",function(){return{restrict:"E",scope:{user:"="},controller:["$scope","$http","$modal","$window","UserProfile",function(e,i,f,h,g){return e.showEditor=function(){g.setProfile(e.user.userName);return f.open({templateUrl:"template/modal/user-admin-modal.html",controller:"UserAdminModalController"})}}],template:'<div class="btn-toolbar"\n     role="toolbar"\n     style="position: absolute; top: 12px; right: 30px;"\n     ng-show="$root.isAdmin">\n  <div class="btn-group">\n    <button type="button"\n            class="btn btn-default btn-sm"\n            ng-click="showEditor()">\n      <i class="fa fa-pencil"></i>\n    </button>\n  </div>\n</div>'}});b.directive("uiValidateInfo",function(){return{restrict:"E",scope:{value:"=","for":"@"},link:function(e){e.isInvalid=false;e.message="";return e.$watch("value",function(){var f;f=_.findWhere(e.value,{field:e["for"]});if(f!==void 0){e.message=f.defaultMessage;return e.isInvalid=true}else{e.message="";return e.isInvalid=false}})},template:'<span class="validate-info" ng-show="isInvalid" ng-bind="message"></span>'}})}).call(this);